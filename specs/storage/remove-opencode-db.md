...
Status: Completed. Startup, the public node export, and database CLI tooling no longer import the legacy awmate database wrapper; `packages/opencode/src/storage/db.ts` has been deleted.
