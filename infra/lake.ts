...
const tableBucketName = `awmate-${$app.stage}-lake`
...
const firehose = new aws.kinesis.FirehoseDeliveryStream(
  "LakeFirehose",
  {
    name: `awmate-${$app.stage}-lake-ingest`,
    destination: "iceberg",
