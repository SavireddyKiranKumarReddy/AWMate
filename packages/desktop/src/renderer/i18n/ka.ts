export const dict = {
  ...
  "desktop.updater.none.message": "თქვენ უკვე იყენებთ AWMate-ის უახლეს ვერსიას",
  ...
  "desktop.updater.downloaded.prompt":
    "AWMate-ის {{version}} ვერსია ჩამოტვირთულია, გსურთ მისი ინსტალაცია და ხელახლა გაშვება?",
  ...
  "desktop.cli.installed.message":
    "CLI დაინსტალირებულია {{path}}-ზე\n\nგადატვირთეთ ტერმინალი „awmate“ ბრძანების გამოსაყენებლად.",
