export const dict = {
  ...
  "desktop.updater.none.message": "Jau naudojate naujausią AWMate versiją",
  ...
  "desktop.updater.downloaded.prompt":
    "AWMate versija {{version}} atsisiųsta, ar norėtumėte ją įdiegti ir paleisti iš naujo?",
  ...
  "desktop.cli.installed.message":
    "CLI įdiegtas į {{path}}\n\nIš naujo paleiskite terminalą, kad galėtumėte naudoti komandą 'awmate'.",
