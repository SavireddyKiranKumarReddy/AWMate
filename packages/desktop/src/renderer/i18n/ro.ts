export const dict = {
  ...
  "desktop.updater.none.message": "Folosești deja cea mai recentă versiune AWMate",
  ...
  "desktop.updater.downloaded.prompt":
    "Versiunea {{version}} AWMate a fost descărcată. Vrei să o instalezi și să repornești?",
  ...
  "desktop.cli.installed.message":
    "CLI a fost instalat în {{path}}\n\nRepornește terminalul pentru a folosi comanda 'awmate'.",
