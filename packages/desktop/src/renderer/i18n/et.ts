export const dict = {
  ...
  "desktop.updater.none.message": "Kasutate juba rakenduse AWMate uusimat versiooni",
  ...
  "desktop.updater.downloaded.prompt":
    "AWMate'i versioon {{version}} on alla laaditud. Kas soovite selle installida ja rakenduse taaskäivitada?",
  ...
  "desktop.cli.installed.message":
    "CLI installitud asukohta {{path}}\n\nKäsu „awmate” kasutamiseks taaskäivitage terminal.",
