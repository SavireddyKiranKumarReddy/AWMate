export const dict = {
  ...
  "desktop.updater.none.message": "شما در حال حاضر از آخرین نسخه AWMate استفاده می کنید",
  ...
  "desktop.updater.downloaded.prompt":
    "نسخه {{version}} AWMate دانلود شده است، آیا می خواهید آن را نصب کنید و دوباره راه اندازی کنید؟",
  ...
  "desktop.cli.installed.message":
    "CLI روی {{path}} نصب شد\n\nترمینال خود را مجددا راه اندازی کنید تا از دستور 'awmate' استفاده کنید.",
