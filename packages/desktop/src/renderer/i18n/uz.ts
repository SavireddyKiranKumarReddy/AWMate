export const dict = {
  ...
  "desktop.updater.none.message": "Siz allaqachon AWMate ning oxirgi versiyasidan foydalanyapsiz",
  ...
  "desktop.updater.downloaded.prompt":
    "AWMatening {{version}} versiyasi yuklab olindi, uni oʻrnatib, qayta ishga tushirmoqchimisiz?",
  ...
  "desktop.cli.installed.message":
    "CLI {{path}} manziliga o'rnatildi\n\n'awmate' buyrug'ini ishlatish uchun terminalni qayta ishga tushiring.",
