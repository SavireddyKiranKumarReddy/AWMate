export const dict = {
  ...
  "desktop.updater.none.message": "Že uporabljate najnovejšo različico AWMate",
  ...
  "desktop.updater.downloaded.prompt":
    "Različica {{version}} AWMate je bila prenesena, jo želite namestiti in znova zagnati?",
  ...
  "desktop.cli.installed.message":
    "CLI je nameščen v {{path}}\n\nZnova zaženite terminal, da lahko uporabite ukaz 'awmate'.",
