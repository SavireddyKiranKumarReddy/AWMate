export const dict = {
  ...
  "desktop.updater.none.message": "Þú ert nú þegar að nota nýjustu útgáfuna af AWMate",
  ...
  "desktop.updater.downloaded.prompt":
    "Útgáfu {{version}} af AWMate hefur verið hlaðið niður. Viltu setja hana upp og endurræsa?",
  ...
  "desktop.cli.installed.message":
    "CLI sett upp í {{path}}\n\nEndurræstu skjáherminn til að nota 'awmate' skipunina.",
