export const dict = {
  ...
  "desktop.updater.none.message": "Artıq AWMate-un ən son versiyasından istifadə edirsiniz",
  ...
  "desktop.updater.downloaded.prompt":
    "AWMate-un {{version}} versiyası yüklənib. Onu quraşdırıb tətbiqi yenidən başlatmaq istəyirsiniz?",
  ...
  "desktop.cli.installed.message":
    "CLI {{path}} ünvanına quraşdırıldı\n\n'awmate' əmrindən istifadə etmək üçün terminalı yenidən başladın.",
