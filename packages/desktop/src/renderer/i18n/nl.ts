export const dict = {
  ...
  "desktop.updater.none.message": "Je gebruikt al de nieuwste versie van AWMate",
  ...
  "desktop.updater.downloaded.prompt":
    "Versie {{version}} van AWMate is gedownload. Wil je deze installeren en AWMate opnieuw starten?",
  ...
  "desktop.cli.installed.message":
    "CLI geïnstalleerd op {{path}}\n\nStart je terminal opnieuw om de opdracht 'awmate' te gebruiken.",
