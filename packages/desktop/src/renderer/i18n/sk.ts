export const dict = {
  ...
  "desktop.updater.none.message": "Používate najnovšiu verziu AWMate",
  ...
  "desktop.updater.downloaded.prompt":
    "Verzia {{version}} AWMate bola stiahnutá. Chcete ju nainštalovať a reštartovať?",
  ...
  "desktop.cli.installed.message":
    "CLI bolo nainštalované do {{path}}\n\nReštartujte terminál, aby ste mohli používať príkaz 'awmate'.",
