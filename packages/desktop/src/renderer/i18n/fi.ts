export const dict = {
  ...
  "desktop.updater.none.message": "Käytät jo AWMaten uusinta versiota",
  ...
  "desktop.updater.downloaded.prompt":
    "AWMaten versio {{version}} on ladattu. Haluatko asentaa sen ja käynnistää AWMaten uudelleen?",
  ...
  "desktop.cli.installed.message":
    "CLI on asennettu polkuun {{path}}\n\nKäynnistä terminaali uudelleen, jotta voit käyttää 'awmate'-komentoa.",
