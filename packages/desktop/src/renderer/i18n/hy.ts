export const dict = {
  ...
  "desktop.updater.none.message": "Դուք արդեն օգտագործում եք AWMate-ի վերջին տարբերակը",
  ...
  "desktop.updater.downloaded.prompt":
    "AWMate-ի {{version}} տարբերակը ներբեռնվել է: Ցանկանու՞մ եք տեղադրել այն և վերագործարկել:",
  ...
  "desktop.cli.installed.message":
    "CLI-ն տեղադրված է {{path}}-ում\n\nՎերագործարկեք ձեր տերմինալը՝ «awmate» հրամանն օգտագործելու համար:",
