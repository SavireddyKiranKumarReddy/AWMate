export const dict = {
  ...
  "desktop.updater.none.message": "አሁን የቅርብ ጊዜውን የAWMate ስሪት እየተጠቀሙ ነው",
  ...
  "desktop.updater.downloaded.prompt": "ስሪት {{version}} ከAWMate ወርዷል፣ መጫን እና እንደገና ማስጀመር ይፈልጋሉ?",
