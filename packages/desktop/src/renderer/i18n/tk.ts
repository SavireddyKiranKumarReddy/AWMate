export const dict = {
  ...
  "desktop.updater.none.message": "AWMate-iň iň soňky wersiýasyny eýýäm ulanýarsyňyz",
  ...
  "desktop.updater.downloaded.prompt":
    "AWMate-iň {{version}} wersiýasy göçürildi, ony gurup täzeden işletmek isleýärsiňizmi?",
  ...
  "desktop.cli.installed.message":
    "CLI {{path}} salgysyna guruldy\n\n'awmate' buýrugyny ulanmak üçin terminalyňyzy täzeden açyň.",
