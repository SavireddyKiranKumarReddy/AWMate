export const dict = {
  ...
  "desktop.updater.none.message": "Du använder redan den senaste versionen av AWMate",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} av AWMate har laddats ned. Vill du installera den och starta om programmet?",
  ...
  "desktop.cli.installed.message":
    "CLI installerat i {{path}}\n\nStarta om terminalen för att använda kommandot 'awmate'.",
