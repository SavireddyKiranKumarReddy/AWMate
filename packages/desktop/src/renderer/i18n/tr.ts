export const dict = {
  ...
  "desktop.updater.none.message": "AWMate'un en son sürümünü zaten kullanıyorsunuz",
  ...
  "desktop.updater.downloaded.prompt":
    "AWMate'un {{version}} sürümü indirildi. Şimdi yükleyip yeniden başlatmak ister misiniz?",
  ...
  "desktop.cli.installed.message":
    "CLI {{path}} konumuna yüklendi\n\n'awmate' komutunu kullanmak için terminalinizi yeniden başlatın.",
