...
export const Info = Schema.Struct({
  ...
  command: Schema.optional(Schema.Record(Schema.String, ConfigCommandV1.Info)).annotate({
    description: "Command configuration, see https://ai.awmate.nxtgensec.org/docs/commands",
  }),
  ...
  ).annotate({ description: "Agent configuration, see https://ai.awmate.nxtgensec.org/docs/agents" }),
