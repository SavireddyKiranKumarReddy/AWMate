...
describe("HttpApi workspace proxy", () => {
  ...
  it.live("strips awmate-internal headers and merges extra headers", () =>
    Effect.gen(function* () {
      ...
      expect(forwarded["x-awmate-directory"]).toBeUndefined()
      expect(forwarded["x-awmate-workspace"]).toBeUndefined()
