...
describe("awmate read-only commands (smoke)", () => {
  ...
  cliIt.live(
    ...
    ({ awmate }) =>
      Effect.gen(function* () {
        const r = yield* awmate.spawn(["mcp", "list"])
        awmate.expectExit(r, 0, "mcp list")
      }),
    60_000,
  )
  ...
  cliIt.live(
    ...
    ({ awmate }) =>
      Effect.gen(function* () {
        const r = yield* awmate.spawn(["providers", "list"])
        awmate.expectExit(r, 0, "providers list")
  ...
  cliIt.live(
    ...
    ({ awmate }) =>
      Effect.gen(function* () {
        const r = yield* awmate.spawn(["models"])
        awmate.expectExit(r, 0, "models")
  ...
  cliIt.live(
    ...
    ({ awmate }) =>
      Effect.gen(function* () {
        const r = yield* awmate.spawn(["agent", "list"])
        awmate.expectExit(r, 0, "agent list")
      }),
    60_000,
  )
  ...
  cliIt.live(
    ...
    ({ awmate }) =>
      Effect.gen(function* () {
        const r = yield* awmate.spawn(["session", "list"])
        awmate.expectExit(r, 0, "session list")
      }),
    60_000,
  )
  ...
  cliIt.live(
    ...
    ({ awmate }) =>
      Effect.gen(function* () {
        const r = yield* awmate.spawn(["stats"])
        awmate.expectExit(r, 0, "stats")
      }),
    60_000,
  )
  ...
  cliIt.live(
    ...
    ({ awmate }) =>
      Effect.gen(function* () {
        const r = yield* awmate.spawn(["db", "path"])
        awmate.expectExit(r, 0, "db path")
