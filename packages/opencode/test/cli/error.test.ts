  ...
  test("formats legacy and tagged config errors the same way", () => {
    const cases = [
      ...
      },
      {
        ...
        data: { path: "/tmp/awmate.jsonc", dir: ".awmate", suggestion: "awmate" },
        expected:
          'Directory ".awmate" in /tmp/awmate.jsonc is not valid. Rename the directory to "awmate" or remove it. This is a common typo.',
      },
      {
