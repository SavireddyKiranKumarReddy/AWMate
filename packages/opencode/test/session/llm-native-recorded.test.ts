...
const RECORDED_SCENARIOS = [
  ...
  },
  {
    ...
    protocol: "openai-responses",
    tags: ["awmate", "native", "oauth", "tool-loop"],
  ...
  },
  {
    ...
    protocol: "openai-responses",
    tags: ["awmate", "zen", "native", "tool-loop"],
...
function recordedNativeLLMLayer(scenario: RecordedScenario) {
  ...
  // Only the HTTP client is recorded; RequestExecutor and the awmate LLM stack remain real.
  const metadata = {
