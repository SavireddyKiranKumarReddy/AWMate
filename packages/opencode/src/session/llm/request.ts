...
export const prepare = Effect.fn("LLMRequestPrep.prepare")(function* (input: PrepareInput) {
  ...
  const awmateProjectID = input.model.providerID.startsWith("awmate")
  ...
  return {
    ...
    headers: {
      ...(input.model.providerID.startsWith("awmate")
        ? {
            ...(awmateProjectID ? { "x-awmate-project": awmateProjectID } : {}),
