export const dict = {
  ...
  "app.description":
    "AWMate kullanımını yapay zeka modelleri genelinde keşfedin: token hacmi, sıralamalar, pazar payı, token fiyatlandırması, oturum maliyeti, önbellek oranı ve coğrafi dağılımlar.",
  ...
  "header.tryAWMate": "AWMate'u dene",
  ...
  "home.topModelsDescription": "AWMate genelinde model kullanımı.",
  ...
  "home.uniqueUsersDescription": "Modele göre günlük benzersiz AWMate kullanıcıları.",
  ...
  "lab.description":
    "AWMate'da kullanılan {{lab}} modellerini karşılaştırın: token kullanımı, model sıralamaları, bağlam pencereleri, yayın tarihleri, maliyetler ve modele özel veriler.",
  ...
  "model.description":
    "{{model}} için AWMate kullanım verilerini görüntüleyin: token hacmi, haftalık sıra, token karışımı, maliyetler, önbellek oranı, oturumlar, coğrafi dağılımlar ve benzer modeller.",
  ...
  "model.catalogFallback":
    "Paylaşılan model dizininden model bilgileri. Bu modelde etkinlik olduğunda AWMate kullanımı görünür.",
  "model.unranked": "Geçen haftaki AWMate kullanımında sıralanmamış",
  "model.ranked": "Geçen haftaki AWMate kullanımında #{{rank}} sırada",
  ...
  "model.noCurrentUsage": "Geçerli veri penceresinde AWMate kullanımı yok.",
  ...
  "model.overviewDescription": "Son AWMate tokenları, benzersiz kullanıcılar ve pazar konumu.",
  "model.noSummaryTitle": "Kullanım özeti yok",
  "model.noSummaryDescription": "Bu modelde henüz AWMate kullanım satırı yok.",
  ...
  "model.usageDescription": "Son iki aylık pencerede günlük AWMate token hacmi.",
  ...
  "model.usersDescription": "Son iki aylık pencerede günlük benzersiz AWMate kullanıcıları.",
  ...
  "model.efficiencyDescription": "Maliyet, önbellek davranışı ve ortalama AWMate oturum yapısı.",
  ...
  "model.noGeoDescription": "Bu modelle eşleşen AWMate coğrafi satırı yok.",
  "model.peersDescription": "Son AWMate token hacmine göre yakındaki modeller.",
