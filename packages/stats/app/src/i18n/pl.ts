export const dict = {
  ...
  "app.description":
    "Przeglądaj użycie AWMate w modelach AI, w tym wolumen tokenów, rankingi, udział w rynku, ceny tokenów, koszt sesji, współczynnik cache i podziały geograficzne.",
  ...
  "header.tryAWMate": "Wypróbuj AWMate",
  ...
  "home.topModelsDescription": "Użycie modeli w AWMate.",
  ...
  "home.uniqueUsersDescription": "Dzienni unikalni użytkownicy AWMate według modelu.",
  ...
  "lab.description":
    "Porównaj modele {{lab}} używane w AWMate, w tym użycie tokenów, rankingi modeli, okna kontekstu, daty wydań, koszty i dane specyficzne dla modeli.",
  ...
  "model.description":
    "Zobacz dane użycia {{model}} w AWMate, w tym wolumen tokenów, tygodniową pozycję, miks tokenów, koszty, współczynnik cache, sesje, podziały geograficzne i podobne modele.",
  ...
  "model.catalogFallback":
    "Fakty modelu ze wspólnego indeksu modeli. Użycie AWMate pojawi się, gdy ten model będzie mieć aktywność.",
  "model.unranked": "Bez pozycji w użyciu AWMate z zeszłego tygodnia",
  "model.ranked": "Pozycja #{{rank}} w użyciu AWMate z zeszłego tygodnia",
  ...
  "model.noCurrentUsage": "Brak użycia AWMate w bieżącym oknie danych.",
  ...
  "model.overviewDescription": "Ostatnie tokeny AWMate, unikalni użytkownicy i pozycja rynkowa.",
  "model.noSummaryTitle": "Brak podsumowania użycia",
  "model.noSummaryDescription": "Ten model nie ma jeszcze wierszy użycia AWMate.",
  "model.tokens": "Tokeny",
  ...
  "model.usageDescription": "Dzienny wolumen tokenów AWMate w ostatnim dwumiesięcznym oknie.",
  ...
  "model.usersDescription": "Dzienni unikalni użytkownicy AWMate w ostatnim dwumiesięcznym oknie.",
  ...
  "model.efficiencyDescription": "Koszt, zachowanie cache i średni kształt sesji AWMate.",
  ...
  "model.noGeoDescription": "Żadne wiersze geograficzne AWMate nie pasowały do tego modelu.",
  "model.peersDescription": "Pobliskie modele według ostatniego wolumenu tokenów AWMate.",
