export const dict = {
  ...
  "app.description":
    "Explora el uso de AWMate en modelos de IA, incluido el volumen de tokens, clasificaciones, cuota de mercado, precios de tokens, coste por sesión, ratio de caché y desgloses geográficos.",
  ...
  "header.tryAWMate": "Probar AWMate",
  ...
  "home.usageTitle": "Uso",
  "home.topModelsDescription": "Uso de modelos en AWMate.",
  ...
  "home.uniqueUsersDescription": "Usuarios únicos diarios de AWMate por modelo.",
  ...
  "lab.description":
    "Compara modelos de {{lab}} usados en AWMate, incluido uso de tokens, clasificaciones de modelos, ventanas de contexto, fechas de lanzamiento, costes y datos específicos del modelo.",
  ...
  "model.description":
    "Consulta datos de uso de {{model}} en AWMate, incluido volumen de tokens, posición semanal, mezcla de tokens, costes, ratio de caché, sesiones, desgloses geográficos y modelos similares.",
  ...
  "model.catalogFallback":
    "Datos del modelo desde el índice compartido de modelos. El uso de AWMate aparecerá cuando este modelo tenga actividad.",
  "model.unranked": "Sin clasificación en el uso de AWMate de la semana pasada",
  "model.ranked": "Clasificado #{{rank}} en el uso de AWMate de la semana pasada",
  ...
  "model.noCurrentUsage": "Sin uso de AWMate en la ventana de datos actual.",
  ...
  "model.overviewDescription": "Tokens recientes de AWMate, usuarios únicos y posición de mercado.",
  "model.noSummaryTitle": "Sin resumen de uso",
  "model.noSummaryDescription": "Este modelo aún no tiene filas de uso de AWMate.",
  "model.tokens": "Tokens",
  ...
  "model.usageDescription": "Volumen diario de tokens de AWMate durante la ventana reciente de dos meses.",
  ...
  "model.usersDescription": "Usuarios únicos diarios de AWMate durante la ventana reciente de dos meses.",
  ...
  "model.efficiencyDescription": "Coste, comportamiento de caché y forma media de sesión de AWMate.",
  ...
  "model.noGeoDescription": "Ninguna fila geográfica de AWMate coincidió con este modelo.",
  "model.peersDescription": "Modelos cercanos por volumen reciente de tokens de AWMate.",
