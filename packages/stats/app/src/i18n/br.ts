export const dict = {
  ...
  "app.description":
    "Explore o uso do AWMate em modelos de IA, incluindo volume de tokens, rankings, participação de mercado, preço por token, custo por sessão, taxa de cache e distribuição geográfica.",
  ...
  "header.tryAWMate": "Experimente o AWMate",
  ...
  "home.usageTitle": "Uso",
  "home.topModelsDescription": "Uso de modelos no AWMate.",
  ...
  "home.uniqueUsersDescription": "Usuários únicos diários do AWMate por modelo.",
  ...
  "lab.description":
    "Compare modelos da {{lab}} usados no AWMate, incluindo uso de tokens, ranking de modelos, janelas de contexto, datas de lançamento, custos e dados específicos de cada modelo.",
  ...
  "model.description":
    "Veja dados de uso de {{model}} no AWMate, incluindo volume de tokens, ranking semanal, combinação de tokens, custos, taxa de cache, sessões, distribuição geográfica e modelos pares.",
  ...
  "model.catalogFallback":
    "Fatos do modelo do índice compartilhado de modelos. O uso no AWMate aparece quando este modelo tiver atividade.",
  "model.unranked": "Sem classificação no uso do AWMate da última semana",
  "model.ranked": "Classificado em #{{rank}} no uso do AWMate da última semana",
  ...
  "model.noCurrentUsage": "Sem uso do AWMate na janela de dados atual.",
  ...
  "model.overviewDescription": "Tokens recentes do AWMate, usuários únicos e posição de mercado.",
  "model.noSummaryTitle": "Sem resumo de uso",
  "model.noSummaryDescription": "Este modelo ainda não tem linhas de uso do AWMate.",
  "model.tokens": "Tokens",
  ...
  "model.usageDescription": "Volume diário de tokens do AWMate na janela recente de dois meses.",
  ...
  "model.usersDescription": "Usuários únicos diários do AWMate na janela recente de dois meses.",
  ...
  "model.efficiencyDescription": "Custo, comportamento de cache e formato médio da sessão do AWMate.",
  ...
  "model.noGeoDescription": "Nenhuma linha geográfica do AWMate correspondeu a este modelo.",
  "model.peersDescription": "Modelos próximos por volume recente de tokens do AWMate.",
