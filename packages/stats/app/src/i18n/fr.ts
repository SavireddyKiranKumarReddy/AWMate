export const dict = {
  ...
  "app.description":
    "Explorez l'utilisation d'AWMate par modèle d'IA, avec le volume de tokens, les classements, la part de marché, le prix des tokens, le coût par session, le taux de cache et les répartitions géographiques.",
  ...
  "header.tryAWMate": "Essayer AWMate",
  ...
  "home.topModelsDescription": "Utilisation des modèles dans AWMate.",
  ...
  "home.uniqueUsersDescription": "Utilisateurs uniques quotidiens d'AWMate par modèle.",
  ...
  "lab.description":
    "Comparez les modèles {{lab}} utilisés dans AWMate, avec l'utilisation des tokens, les classements de modèles, les fenêtres de contexte, les dates de sortie, les coûts et les données propres aux modèles.",
  ...
  "model.description":
    "Consultez les données d'utilisation AWMate de {{model}}, avec le volume de tokens, le rang hebdomadaire, la répartition des tokens, les coûts, le taux de cache, les sessions, les répartitions géographiques et les modèles proches.",
  ...
  "model.catalogFallback":
    "Faits du modèle issus de l'index partagé des modèles. L'utilisation AWMate apparaîtra dès que ce modèle aura de l'activité.",
  "model.unranked": "Non classé dans l'utilisation AWMate de la semaine dernière",
  "model.ranked": "Classé #{{rank}} dans l'utilisation AWMate de la semaine dernière",
  ...
  "model.noCurrentUsage": "Aucune utilisation AWMate dans la fenêtre de données actuelle.",
  ...
  "model.overviewDescription": "Tokens AWMate récents, utilisateurs uniques et position sur le marché.",
  "model.noSummaryTitle": "Aucun résumé d'utilisation",
  "model.noSummaryDescription": "Ce modèle n'a pas encore de lignes d'utilisation AWMate.",
  "model.tokens": "Tokens",
  ...
  "model.usageDescription": "Volume quotidien de tokens AWMate sur la fenêtre récente de deux mois.",
  ...
  "model.usersDescription": "Utilisateurs uniques quotidiens d'AWMate sur la fenêtre récente de deux mois.",
  ...
  "model.efficiencyDescription": "Coût, comportement du cache et forme moyenne des sessions AWMate.",
  ...
  "model.noGeoDescription": "Aucune ligne géographique AWMate ne correspondait à ce modèle.",
  "model.peersDescription": "Modèles proches par volume récent de tokens AWMate.",
