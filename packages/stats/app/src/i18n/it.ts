export const dict = {
  ...
  "app.description":
    "Esplora l'utilizzo di AWMate nei modelli IA, inclusi volume di token, classifiche, quota di mercato, prezzi dei token, costo per sessione, rapporto cache e ripartizioni geografiche.",
  ...
  "home.topModelsDescription": "Utilizzo dei modelli in AWMate.",
  ...
  "home.uniqueUsersDescription": "Utenti unici giornalieri di AWMate per modello.",
  ...
  "lab.description":
    "Confronta i modelli {{lab}} usati in AWMate, inclusi utilizzo dei token, classifiche dei modelli, finestre di contesto, date di rilascio, costi e dati specifici del modello.",
  ...
  "model.description":
    "Visualizza i dati di utilizzo di {{model}} in AWMate, inclusi volume di token, rango settimanale, mix di token, costi, rapporto cache, sessioni, ripartizioni geografiche e modelli simili.",
  ...
  "model.catalogFallback":
    "Fatti del modello dall'indice condiviso dei modelli. L'utilizzo di AWMate appare quando questo modello ha attività.",
  "model.unranked": "Non classificato nell'utilizzo AWMate della scorsa settimana",
  "model.ranked": "Posizione #{{rank}} nell'utilizzo AWMate della scorsa settimana",
  ...
  "model.noCurrentUsage": "Nessun utilizzo di AWMate nella finestra dati attuale.",
  ...
  "model.inputs": "Input",
  "model.overviewDescription": "Token recenti di AWMate, utenti unici e posizione di mercato.",
  "model.noSummaryTitle": "Nessun riepilogo di utilizzo",
  "model.noSummaryDescription": "Questo modello non ha ancora righe di utilizzo di AWMate.",
  "model.tokens": "Token",
  ...
  "model.usageDescription": "Volume giornaliero di token AWMate nella recente finestra di due mesi.",
  ...
  "model.usersDescription": "Utenti unici giornalieri di AWMate nella recente finestra di due mesi.",
  ...
  "model.efficiencyDescription": "Costi, comportamento della cache e forma media della sessione AWMate.",
  ...
  "model.noGeoDescription": "Nessuna riga geografica AWMate corrispondeva a questo modello.",
  "model.peersDescription": "Modelli vicini per volume recente di token AWMate.",
