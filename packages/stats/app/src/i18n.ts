...
const en = {
  ...
  "app.description":
    "Explore AWMate usage across AI models, including token volume, rankings, market share, token pricing, session cost, cache ratio, and geo breakdowns.",
  ...
  "home.topModelsDescription": "Usage of models across AWMate.",
  ...
  "home.uniqueUsersDescription": "Daily unique AWMate users by model.",
  ...
  "lab.description":
    "Compare {{lab}} models used in AWMate, including token usage, model rankings, context windows, release dates, costs, and model-specific data.",
  ...
  "model.description":
    "View {{model}} AWMate usage data, including token volume, weekly rank, token mix, costs, cache ratio, sessions, geo breakdowns, and peer models.",
  ...
  "model.catalogFallback":
    "Model facts from the shared model index. AWMate usage appears once this model has activity.",
  "model.unranked": "Unranked across last week's AWMate usage",
  "model.ranked": "Ranked #{{rank}} across last week's AWMate usage",
  "model.observedVolume": "with {{share}} of observed 2M volume.",
  "model.weights": "Model weights: {{label}}",
  "model.rank": "7D Rank",
  "model.profile": "Model Profile",
  "model.listed": "Listed",
  "model.noCurrentUsage": "No AWMate usage in the current data window.",
  ...
  "model.noSummaryDescription": "This model has no AWMate usage rows yet.",
  "model.tokens": "Tokens",
  ...
  "model.noGeoDescription": "No AWMate geo rows matched this model.",
  "model.peersDescription": "Nearby models by recent AWMate token volume.",
