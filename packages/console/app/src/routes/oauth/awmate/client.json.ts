...
// OAuth Client ID Metadata Document for the awmate client.
// Spec: https://datatracker.ietf.org/doc/draft-ietf-oauth-client-id-metadata-document/
//
// When an MCP server's authorization server supports this, awmate sends this URL as its OAuth client_id
...
//
// redirect_uris have no port because awmate binds an ephemeral port per login. RFC 8252 section 7.3 has
// authorization servers ignore the port when matching loopback redirects for native apps.
const PATH = "/oauth/awmate/client.json"
