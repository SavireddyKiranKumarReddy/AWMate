...
import { Database, eq, and, gte, isNull, sql } from "@awmate/console-core/drizzle/index.js"
import { BillingTable, LiteTable, UsageTable } from "@awmate/console-core/schema/billing.sql.js"
        ...
        {(sub) => (
          <section class={styles.root}>
            ...
            <div data-slot="beta-notice">
              ...
              <a href={language.route("/docs/providers/#awmate-go")} target="_blank" rel="noopener noreferrer">
