...
export const dict = {
  ...
  "go.problem.body":
    "Nos enfocamos en llevar la experiencia de AWMate a tantas personas como sea posible. AWMate Go es una suscripción de bajo coste de 10 $/mes. Proporciona límites generosos y acceso fiable a los modelos de código abierto más capaces.",
  "go.problem.subtitle": " ",
  ...
  "go.how.body": "Go cuesta 10 $/mes. Puedes usarlo con AWMate o cualquier agente.",
  ...
  "workspace.lite.promo.description":
    "AWMate Go cuesta {{price}} y ofrece acceso confiable a modelos de codificación abiertos populares con límites de uso generosos.",
  ...
  "download.hero.title": "Descargar AWMate Desktop",
