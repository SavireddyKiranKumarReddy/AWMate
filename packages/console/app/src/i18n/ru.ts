...
export const dict = {
  ...
  "go.problem.body":
    "Мы стремимся сделать AWMate доступным для как можно большего числа людей. AWMate Go - это недорогая подписка за $10/месяц. Она предоставляет щедрые лимиты и надежный доступ к самым мощным моделям с открытым исходным кодом.",
  "go.problem.subtitle": " ",
  ...
  "go.how.body": "Go стоит $10/месяц. Вы можете использовать его с AWMate или любым агентом.",
  ...
  "workspace.lite.promo.description":
    "AWMate Go стоит {{price}} и предоставляет надежный доступ к популярным открытым моделям кодирования с щедрыми лимитами использования.",
  ...
  "download.hero.title": "Скачать AWMate Desktop",
