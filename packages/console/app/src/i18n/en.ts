export const dict = {
  ...
  "go.problem.body":
    "We're focused on bringing the AWMate experience to as many people as possible. AWMate Go is a low cost $10/month subscription. It provides generous limits and reliable access to the most capable open source models.",
  "go.problem.subtitle": " ",
  ...
  "go.how.body": "Go costs $10/month. You can use it with AWMate or any agent.",
  ...
  "workspace.lite.promo.description":
    "AWMate Go costs {{price}} and provides reliable access to popular open coding models with generous usage limits.",
