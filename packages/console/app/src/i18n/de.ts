...
export const dict = {
  ...
  "go.problem.body":
    "Wir konzentrieren uns darauf, die AWMate-Erfahrung so vielen Menschen wie möglich zugänglich zu machen. AWMate Go ist ein kostengünstiges Abonnement für $10/Monat. Es bietet großzügige Limits und zuverlässigen Zugang zu den leistungsfähigsten Open-Source-Modellen.",
  "go.problem.subtitle": " ",
  ...
  "go.how.body": "Go kostet $10/Monat. Du kannst es mit AWMate oder jedem Agenten nutzen.",
  ...
  "workspace.lite.promo.description":
    "AWMate Go kostet {{price}} und bietet zuverlässigen Zugang zu beliebten offenen Coding-Modellen mit großzügigen Nutzungslimits.",
  ...
  "download.hero.title": "AWMate Desktop herunterladen",
  ...
  "download.section.desktop": "AWMate Desktop",
