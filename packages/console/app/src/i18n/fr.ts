...
export const dict = {
  ...
  "go.problem.body":
    "Nous nous efforçons d'apporter l'expérience AWMate au plus grand nombre. AWMate Go est un abonnement à faible coût de 10 $/mois. Il offre des limites généreuses et un accès fiable aux modèles open source les plus performants.",
  "go.problem.subtitle": " ",
  ...
  "go.how.body": "Go coûte 10 $/mois. Vous pouvez l'utiliser avec AWMate ou n'importe quel agent.",
  ...
  "workspace.lite.promo.description":
    "AWMate Go coûte {{price}} et offre un accès fiable aux modèles de code ouverts populaires avec des limites d'utilisation généreuses.",
  ...
  "download.hero.title": "Télécharger AWMate Desktop",
