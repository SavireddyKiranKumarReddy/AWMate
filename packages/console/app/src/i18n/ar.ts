...
export const dict = {
  ...
  "go.problem.body":
    "نحن نركز على تقديم تجربة AWMate لأكبر عدد ممكن من الناس. AWMate Go هو اشتراك منخفض التكلفة بسعر $10/شهر. يوفر حدودا سخية ووصولا موثوقا إلى نماذج المصدر المفتوح الأكثر قدرة.",
  "go.problem.subtitle": " ",
  ...
  "go.how.body": "يبلغ سعر Go ‏$10/شهر. يمكنك استخدامه مع AWMate أو أي وكيل.",
  ...
  "workspace.lite.promo.description":
    "يبلغ سعر AWMate Go {{price}}، ويوفر وصولا موثوقا لنماذج البرمجة المفتوحة الشهيرة مع حدود استخدام سخية.",
  ...
  "download.hero.title": "تنزيل AWMate لسطح المكتب",
  ...
  "download.section.desktop": "AWMate لسطح المكتب",
