...
export const dict = {
  ...
  "go.problem.body":
    "Ci concentriamo nel portare l'esperienza AWMate a quante più persone possibile. AWMate Go è un abbonamento a basso costo da $10/mese. Offre limiti generosi e accesso affidabile ai modelli open source più capaci.",
  "go.problem.subtitle": " ",
  ...
  "go.how.body": "Go costa $10/mese. Puoi usarlo con AWMate o qualsiasi agente.",
  ...
  "workspace.lite.promo.description":
    "AWMate Go costa {{price}} e offre un accesso affidabile a popolari modelli di coding aperti con generosi limiti di utilizzo.",
  ...
  "download.hero.title": "Scarica AWMate Desktop",
