...
export const dict = {
  ...
  "go.problem.body":
    "Estamos focados em levar a experiência do AWMate para o maior número de pessoas possível. AWMate Go é uma assinatura de baixo custo de $10/mês. Oferece limites generosos e acesso confiável aos modelos open source mais capazes.",
  "go.problem.subtitle": " ",
  ...
  "go.how.body": "O Go custa $10/mês. Você pode usá-lo com o AWMate ou qualquer agente.",
  ...
  "workspace.lite.promo.description":
    "O AWMate Go custa {{price}} e oferece acesso confiável a modelos de codificação abertos populares com limites de uso generosos.",
  ...
  "download.hero.title": "Baixar AWMate Desktop",
