...
export const dict = {
  ...
  "go.problem.body":
    "私たちはAWMateの体験をできるだけ多くの人に届けることに注力しています。AWMate Goは月額$10の低価格なサブスクリプションです。ゆとりある上限と、最も高性能なオープンソースモデルへの信頼できるアクセスを提供します。",
  "go.problem.subtitle": " ",
  ...
  "go.how.title": "Goの仕組み",
  "go.how.body": "Goは月額$10です。AWMateまたは任意のエージェントで使えます。",
  ...
  "workspace.lite.promo.description":
    "AWMate Goは{{price}}で、人気の高いオープンコーディングモデルへの安定したアクセスと余裕のある利用枠を提供します。",
  ...
  "download.hero.title": "AWMate デスクトップ版をダウンロード",
