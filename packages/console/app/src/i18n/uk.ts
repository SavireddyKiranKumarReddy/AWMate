...
export const dict = {
  ...
  "go.problem.body":
    "Ми зосереджені на тому, щоб зробити досвід AWMate доступним для якомога більшої кількості людей. AWMate Go — це недорога підписка за $10/місяць. Вона надає щедрі ліміти та надійний доступ до найкращих моделей з відкритим кодом.",
  "go.problem.subtitle": " ",
  ...
  "go.how.body": "Go коштує $10/місяць. Використовуйте з AWMate або будь-яким агентом.",
  ...
  "workspace.lite.promo.description": "AWMate Go коштує {{price}} і має щедрі ліміти.",
  ...
  "download.hero.title": "Завантажити AWMate Desktop",
  ...
  "download.section.desktop": "Десктоп AWMate",
