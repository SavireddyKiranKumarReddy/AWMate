...
export const dict = {
  ...
  "go.problem.body":
    "Vi fokuserer på å bringe AWMate-opplevelsen til så mange som mulig. AWMate Go er et rimelig abonnement til $10/måned. Det gir sjenerøse grenser og pålitelig tilgang til de mest kapable åpen kildekode-modellene.",
  "go.problem.subtitle": " ",
  ...
  "go.how.body": "Go koster $10/måned. Du kan bruke det med AWMate eller hvilken som helst agent.",
  ...
  "workspace.lite.promo.description":
    "AWMate Go koster {{price}} og gir pålitelig tilgang til populære åpne kodingsmodeller med sjenerøse bruksgrenser.",
  ...
  "download.hero.title": "Last ned AWMate Desktop",
