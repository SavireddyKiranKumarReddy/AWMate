...
export const dict = {
  ...
  "go.problem.body":
    "เรามุ่งมั่นที่จะนำประสบการณ์ AWMate ไปสู่ผู้คนให้ได้มากที่สุด AWMate Go เป็นการสมัครสมาชิกราคาประหยัด $10/เดือน โดยมอบขีดจำกัดที่เอื้อเฟื้อและการเข้าถึงโมเดลโอเพนซอร์สที่มีความสามารถสูงสุดอย่างเชื่อถือได้",
  "go.problem.subtitle": " ",
  ...
  "go.how.body": "Go มีราคา $10/เดือน คุณสามารถใช้กับ AWMate หรือเอเจนต์ใดก็ได้",
  ...
  "workspace.lite.promo.description":
    "AWMate Go ราคา {{price}} และมอบการเข้าถึงโมเดลการเขียนโค้ดแบบเปิดยอดนิยมอย่างเสถียรพร้อมขีดจำกัดการใช้งานที่ให้มาอย่างเหลือเฟือ",
  ...
  "download.hero.title": "ดาวน์โหลด AWMate สำหรับเดสก์ท็อป",
