...
export const dict = {
  ...
  "go.problem.body":
    "Skupiamy się na udostępnieniu doświadczenia AWMate jak największej liczbie osób. AWMate Go to tania subskrypcja za $10/miesiąc. Zapewnia hojne limity i niezawodny dostęp do najbardziej wydajnych modeli open source.",
  "go.problem.subtitle": " ",
  ...
  "go.how.body": "Go kosztuje $10/miesiąc. Możesz go używać z AWMate lub dowolnym agentem.",
  ...
  "workspace.lite.promo.description":
    "AWMate Go kosztuje {{price}} i zapewnia niezawodny dostęp do popularnych otwartych modeli kodowania z hojnymi limitami użycia.",
  ...
  "download.hero.title": "Pobierz AWMate Desktop",
  ...
  "download.section.desktop": "Pulpit AWMate",
