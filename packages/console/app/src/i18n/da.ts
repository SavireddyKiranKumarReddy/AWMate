...
export const dict = {
  ...
  "go.problem.body":
    "Vi fokuserer på at bringe AWMate-oplevelsen ud til så mange som muligt. AWMate Go er et lavprisabonnement til $10/måned. Det giver generøse grænser og pålidelig adgang til de mest kapable open source-modeller.",
  "go.problem.subtitle": " ",
  ...
  "go.how.body": "Go koster $10/måned. Du kan bruge det med AWMate eller enhver agent.",
  ...
  "workspace.lite.promo.description":
    "AWMate Go koster {{price}} og giver pålidelig adgang til populære åbne kodningsmodeller med generøse brugsgrænser.",
  ...
  "download.hero.title": "Download AWMate Desktop",
