...
export const dict = {
  ...
  "go.problem.body":
    "我们致力于将 AWMate 体验带给尽可能多的人。AWMate Go 是一款每月 $10 的低成本订阅服务。它提供充裕的额度，并让您能可靠地使用最强大的开源模型。",
  "go.problem.subtitle": " ",
  ...
  "go.how.body": "Go 每月 $10。您可以将其与 AWMate 或任何代理搭配使用。",
  ...
  "workspace.lite.promo.description":
    "AWMate Go 每月 {{price}}，并提供对流行开放编码模型的可靠访问，同时享有充裕的使用限额。",
