...
export const dict = {
  ...
  "go.problem.body":
    "AWMate deneyimini mümkün olduğunca çok kişiye ulaştırmaya odaklandık. AWMate Go, ayda 10$ olan düşük maliyetli bir aboneliktir. Cömert limitler ve en yetenekli açık kaynak modellere güvenilir erişim sağlar.",
  "go.problem.subtitle": " ",
  ...
  "go.how.body": "Go ayda 10$'dır. AWMate veya herhangi bir ajanla kullanabilirsiniz.",
  ...
  "workspace.lite.promo.description":
    "AWMate Go {{price}} fiyatıyla cömert kullanım limitleri ve popüler açık kodlama modellerine güvenilir erişim sağlar.",
  ...
  "download.hero.title": "AWMate Desktop'u İndir",
