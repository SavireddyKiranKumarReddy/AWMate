...
export const dict = {
  ...
  "go.problem.body":
    "우리는 가능한 많은 사람들에게 AWMate 경험을 제공하는 데 집중하고 있습니다. AWMate Go는 월 $10의 저렴한 구독 서비스입니다. 넉넉한 한도와 가장 뛰어난 오픈 소스 모델에 대한 안정적인 액세스를 제공합니다.",
  "go.problem.subtitle": " ",
  ...
  "go.how.body": "Go는 월 $10입니다. AWMate 또는 어떤 에이전트와도 함께 사용할 수 있습니다.",
  ...
  "workspace.lite.promo.description":
    "AWMate Go는 {{price}}로 넉넉한 사용량 한도와 함께 인기 있는 오픈 코딩 모델에 대한 안정적인 액세스를 제공합니다.",
  ...
  "download.hero.title": "AWMate 데스크톱 다운로드",
  ...
  "download.section.desktop": "AWMate 데스크톱",
