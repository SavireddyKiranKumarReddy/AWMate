...
export const dict = {
  ...
  "go.problem.body":
    "我們致力於將 AWMate 體驗帶給盡可能多的人。AWMate Go 是一款每月 $10 的低成本訂閱服務。它提供充裕的額度，並讓您能可靠地使用最強大的開源模型。",
  "go.problem.subtitle": " ",
  ...
  "go.how.body": "Go 每月 $10。您可以將其與 AWMate 或任何代理搭配使用。",
  ...
  "workspace.lite.promo.description":
    "AWMate Go 每月 {{price}}，並提供對熱門開放編碼模型的可靠存取，同時享有充裕的使用額度。",
  ...
  "download.hero.title": "下載 AWMate 桌面版",
