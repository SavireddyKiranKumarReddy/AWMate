export const dict = {
  ...
  "desktop.recovery.loadFailed": "AWMate laadimine ebaõnnestus",
  "desktop.recovery.terminated": "AWMate aken suleti ootamatult",
  "desktop.recovery.unresponsive": "AWMate ei vasta",
  ...
  "desktop.wsl.error.installAWMate": "AWMate installimine ebaõnnestus",
  "desktop.wsl.error.alreadyAdded": "{{distro}} on juba lisatud",
  "desktop.wsl.error.awmateMissing": "awmate pole sellesse distrosse installitud",
  "desktop.wsl.error.awmateCannotRun": "awmate on installitud, kuid seda ei saa käivitada",
  "desktop.wsl.error.awmateNotInstalled": "AWMate pole installitud asukohta {{distro}}",
  "desktop.wsl.error.updateVersion":
    "AWMate värskendus on lõpetatud, kuid {{distro}} teatab endiselt {{installed}}; oodata {{expected}}",
  ...
  "dialog.provider.awmate.note": "Kureeritud mudelid, sealhulgas Claude, GPT, Gemini ja palju muud",
  "dialog.provider.awmate.tagline": "Usaldusväärsed optimeeritud mudelid",
  "dialog.provider.awmateGo.tagline": "Madala hinnaga tellimus kõigile",
  ...
  "dialog.model.unpaid.freeModels.title": "Tasuta mudeleid pakub AWMate",
  ...
  "provider.connect.apiKey.description":
    "Sisestage {{provider}} API võti, et ühendada konto ja kasutada {{provider}} mudeleid AWMate'is.",
  ...
  "provider.connect.awmateZen.line1":
    "AWMate Zen annab teile juurdepääsu kodeerimisagentide usaldusväärsete optimeeritud mudelite kureeritud komplektile.",
  ...
  "provider.connect.awmateZen.visit.prefix": "Külastage ",
  "provider.connect.awmateZen.visit.link": "opencode.ai/zen",
  "provider.connect.awmateZen.visit.suffix": " API võtme kättesaamiseks.",
  "provider.connect.oauth.code.visit.prefix": "Külastage ",
  "provider.connect.oauth.code.visit.link": "see link",
  "provider.connect.oauth.code.visit.suffix":
    " konto ühendamiseks autoriseerimiskoodi kogumiseks ja {{provider}} mudeli kasutamiseks jaotises AWMate.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " ja sisestage allolev kood, et ühendada oma konto ja kasutada {{provider}} mudelit jaotises AWMate.",
  ...
  "dialog.plugins.empty": "Pluginad on konfigureeritud failis awmate.json",
  ...
  "dialog.server.description": "Lülitage, millise AWMate serveriga see rakendus ühenduse loob.",
  ...
  "wsl.onboarding.checkingAWMate": "AWMate kontrollimine...",
  "wsl.onboarding.checkingAWMateIn": "AWMate kontrollimine asukohas {{distro}}...",
  "wsl.onboarding.updatingAWMate": "AWMate värskendamine...",
  "wsl.onboarding.updatingAWMateIn": "AWMate värskendamine asukohas {{distro}}...",
  "wsl.onboarding.updateAWMateIn": "Värskenda AWMate jaotises {{distro}}.",
  "wsl.onboarding.updateAWMate": "Värskenda AWMate",
  "wsl.onboarding.awmateReadyIn": "AWMate on valmis {{distro}}.",
  "wsl.onboarding.awmateReady": "AWMate on valmis.",
  "wsl.onboarding.installAWMateIn": "Installige AWMate asukohta {{distro}}.",
  "wsl.onboarding.installAWMate": "Installige AWMate",
  ...
  "wsl.onboarding.distroStatus.awmateMissing": "AWMate pole installitud",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows alamsüsteem Linux jaoks) on nõutav, enne kui AWMate saab lisada WSL serveri",
  "wsl.onboarding.wslUnavailable.title": "WSL pole saadaval",
  "wsl.onboarding.wslUnavailable.description": "AWMate ei saanud selles masinas kontrollida WSL.",
  "wsl.onboarding.installWsl": "Installige WSL",
  "wsl.onboarding.windowsRestartRequired": "Taaskäivitage Windows, et installida WSL, seejärel avage uuesti AWMate.",
  ...
  "help.tabs.introduction": "AWMate Töölaud on nüüd üles ehitatud vahekaartide ümber.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Rakenduse AWMate ({{version}}) uus versioon on nüüd installimiseks saadaval.",
  ...
  "error.page.report.prefix": "Teatage sellest veast AWMate meeskonnale",
  ...
  "error.chain.checkConfig": "Kontrollige oma konfiguratsiooni (awmate.json) pakkuja/mudeli nimesid",
  "error.chain.mcpFailed": 'MCP server "{{name}}" ebaõnnestus. Pange tähele, AWMate ei toeta veel MCP autentimist.',
  ...
  "sidebar.gettingStarted.line1": "AWMate sisaldab tasuta mudeleid, nii et saate kohe alustada.",
  ...
  "app.name.desktop": "AWMate Töölaud",
  ...
  "settings.desktop.wsl.description": "Käivitage AWMate server sees WSL saidil Windows.",
  ...
  "settings.general.row.language.description": "Muutke AWMate kuvakeelt",
  ...
  "settings.general.row.appearance.description": "Kohandage, kuidas AWMate teie seadmes välja näeb",
  "settings.general.row.colorScheme.title": "Värvilahendus",
  "settings.general.row.colorScheme.description": "Valige, kas AWMate järgib süsteemi, heledat või tumedat teemat",
  "settings.general.row.theme.title": "Teema",
  "settings.general.row.theme.description": "Kohandage, kuidas AWMate on teemastatud.",
  ...
  "settings.updates.row.startup.description": "Kontrollige automaatselt värskendusi, kui AWMate käivitub",
  ...
  "settings.updates.toast.latest.description": "Kasutate rakenduse AWMate uusimat versiooni.",
