export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacija za AWMate",
  ...
  "desktop.recovery.loadFailed": "AWMate se nije uspio učitati",
  "desktop.recovery.terminated": "Prozor AWMate-a neočekivano je zatvoren",
  "desktop.recovery.unresponsive": "AWMate ne reaguje",
  ...
  "desktop.wsl.error.installAWMate": "Instalacija AWMate-a nije uspjela",
  "desktop.wsl.error.alreadyAdded": "Distribucija {{distro}} je već dodana",
  "desktop.wsl.error.awmateMissing": "awmate nije instaliran u ovoj distribuciji",
  "desktop.wsl.error.awmateCannotRun": "awmate je instaliran, ali se ne može pokrenuti",
  "desktop.wsl.error.awmateNotInstalled": "AWMate nije instaliran u distribuciji {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Ažuriranje AWMate-a je završeno, ali {{distro}} i dalje prijavljuje {{installed}}; očekivano je {{expected}}",
  ...
  "dialog.provider.awmateGo.tagline": "Povoljna pretplata za sve",
  ...
  "provider.connect.awmateZen.visit.prefix": "Posjeti ",
  "provider.connect.awmateZen.visit.link": "opencode.ai/zen",
  "provider.connect.awmateZen.visit.suffix": " da preuzmeš svoj API ključ.",
  ...
  "wsl.onboarding.checkingAWMateIn": "Provjera AWMate u distribuciji {{distro}}...",
  "wsl.onboarding.updatingAWMate": "Ažuriranje AWMate...",
  "wsl.onboarding.updatingAWMateIn": "Ažuriranje AWMate u distribuciji {{distro}}...",
  "wsl.onboarding.updateAWMateIn": "Ažuriraj AWMate u distribuciji {{distro}}.",
  "wsl.onboarding.updateAWMate": "Ažuriraj AWMate",
  "wsl.onboarding.awmateReadyIn": "AWMate je spreman u distribuciji {{distro}}.",
  ...
  "help.tabs.introduction": "AWMate Desktop sada je organizovan oko kartica.",
  "help.tabs.sessions":
  ...
  "error.chain.checkConfig": "Provjeri nazive provajdera/modela u konfiguraciji (awmate.json)",
