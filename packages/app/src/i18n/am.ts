export const dict = {
  ...
  "desktop.recovery.loadFailed": "AWMate መጫን አልቻለም",
  "desktop.recovery.terminated": "AWMate መስኮት በድንገት ተቋርጧል",
  "desktop.recovery.unresponsive": "AWMate ምላሽ እየሰጠ አይደለም",
  ...
  "desktop.wsl.error.installAWMate": "AWMateመጫኑ አልተሳካም",
  "desktop.wsl.error.alreadyAdded": "{{distro}} አስቀድሞ ታክሏል",
  "desktop.wsl.error.awmateMissing": "ክፍት ኮድ በዚህ ዲስትሪ ውስጥ አልተጫነም",
  "desktop.wsl.error.awmateCannotRun": "ክፍት ኮድ ተጭኗል ግን ማሄድ አልቻለም",
  "desktop.wsl.error.awmateNotInstalled": "AWMate በ{{distro}}] ውስጥ አልተጫነም",
  "desktop.wsl.error.updateVersion":
    "AWMate ዝማኔ አልቋል ግን {{distro}} አሁንም ሪፖርት ያደርጋል {{installed}}; የሚጠበቀው {{expected}}",
  ...
  "dialog.provider.awmate.note": "Claude፣ GPT፣ Gemini እና ሌሎችንም ጨምሮ የተስተካከሉ ሞዴሎች",
  "dialog.provider.awmate.tagline": "ታማኝ የተመቻቹ ሞዴሎች",
  "dialog.provider.awmateGo.tagline": "ዝቅተኛ ወጪ ለሁሉም ሰው",
  ...
  "dialog.model.unpaid.freeModels.title": "ነጻ ሞዴሎች በAWMate",
  ...
  "provider.connect.apiKey.description":
    "መለያዎን ለማገናኘት የ{{provider}} API ቁልፍዎን ያስገቡ እና {{provider}} ሞዴሎችን በAWMate ይጠቀሙ።",
  ...
  "provider.connect.awmateZen.line1": "AWMate ዜን ለኮድ ወኪሎች የተመቻቹ አስተማማኝ ሞዴሎች ስብስብ መዳረሻ ይሰጥዎታል።",
  "provider.connect.awmateZen.line2": "በአንድ የAPI ቁልፍ እንደ Claude፣ GPT፣ Gemini፣ GLM እና ሌሎችም ያሉ ሞዴሎችን መድረስ ይችላሉ።",
  "provider.connect.awmateZen.visit.prefix": "ጎብኝ ",
  "provider.connect.awmateZen.visit.link": "opencode.ai/zen",
  "provider.connect.awmateZen.visit.suffix": " የእርስዎን API ቁልፍ ለመሰብሰብ።",
  "provider.connect.oauth.code.visit.prefix": "ጎብኝ ",
  "provider.connect.oauth.code.visit.link": "ይህ ሊንክ",
  "provider.connect.oauth.code.visit.suffix":
    " መለያዎን ለማገናኘት የፈቀዳ ኮድዎን ለመሰብሰብ እና {{provider}} ሞዴሎችን በAWMate ውስጥ ይጠቀሙ።",
  ...
  "provider.connect.oauth.auto.visit.suffix": " እና መለያዎን ለማገናኘት ከታች ያለውን ኮድ ያስገቡ እና {{provider}} ሞዴሎችን በAWMate ይጠቀሙ።",
  ...
  "dialog.plugins.empty": "plugins በ awmate.json የተዋቀሩ",
  ...
  "dialog.server.description": "ይህ መተግበሪያ ከየትኛው AWMate አገልጋይ ጋር እንደሚገናኝ ይቀይሩ።",
  ...
  "wsl.onboarding.checkingAWMate": "መፈተሽ AWMate...",
  "wsl.onboarding.checkingAWMateIn": "AWMateን በ{{distro}} ውስጥ በመፈተሽ ላይ...",
  "wsl.onboarding.updatingAWMate": "በማዘመን ላይ AWMate...",
  "wsl.onboarding.updatingAWMateIn": "በማዘመን ላይ AWMate በ{{distro}}...",
  "wsl.onboarding.updateAWMateIn": "አዘምን AWMate በ{{distro}}።",
  "wsl.onboarding.updateAWMate": "አዘምን AWMate",
  "wsl.onboarding.awmateReadyIn": "AWMate በ{{distro}} ውስጥ ዝግጁ ነው።",
  "wsl.onboarding.awmateReady": "AWMate ዝግጁ ነው።",
  "wsl.onboarding.installAWMateIn": "መጫን AWMate በ{{distro}} ውስጥ።",
  "wsl.onboarding.installAWMate": "ጫን AWMate",
  ...
  "wsl.onboarding.distroStatus.awmateMissing": "AWMateአልተጫነም",
  ...
  "wsl.onboarding.wslNotInstalled.description": "WSL (Windowsንዑስ ስርዓት ለLinux) AWMate WSL አገልጋይ ከመጨመራቸው በፊት ያስፈልጋል",
  "wsl.onboarding.wslUnavailable.title": "WSL አይገኝም",
  "wsl.onboarding.wslUnavailable.description": "AWMate በዚህ ማሽን ላይ WSLን ማረጋገጥ አልቻለም።",
  "wsl.onboarding.installWsl": "ጫን WSL",
  "wsl.onboarding.windowsRestartRequired": "WSLን መጫኑን ለመጨረስ Windows እንደገና ያስጀምሩ እና ከዚያ እንደገና ይክፈቱ AWMate።",
  ...
  "help.tabs.introduction": "AWMate ዴስክቶፕ አሁን በትሮች ዙሪያ ነው የተሰራው።",
  "help.tabs.sessions":
  ...
  "toast.update.description": "አዲሱ የAWMate ({{version}}) ስሪት አሁን ለመጫን አለ።",
  ...
  "error.page.report.prefix": "እባክዎ ይህንን ስህተት ለAWMate ቡድን ያሳውቁ",
  ...
  "error.chain.checkConfig": "የእርስዎን ውቅር (awmate.json) አቅራቢ/የሞዴል ስሞችን ያረጋግጡ",
  "error.chain.mcpFailed": 'MCP አገልጋይ "{{name}}" አልተሳካም። ማስታወሻ፣ AWMate እስካሁን MCP ማረጋገጫን አይደግፍም።',
  ...
  "sidebar.gettingStarted.line1": "AWMate ነፃ ሞዴሎችን ያካትታል ስለዚህ ወዲያውኑ መጀመር ይችላሉ።",
  ...
  "settings.desktop.wsl.description": "የAWMate አገልጋዩን በWSL ውስጥ በWindows ላይ ያሂዱ።",
  ...
  "settings.general.row.language.description": "የማሳያ ቋንቋውን ለAWMate",
  ...
  "settings.general.row.appearance.description": "AWMateበመሣሪያዎ ላይ እንዴት እንደሚታይ ብጁ ያድርጉ",
  "settings.general.row.colorScheme.title": "የቀለም ንድፍ",
  "settings.general.row.colorScheme.description": "AWMate ስርዓቱን፣ ብርሃንን ወይም ጨለማውን ገጽታ የሚከተል እንደሆነ ምረጥ",
  "settings.general.row.theme.title": "ገጽታ",
  "settings.general.row.theme.description": "AWMate ገጽታ እንዴት እንደሆነ አብጅ።",
  ...
  "settings.updates.row.startup.description": "AWMate ሲጀመር ዝማኔዎችን በራስ-ሰር ያረጋግጡ",
  ...
  "settings.updates.toast.latest.description": "የቅርብ ጊዜውን የAWMate እትም እያሄዱ ነው።",
