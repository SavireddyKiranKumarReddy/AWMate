export const dict = {
  ...
  "desktop.menu.documentation": "AWMate Skjøl",
  ...
  "desktop.menu.ariaLabel": "AWMate valmynd",
  ...
  "desktop.recovery.loadFailed": "AWMate miseydnaðist at heinta",
  "desktop.recovery.terminated": "AWMate vindeygað endað óvæntað",
  "desktop.recovery.unresponsive": "AWMate svarar ikki",
  ...
  "desktop.wsl.error.installAWMate": "AWMate uppsetingin miseydnaðist",
  "desktop.wsl.error.alreadyAdded": "{{distro}} er longu lagt afturat .",
  "desktop.wsl.error.awmateMissing": "awmate er ikki sett upp í hesi distro",
  "desktop.wsl.error.awmateCannotRun": "awmate er sett upp men kundi ikki koyra",
  "desktop.wsl.error.awmateNotInstalled": "AWMate er ikki sett upp í {{distro}}",
  "desktop.wsl.error.updateVersion":
    "AWMate dagføring liðug men {{distro}} greiðir enn frá {{installed}}; væntað {{expected}}.",
  ...
  "dialog.provider.awmate.note": "Kuraterað modell íroknað Claude, GPT, Gemini og fleiri",
  "dialog.provider.awmate.tagline": "Álítandi optimerað modell",
  "dialog.provider.awmateGo.tagline": "Lágkostnaðarhald fyri øll",
  ...
  "dialog.model.unpaid.freeModels.title": "Ókeypis modellir veitt av AWMate",
  ...
  "provider.connect.apiKey.description":
    "Skriva {{provider}} API-lykilin fyri at knýta kontuna saman og brúka {{provider}}-modell í AWMate.",
  ...
  "provider.connect.awmateZen.line1":
    "AWMate Zen gevur tær atgongd til eitt kuraterað sett av álítandi optimeraðum modellum til kodingaragentar.",
  "provider.connect.awmateZen.line2":
    "Við einum API lykli fært tú atgongd til modellir sum Claude, GPT, Gemini, GLM og fleiri.",
  "provider.connect.awmateZen.visit.prefix": "Vitja ",
  "provider.connect.awmateZen.visit.link": "opencode.ai/zen",
  "provider.connect.awmateZen.visit.suffix": " fyri at savna tín API lykil.",
  "provider.connect.oauth.code.visit.prefix": "Vitja ",
  "provider.connect.oauth.code.visit.link": "hesa leinkjuna",
  "provider.connect.oauth.code.visit.suffix":
    " at savna inn tína heimildarkotu til at knýta tína kontu saman og brúka {{provider}} modellir í AWMate.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriva kotuna niðanfyri fyri at knýta tína kontu saman og brúka {{provider}} modellir í AWMate.",
  ...
  "dialog.plugins.empty": "Tilskot uppsett í awmate.json",
  ...
  "dialog.server.description": "Skift hvønn AWMate ambætara henda appin hevur samband við.",
  ...
  "wsl.onboarding.checkingAWMate": "Kanna AWMate...",
  "wsl.onboarding.checkingAWMateIn": "Kanna AWMate í {{distro}}...",
  "wsl.onboarding.updatingAWMate": "Dagføring AWMate...",
  "wsl.onboarding.updatingAWMateIn": "Dagføring AWMate í {{distro}}...",
  "wsl.onboarding.updateAWMateIn": "Dagfør AWMate í {{distro}}.",
  "wsl.onboarding.updateAWMate": "Dagfør AWMate",
  "wsl.onboarding.awmateReadyIn": "AWMate er klárt í {{distro}}.",
  "wsl.onboarding.awmateReady": "AWMate er klárt.",
  "wsl.onboarding.installAWMateIn": "Set AWMate upp í {{distro}}.",
  "wsl.onboarding.installAWMate": "Set upp AWMate",
  ...
  "wsl.onboarding.distroStatus.awmateMissing": "AWMate ikki innstillað",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Undirskipan til Linux) er kravd áðrenn AWMate kann leggja ein WSL ambætara til",
  "wsl.onboarding.wslUnavailable.title": "WSL ikki tøkt",
  "wsl.onboarding.wslUnavailable.description": "AWMate kundi ikki staðfesta WSL á hesi maskinuni.",
  "wsl.onboarding.installWsl": "Set upp WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Endurbyrja Windows fyri at klára at seta upp WSL, og opna síðani AWMate aftur.",
  ...
  "help.tabs.introduction": "AWMate Skrivaraborð er nú bygt rundan um flikar.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Ein nýggj útgáva av AWMate ({{version}}) er nú tøk at seta upp.",
  ...
  "error.page.report.prefix": "Vinarliga melda hendan feilin til AWMate toymið",
  ...
  "error.chain.checkConfig": "Kanna tíni uppseting (awmate.json) veitara/modell nøvn",
  "error.chain.mcpFailed": 'MCP ambætarin "{{name}}" miseydnaðist. Viðmæli, AWMate stuðlar ikki MCP sannroynd enn.',
  ...
  "sidebar.gettingStarted.line1": "AWMate inniheldur ókeypis modellir so tú kanst byrja beinanvegin.",
  ...
  "app.name.desktop": "AWMate Skrivaraborð",
  ...
  "settings.desktop.wsl.description": "Koyr AWMate ambætaran inni í WSL á Windows.",
  ...
  "settings.general.row.language.description": "Broyt sýnismálið fyri AWMate",
  ...
  "settings.general.row.appearance.description": "Tillaga hvussu AWMate sær út á tínari eind",
  "settings.general.row.colorScheme.title": "Litskipan",
  "settings.general.row.colorScheme.description": "Vel um AWMate fylgir skipanini, ljósa ella myrka temanum",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tillaga hvussu AWMate er tema.",
  ...
  "settings.updates.row.startup.description": "Kanna sjálvvirkandi fyri dagføringum, tá AWMate byrjar",
  ...
  "settings.updates.toast.latest.description": "Tú koyrir nýggjastu útgávuna av AWMate.",
