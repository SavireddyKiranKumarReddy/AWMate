export const dict = {
  ...
  "desktop.menu.documentation": "AWMate Dokumentacija",
  ...
  "desktop.menu.ariaLabel": "AWMate meni",
  ...
  "desktop.recovery.loadFailed": "AWMate ni uspelo naložiti",
  "desktop.recovery.terminated": "Okno AWMate se je nepričakovano končalo",
  "desktop.recovery.unresponsive": "AWMate se ne odziva",
  ...
  "desktop.wsl.error.installAWMate": "Namestitev AWMate ni uspela",
  "desktop.wsl.error.alreadyAdded": "{{distro}} je že dodan",
  "desktop.wsl.error.awmateMissing": "awmate ni nameščen v tej distribuciji",
  "desktop.wsl.error.awmateCannotRun": "awmate je nameščen, vendar se ne more zagnati",
  "desktop.wsl.error.awmateNotInstalled": "AWMate ni nameščen v {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Posodobitev AWMate je končana, vendar {{distro}} še vedno poroča {{installed}}; pričakovano {{expected}}",
  ...
  "dialog.provider.awmate.note": "Izbrani modeli, vključno z Claude, GPT, Gemini in drugimi",
  "dialog.provider.awmate.tagline": "Zanesljivi optimizirani modeli",
  "dialog.provider.awmateGo.tagline": "Poceni naročnina za vsakogar",
  ...
  "dialog.model.unpaid.freeModels.title": "Brezplačne modele ponuja AWMate",
  ...
  "provider.connect.apiKey.description":
    "Vnesite ključ API ponudnika {{provider}}, da povežete račun in uporabljate modele {{provider}} v AWMate.",
  ...
  "provider.connect.awmateZen.line1":
    "AWMate Zen vam omogoča dostop do izbranega nabora zanesljivih optimiziranih modelov za agente za kodiranje.",
  ...
  "provider.connect.awmateZen.visit.prefix": "Obisk ",
  "provider.connect.awmateZen.visit.link": "opencode.ai/zen",
  "provider.connect.awmateZen.visit.suffix": " za prevzem ključa API.",
  "provider.connect.oauth.code.visit.prefix": "Obisk ",
  "provider.connect.oauth.code.visit.link": "ta povezava",
  "provider.connect.oauth.code.visit.suffix":
    " za zbiranje avtorizacijske kode za povezavo vašega računa in uporabo modelov {{provider}} v AWMate.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " in vnesite spodnjo kodo, da povežete svoj račun in uporabite modele {{provider}} v AWMate.",
  ...
  "dialog.plugins.empty": "Vtičniki, konfigurirani v awmate.json",
  ...
  "dialog.server.description": "Preklopite, s katerim strežnikom AWMate se povezuje ta aplikacija.",
  ...
  "wsl.onboarding.checkingAWMate": "Preverjanje AWMate ...",
  "wsl.onboarding.checkingAWMateIn": "Preverjanje AWMate v {{distro}} ...",
  "wsl.onboarding.updatingAWMate": "Posodabljanje AWMate ...",
  "wsl.onboarding.updatingAWMateIn": "Posodabljanje AWMate v {{distro}} ...",
  "wsl.onboarding.updateAWMateIn": "Posodobite AWMate v {{distro}}.",
  "wsl.onboarding.updateAWMate": "Posodobite AWMate",
  "wsl.onboarding.awmateReadyIn": "AWMate je pripravljen v {{distro}}.",
  "wsl.onboarding.awmateReady": "AWMate je pripravljen.",
  "wsl.onboarding.installAWMateIn": "Namestite AWMate v {{distro}}.",
  "wsl.onboarding.installAWMate": "Namestite AWMate",
  ...
  "wsl.onboarding.distroStatus.awmateMissing": "AWMate ni nameščen",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (podsistem Windows za Linux) je potreben, preden lahko AWMate doda strežnik WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL ni na voljo",
  "wsl.onboarding.wslUnavailable.description": "AWMate ni mogel preveriti WSL na tej napravi.",
  "wsl.onboarding.installWsl": "Namestite WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Znova zaženite Windows, da dokončate namestitev WSL, nato znova odprite AWMate.",
  ...
  "help.tabs.introduction": "AWMate Desktop je zdaj zgrajen okoli zavihkov.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova različica AWMate ({{version}}) je zdaj na voljo za namestitev.",
  ...
  "error.page.report.prefix": "Prosimo, prijavite to napako ekipi AWMate",
  ...
  "error.chain.checkConfig": "Preverite imena ponudnikov/modelov konfiguracije (awmate.json).",
  "error.chain.mcpFailed": 'MCP strežnik "{{name}}" ni uspel. Opomba, AWMate še ne podpira avtentikacije MCP.',
  ...
  "sidebar.gettingStarted.line1": "AWMate vključuje brezplačne modele, tako da lahko začnete takoj.",
  ...
  "settings.desktop.wsl.description": "Zaženite strežnik AWMate znotraj WSL na Windows.",
  ...
  "settings.general.row.language.description": "Spremenite jezik prikaza za AWMate",
  ...
  "settings.general.row.appearance.description": "Prilagodite, kako AWMate izgleda na vaši napravi",
  "settings.general.row.colorScheme.title": "Barvna shema",
  "settings.general.row.colorScheme.description": "Izberite, ali AWMate sledi sistemski, svetli ali temni temi",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodite temo AWMate.",
  ...
  "settings.updates.row.startup.description": "Samodejno preveri posodobitve, ko se zažene AWMate",
  ...
  "settings.updates.toast.latest.description": "Uporabljate najnovejšo različico AWMate.",
