export const dict = {
  ...
  "desktop.menu.documentation": "Documentación de AWMate",
  ...
  "desktop.menu.ariaLabel": "Menú de AWMate",
  ...
  "desktop.recovery.loadFailed": "No se pudo cargar AWMate",
  "desktop.recovery.terminated": "La ventana de AWMate se cerró de forma inesperada",
  "desktop.recovery.unresponsive": "AWMate no responde",
  ...
  "desktop.wsl.error.installAWMate": "No se pudo instalar AWMate",
  "desktop.wsl.error.alreadyAdded": "Ya se ha añadido {{distro}}",
  "desktop.wsl.error.awmateMissing": "awmate no está instalado en esta distribución",
  "desktop.wsl.error.awmateCannotRun": "awmate está instalado, pero no se pudo ejecutar",
  "desktop.wsl.error.awmateNotInstalled": "AWMate no está instalado en {{distro}}",
  "desktop.wsl.error.updateVersion":
    "La actualización de AWMate finalizó, pero {{distro}} sigue indicando {{installed}}; se esperaba {{expected}}",
  ...
  "dialog.provider.awmate.note": "Selección de modelos como Claude, GPT, Gemini y otros",
  "dialog.provider.awmate.tagline": "Modelos optimizados y fiables",
  "dialog.provider.awmateGo.tagline": "Suscripción económica para todos",
  ...
  "provider.connect.awmateZen.visit.suffix": " para obtener tu clave API.",
  ...
  "dialog.server.description": "Cambiar el servidor de AWMate al que se conecta esta aplicación.",
  ...
  "wsl.onboarding.checkingAWMate": "Comprobando AWMate...",
  "wsl.onboarding.checkingAWMateIn": "Comprobando AWMate en {{distro}}...",
  "wsl.onboarding.updatingAWMate": "Actualizando AWMate...",
  "wsl.onboarding.updatingAWMateIn": "Actualizando AWMate en {{distro}}...",
  "wsl.onboarding.updateAWMateIn": "Actualiza AWMate en {{distro}}.",
  "wsl.onboarding.updateAWMate": "Actualizar AWMate",
  "wsl.onboarding.awmateReadyIn": "AWMate está listo en {{distro}}.",
  "wsl.onboarding.awmateReady": "AWMate está listo.",
  ...
  "wsl.onboarding.distroStatus.awmateMissing": "AWMate no está instalado",
  ...
  "help.tabs.introduction": "AWMate Desktop ahora se organiza en torno a pestañas.",
  "help.tabs.sessions":
  ...
  "error.page.report.prefix": "Informa de este error al equipo de AWMate",
  ...
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota: AWMate aún no admite la autenticación MCP.',
