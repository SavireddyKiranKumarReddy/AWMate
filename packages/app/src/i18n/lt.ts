...
const desktop = [
  ...
  "Laukti toliau",
  "Baigti darbą",
  "AWMate įkelti nepavyko",
  "AWMate langas netikėtai užsidarė",
  "AWMate neatsako",
  ...
  "AWMate įdiegti nepavyko",
  "{{distro}} jau pridėtas",
  "awmate šiame distributyve neįdiegtas",
  "awmate įdiegtas, bet jo paleisti nepavyko",
  "AWMate neįdiegtas distributyve {{distro}}",
  "AWMate naujinimas baigtas, bet {{distro}} vis dar praneša {{installed}}; tikėtasi {{expected}}",
  "versijos nėra",
...
export const dict = {
  ...
  "dialog.provider.awmate.note": "Kuruojami modeliai, įskaitant Claude, GPT, Gemini ir kt.",
  "dialog.provider.awmate.tagline": "Patikimi optimizuoti modeliai",
  "dialog.provider.awmateGo.tagline": "Mažos kainos abonementas visiems",
  ...
  "dialog.model.unpaid.freeModels.title": "Nemokami AWMate modeliai",
  ...
  "provider.connect.apiKey.description":
    "Įveskite {{provider}} API raktą, kad susietumėte paskyrą ir naudotumėte {{provider}} modelius programoje AWMate.",
  ...
  "provider.connect.awmateZen.line1":
    "AWMate Zen suteikia prieigą prie kuruojamo patikimų optimizuotų kodavimo agentų modelių rinkinio.",
  "provider.connect.awmateZen.line2":
    "Su vienu API raktu galėsite pasiekti tokius modelius kaip Claude, GPT, Gemini, GLM ir kt.",
  "provider.connect.awmateZen.visit.prefix": "Aplankykite",
  "provider.connect.awmateZen.visit.link": "opencode.ai/zen",
  "provider.connect.awmateZen.visit.suffix": "norėdami pasiimti savo API raktą.",
  "provider.connect.oauth.code.visit.prefix": "Aplankykite",
  "provider.connect.oauth.code.visit.link": "šią nuorodą",
  "provider.connect.oauth.code.visit.suffix":
    "rinkti prieigos kodą, kad galėtumėte prisijungti prie paskyros ir naudoti {{provider}} modelius AWMate.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "ir įveskite toliau esantį kodą, kad susietumėte paskyrą ir naudotumėte {{provider}} modelius AWMate.",
  ...
  "dialog.plugins.empty": "Papildiniai sukonfigūruoti awmate.json",
  ...
  "dialog.server.description": "Perjunkite, prie kurio AWMate serverio jungiasi ši programa.",
  ...
  "wsl.onboarding.checkingAWMate": "Tikrinama AWMate...",
  "wsl.onboarding.checkingAWMateIn": "Tikrinama AWMate {{distro}}...",
  "wsl.onboarding.updatingAWMate": "Atnaujinamas AWMate...",
  "wsl.onboarding.updatingAWMateIn": "Atnaujinamas AWMate {{distro}}...",
  "wsl.onboarding.updateAWMateIn": "Atnaujinkite AWMate {{distro}}.",
  "wsl.onboarding.updateAWMate": "Atnaujinkite AWMate",
  "wsl.onboarding.awmateReadyIn": "AWMate yra paruoštas {{distro}}.",
  "wsl.onboarding.awmateReady": "AWMate yra paruoštas.",
  "wsl.onboarding.installAWMateIn": "Įdiekite AWMate į {{distro}}.",
  "wsl.onboarding.installAWMate": "Įdiekite AWMate",
  ...
  "wsl.onboarding.distroStatus.awmateMissing": "AWMate neįdiegtas",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Kad AWMate galėtų pridėti WSL serverį, reikalingas WSL (Windows posistemis, skirtas Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL nepasiekiamas",
  "wsl.onboarding.wslUnavailable.description": "AWMate nepavyko patikrinti WSL šiame įrenginyje.",
  "wsl.onboarding.installWsl": "Įdiekite WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Iš naujo paleiskite Windows, kad užbaigtumėte WSL diegimą, tada iš naujo atidarykite AWMate.",
  ...
  "help.tabs.introduction": "AWMate Desktop dabar sukurtas iš skirtukų.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Dabar galima įdiegti naują AWMate ({{version}}) versiją.",
  ...
  "error.page.report.prefix": "Praneškite apie šią klaidą AWMate komandai",
  ...
  "error.chain.checkConfig": "Patikrinkite konfigūracijos (awmate.json) teikėjo / modelio pavadinimus",
  "error.chain.mcpFailed":
    "MCP serveris „{{name}}“ nepavyko. Atminkite, kad AWMate dar nepalaiko MCP autentifikavimo.",
  ...
  "sidebar.gettingStarted.line1": "AWMate apima nemokamus modelius, todėl galite pradėti iš karto.",
  ...
  "app.name.desktop": "AWMate darbalaukis",
  ...
  "settings.desktop.wsl.description": "Paleiskite AWMate serverį WSL viduje Windows.",
  ...
  "settings.general.row.language.description": "Pakeiskite AWMate ekrano kalbą",
  ...
  "settings.general.row.appearance.description": "Tinkinkite, kaip AWMate atrodo jūsų įrenginyje",
  "settings.general.row.colorScheme.title": "Spalvų schema",
  "settings.general.row.colorScheme.description": "Pasirinkite, ar AWMate seka sistemos, šviesios ar tamsios temos",
  "settings.general.row.theme.title": "tema",
  "settings.general.row.theme.description": "Tinkinkite AWMate temą.",
  ...
  "settings.updates.row.startup.description": "Automatiškai patikrinkite, ar nėra naujinimų, kai paleidžiamas AWMate",
  ...
  "settings.updates.toast.latest.description": "Naudojate naujausią AWMate versiją.",
