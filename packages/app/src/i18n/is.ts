...
const desktop = [
  ...
  "Bíða áfram",
  "Hætta",
  "Ekki tókst að hlaða AWMate",
  "AWMate-glugganum var óvænt lokað",
  "AWMate svarar ekki",
  ...
  "Uppsetning AWMate mistókst",
  "{{distro}} hefur þegar verið bætt við",
  "awmate er ekki uppsett í þessari dreifingu",
  "awmate er uppsett en ekki var hægt að keyra það",
  "AWMate er ekki uppsett í {{distro}}",
  "Uppfærslu AWMate lauk en {{distro}} tilkynnir enn {{installed}}; vænt var {{expected}}",
  "engin útgáfa",
...
export const dict = {
  ...
  "dialog.provider.awmate.note": "Sýndar gerðir þar á meðal Claude, GPT, Gemini og fleira",
  "dialog.provider.awmate.tagline": "Áreiðanleg bjartsýni módel",
  "dialog.provider.awmateGo.tagline": "Lággjaldaáskrift fyrir alla",
  ...
  "dialog.model.unpaid.freeModels.title": "Ókeypis gerðir frá AWMate",
  ...
  "provider.connect.apiKey.description":
    "Sláðu inn API-lykilinn þinn fyrir {{provider}} til að tengja reikninginn og nota líkön frá {{provider}} í AWMate.",
  ...
  "provider.connect.awmateZen.line1":
    "AWMate Zen veitir þér aðgang að safni af áreiðanlegum og fínstilltum gerðum fyrir kóðunarmiðla.",
  "provider.connect.awmateZen.line2":
    "Með einum API lykli færðu aðgang að gerðum eins og Claude, GPT, Gemini, GLM og fleira.",
  "provider.connect.awmateZen.visit.prefix": "Heimsókn",
  "provider.connect.awmateZen.visit.link": "opencode.ai/zen",
  "provider.connect.awmateZen.visit.suffix": "til að safna API lykilnum þínum.",
  "provider.connect.oauth.code.visit.prefix": "Heimsókn",
  "provider.connect.oauth.code.visit.link": "þennan hlekk",
  "provider.connect.oauth.code.visit.suffix":
    "til að safna heimildarkóðanum þínum til að tengja reikninginn þinn og nota {{provider}} gerðir í AWMate.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "og sláðu inn kóðann hér að neðan til að tengja reikninginn þinn og nota {{provider}} gerðir í AWMate.",
  ...
  "dialog.plugins.empty": "Viðbætur stilltar í awmate.json",
  ...
  "dialog.server.description": "Skiptu um hvaða AWMate miðlara þetta app tengist.",
  ...
  "wsl.onboarding.checkingAWMate": "Athugar AWMate...",
  "wsl.onboarding.checkingAWMateIn": "Athugar AWMate í {{distro}}...",
  "wsl.onboarding.updatingAWMate": "Uppfærir AWMate...",
  "wsl.onboarding.updatingAWMateIn": "Uppfærir AWMate í {{distro}}...",
  "wsl.onboarding.updateAWMateIn": "Uppfærðu AWMate í {{distro}}.",
  "wsl.onboarding.updateAWMate": "Uppfærðu AWMate",
  "wsl.onboarding.awmateReadyIn": "AWMate er tilbúið í {{distro}}.",
  "wsl.onboarding.awmateReady": "AWMate er tilbúinn.",
  "wsl.onboarding.installAWMateIn": "Settu upp AWMate í {{distro}}.",
  "wsl.onboarding.installAWMate": "Settu upp AWMate",
  ...
  "wsl.onboarding.distroStatus.awmateMissing": "AWMate ekki uppsett",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows undirkerfi fyrir Linux) þarf áður en AWMate getur bætt við WSL netþjóni",
  "wsl.onboarding.wslUnavailable.title": "WSL ekki í boði",
  "wsl.onboarding.wslUnavailable.description": "AWMate gat ekki staðfest WSL á þessari vél.",
  "wsl.onboarding.installWsl": "Settu upp WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Endurræstu Windows til að klára að setja upp WSL, opnaðu síðan AWMate aftur.",
  ...
  "help.tabs.introduction": "AWMate Desktop er nú byggt í kringum flipa.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Ný útgáfa af AWMate ({{version}}) er nú fáanleg til uppsetningar.",
  ...
  "error.page.report.prefix": "Vinsamlegast tilkynnið þessa villu til AWMate teymisins",
  ...
  "error.chain.checkConfig": "Athugaðu stillingar (awmate.json) þjónustuveitu/módelheiti",
  "error.chain.mcpFailed": "MCP þjónn „{{name}}“ mistókst. Athugið, AWMate styður ekki MCP auðkenningu ennþá.",
  ...
  "sidebar.gettingStarted.line1": "AWMate inniheldur ókeypis gerðir svo þú getir byrjað strax.",
  ...
  "app.name.desktop": "AWMate skjáborð",
  ...
  "settings.desktop.wsl.description": "Keyrðu AWMate netþjóninn inni í WSL á Windows.",
  ...
  "settings.general.row.language.description": "Breyttu skjátungumálinu fyrir AWMate",
  ...
  "settings.general.row.appearance.description": "Sérsníddu hvernig AWMate lítur út á tækinu þínu",
  "settings.general.row.colorScheme.title": "Litasamsetning",
  "settings.general.row.colorScheme.description": "Veldu hvort AWMate fylgir kerfis-, ljósu eða dökku þema",
  "settings.general.row.theme.title": "Þema",
  "settings.general.row.theme.description": "Sérsníddu hvernig AWMate er þema.",
  ...
  "settings.updates.row.startup.description": "Athugaðu sjálfkrafa fyrir uppfærslur þegar AWMate ræsir",
  ...
  "settings.updates.toast.latest.description": "Þú ert að keyra nýjustu útgáfuna af AWMate.",
