export const dict = {
  ...
  "desktop.menu.documentation": "AWMate dokumentācija",
  ...
  "desktop.menu.ariaLabel": "AWMate izvēlne",
  ...
  "desktop.recovery.loadFailed": "Neizdevās ielādēt AWMate",
  "desktop.recovery.terminated": "AWMate logs negaidīti aizvērts",
  "desktop.recovery.unresponsive": "AWMate neatbild",
  ...
  "desktop.wsl.error.installAWMate": "AWMate instalēšana neizdevās",
  "desktop.wsl.error.alreadyAdded": "{{distro}} jau ir pievienota",
  "desktop.wsl.error.awmateMissing": "awmate nav instalēts šajā distribūcijā",
  "desktop.wsl.error.awmateCannotRun": "awmate ir instalēts, bet to nevar palaist",
  "desktop.wsl.error.awmateNotInstalled": "AWMate nav instalēts {{distro}}",
  "desktop.wsl.error.updateVersion":
    "AWMate atjaunināšana pabeigta, bet {{distro}} joprojām rāda {{installed}}; gaidīts {{expected}}",
  ...
  "dialog.provider.awmate.note": "Atlasīti modeļi, tostarp Claude, GPT, Gemini un citi",
  "dialog.provider.awmate.tagline": "Uzticami optimizēti modeļi",
  "dialog.provider.awmateGo.tagline": "Zemas cenas abonements visiem",
  ...
  "dialog.model.unpaid.freeModels.title": "Bezmaksas modeļi no AWMate",
  ...
  "provider.connect.apiKey.description":
    "Ievadiet savu {{provider}} API atslēgu, lai savienotu kontu un izmantotu {{provider}} modeļus AWMate.",
  ...
  "provider.connect.awmateZen.line1":
    "AWMate Zen nodrošina piekļuvi atlasītiem uzticamiem optimizētiem modeļiem kodēšanas aģentiem.",
  ...
  "provider.connect.awmateZen.visit.prefix": "Apmeklējiet",
  "provider.connect.awmateZen.visit.link": "opencode.ai/zen",
  "provider.connect.awmateZen.visit.suffix": ", lai saņemtu savu API atslēgu.",
  "provider.connect.oauth.code.visit.prefix": "Apmeklējiet",
  "provider.connect.oauth.code.visit.link": "šo saiti",
  "provider.connect.oauth.code.visit.suffix":
    ", lai saņemtu autorizācijas kodu, savienotu kontu un izmantotu {{provider}} modeļus AWMate.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " un ievadiet zemāk redzamo kodu, lai savienotu kontu un izmantotu {{provider}} modeļus AWMate.",
  ...
  "dialog.plugins.empty": "Spraudņi konfigurēti awmate.json",
  ...
  "dialog.server.description": "Mainiet, pie kura AWMate servera šī lietotne pieslēdzas.",
  ...
  "wsl.onboarding.checkingAWMate": "Pārbaudu AWMate...",
  "wsl.onboarding.checkingAWMateIn": "Pārbaudu AWMate distribūcijā {{distro}}...",
  "wsl.onboarding.updatingAWMate": "Atjauninu AWMate...",
  "wsl.onboarding.updatingAWMateIn": "Atjauninu AWMate distribūcijā {{distro}}...",
  "wsl.onboarding.updateAWMateIn": "Atjauniniet AWMate distribūcijā {{distro}}.",
  "wsl.onboarding.updateAWMate": "Atjauniniet AWMate",
  "wsl.onboarding.awmateReadyIn": "AWMate ir gatavs distribūcijā {{distro}}.",
  "wsl.onboarding.awmateReady": "AWMate ir gatavs.",
  "wsl.onboarding.installAWMateIn": "Instalējiet AWMate distribūcijā {{distro}}.",
  "wsl.onboarding.installAWMate": "Instalējiet AWMate",
  ...
  "wsl.onboarding.distroStatus.awmateMissing": "AWMate nav instalēts",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Pirms AWMate var pievienot WSL serveri, nepieciešams WSL (Windows Subsystem for Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL nav pieejams",
  "wsl.onboarding.wslUnavailable.description": "AWMate neizdevās pārbaudīt WSL šajā datorā.",
  "wsl.onboarding.installWsl": "Instalēt WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Restartējiet Windows, lai pabeigtu WSL instalēšanu, pēc tam atveriet AWMate no jauna.",
  ...
  "help.tabs.introduction": "AWMate Desktop tagad balstās uz cilnēm.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Pieejama jauna AWMate versija ({{version}}) instalēšanai.",
  ...
  "error.page.report.prefix": "Lūdzu, ziņojiet par šo kļūdu AWMate komandai",
  ...
  "error.chain.checkConfig": "Pārbaudiet konfigurāciju (awmate.json) pakalpojuma/modela nosaukumus",
  "error.chain.mcpFailed":
    'MCP serveris "{{name}}" neizdevās. Ņemiet vērā, AWMate vēl neatbalsta MCP autentifikāciju.',
  ...
  "sidebar.gettingStarted.line1": "AWMate ietver bezmaksas modeļus, lai varētu sākt uzreiz.",
  ...
  "app.name.desktop": "AWMate darbvirsma",
  ...
  "settings.desktop.wsl.description": "Palaist AWMate serveri WSL vidē uz Windows.",
  ...
  "settings.general.row.language.description": "Mainīt AWMate saskarnes valodu",
  ...
  "settings.general.row.appearance.description": "Pielāgojiet, kā AWMate izskatās jūsu ierīcē",
  "settings.general.row.colorScheme.title": "Krāsu shēma",
  "settings.general.row.colorScheme.description":
    "Izvēlieties, vai AWMate sekos sistēmas, gaišajai vai tumšajai tēmai",
  "settings.general.row.theme.title": "Tēma",
  "settings.general.row.theme.description": "Pielāgojiet AWMate tēmu.",
  ...
  "settings.updates.row.startup.description": "Automātiski pārbaudīt atjauninājumus, palaižot AWMate",
  ...
  "settings.updates.toast.latest.description": "Jūs izmantojat jaunāko AWMate versiju.",
