export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacja AWMate",
  ...
  "desktop.recovery.loadFailed": "Nie udało się wczytać AWMate",
  "desktop.recovery.terminated": "Okno AWMate zostało nieoczekiwanie zamknięte",
  "desktop.recovery.unresponsive": "AWMate nie odpowiada",
  ...
  "desktop.wsl.error.installAWMate": "Nie udało się zainstalować AWMate",
  "desktop.wsl.error.alreadyAdded": "Dystrybucja {{distro}} została już dodana",
  "desktop.wsl.error.awmateMissing": "Program awmate nie jest zainstalowany w tej dystrybucji",
  "desktop.wsl.error.awmateCannotRun": "Program awmate jest zainstalowany, ale nie można go uruchomić",
  "desktop.wsl.error.awmateNotInstalled": "AWMate nie jest zainstalowany w dystrybucji {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Aktualizacja AWMate została ukończona, ale dystrybucja {{distro}} nadal zgłasza wersję {{installed}}; oczekiwano {{expected}}",
  ...
  "dialog.provider.awmate.note": "Starannie dobrane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.awmate.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.awmateGo.tagline": "Niedroga subskrypcja dla każdego",
  ...
  "provider.connect.awmateZen.line1":
    "AWMate Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów programistycznych.",
  ...
  "provider.connect.awmateZen.visit.prefix": "Odwiedź ",
  "provider.connect.awmateZen.visit.link": "opencode.ai/zen",
  "provider.connect.awmateZen.visit.suffix": ", aby odebrać swój klucz API.",
  ...
  "dialog.plugins.empty": "Wtyczki są skonfigurowane w pliku awmate.json",
  ...
  "wsl.onboarding.checkingAWMate": "Sprawdzanie AWMate...",
  "wsl.onboarding.checkingAWMateIn": "Sprawdzanie AWMate w dystrybucji {{distro}}...",
  "wsl.onboarding.updatingAWMate": "Aktualizowanie AWMate...",
  "wsl.onboarding.updatingAWMateIn": "Aktualizowanie AWMate w dystrybucji {{distro}}...",
  "wsl.onboarding.updateAWMateIn": "Zaktualizuj AWMate w dystrybucji {{distro}}.",
  "wsl.onboarding.updateAWMate": "Zaktualizuj AWMate",
  "wsl.onboarding.awmateReadyIn": "AWMate jest gotowy w dystrybucji {{distro}}.",
  "wsl.onboarding.awmateReady": "AWMate jest gotowy.",
  ...
  "wsl.onboarding.distroStatus.awmateMissing": "AWMate nie jest zainstalowany",
  ...
  "help.tabs.introduction": "AWMate Desktop korzysta teraz z układu opartego na kartach.",
  "help.tabs.sessions":
  ...
  "error.chain.checkConfig": "Sprawdź nazwy dostawców i modeli w konfiguracji (awmate.json)",
