export const dict = {
  ...
  "desktop.menu.documentation": "AWMate Документација",
  ...
  "desktop.menu.ariaLabel": "AWMate мени",
  ...
  "desktop.recovery.loadFailed": "AWMate не успеа да се вчита",
  "desktop.recovery.terminated": "Прозорецот AWMate неочекувано заврши",
  "desktop.recovery.unresponsive": "AWMate не реагира",
  ...
  "desktop.wsl.error.installAWMate": "инсталацијата AWMate не успеа",
  "desktop.wsl.error.alreadyAdded": "{{distro}} е веќе додаден",
  "desktop.wsl.error.awmateMissing": "awmate не е инсталиран во оваа дистрибуција",
  "desktop.wsl.error.awmateCannotRun": "awmate е инсталиран, но не може да се изврши",
  "desktop.wsl.error.awmateNotInstalled": "AWMate не е инсталиран во {{distro}}",
  "desktop.wsl.error.updateVersion":
    "AWMate ажурирањето е завршено, но {{distro}} сè уште известува {{installed}}; се очекува {{expected}}",
  ...
  "dialog.provider.awmate.note": "Курирани модели вклучувајќи Claude, GPT, Gemini и повеќе",
  "dialog.provider.awmate.tagline": "Сигурни оптимизирани модели",
  "dialog.provider.awmateGo.tagline": "Ниска цена претплата за секого",
  ...
  "dialog.model.unpaid.freeModels.title": "Бесплатни модели обезбедени од AWMate",
  ...
  "provider.connect.apiKey.description":
    "Внесете го вашиот клуч {{provider}} API за да ја поврзете вашата сметка и да користите {{provider}} модели во AWMate.",
  ...
  "provider.connect.awmateZen.line1":
    "AWMate Zen ви дава пристап до куриран сет на сигурни оптимизирани модели за агенти за кодирање.",
  "provider.connect.awmateZen.line2":
    "Со еден клуч API ќе добиете пристап до модели како што се Claude, GPT, Gemini, GLM и повеќе.",
  "provider.connect.awmateZen.visit.prefix": "Посетете",
  "provider.connect.awmateZen.visit.link": "opencode.ai/zen",
  "provider.connect.awmateZen.visit.suffix": "да го соберете вашиот клуч API.",
  "provider.connect.oauth.code.visit.prefix": "Посетете",
  "provider.connect.oauth.code.visit.link": "оваа врска",
  "provider.connect.oauth.code.visit.suffix":
    "да го соберете вашиот код за авторизација за да ја поврзете вашата сметка и да користите {{provider}} модели во AWMate.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "и внесете го кодот подолу за да ја поврзете вашата сметка и да користите {{provider}} модели во AWMate.",
  ...
  "dialog.plugins.empty": "Приклучоци конфигурирани во awmate.json",
  ...
  "dialog.server.description": "Променете на кој AWMate сервер се поврзува оваа апликација.",
  ...
  "wsl.onboarding.checkingAWMate": "Се проверува AWMate...",
  "wsl.onboarding.checkingAWMateIn": "Се проверува AWMate во {{distro}}...",
  "wsl.onboarding.updatingAWMate": "Се ажурира AWMate...",
  "wsl.onboarding.updatingAWMateIn": "Се ажурира AWMate во {{distro}}...",
  "wsl.onboarding.updateAWMateIn": "Ажурирајте AWMate во {{distro}}.",
  "wsl.onboarding.updateAWMate": "Ажурирај AWMate",
  "wsl.onboarding.awmateReadyIn": "AWMate е подготвен во {{distro}}.",
  "wsl.onboarding.awmateReady": "AWMate е подготвен.",
  "wsl.onboarding.installAWMateIn": "Инсталирајте AWMate во {{distro}}.",
  "wsl.onboarding.installAWMate": "Инсталирај AWMate",
  ...
  "wsl.onboarding.distroStatus.awmateMissing": "AWMate не е инсталиран",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) е потребно пред AWMate да може да додаде WSL сервер",
  "wsl.onboarding.wslUnavailable.title": "WSL недостапен",
  "wsl.onboarding.wslUnavailable.description": "AWMate не можеше да го потврди WSL на оваа машина.",
  "wsl.onboarding.installWsl": "Инсталирај WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Рестартирајте го Windows за да завршите со инсталирањето WSL, а потоа повторно отворете AWMate.",
  ...
  "help.tabs.introduction": "AWMate Desktop сега е изграден околу картичките.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Новата верзија на AWMate ({{version}}) сега е достапна за инсталирање.",
  ...
  "error.page.report.prefix": "Ве молиме пријавете ја оваа грешка на тимот AWMate",
  ...
  "error.chain.checkConfig": "Проверете ги имињата на давателот/моделот за конфигурација (awmate.json).",
  "error.chain.mcpFailed":
    "MCP серверот „{{name}}“ не успеа. Забелешка, AWMate сè уште не поддржува автентикација MCP.",
  ...
  "sidebar.gettingStarted.line1": "AWMate вклучува бесплатни модели за да можете веднаш да започнете.",
  ...
  "settings.desktop.wsl.description": "Стартувај го серверот AWMate во WSL на Windows.",
  ...
  "settings.general.row.language.description": "Променете го јазикот на прикажување за AWMate",
  ...
  "settings.general.row.appearance.description": "Приспособете како изгледа AWMate на вашиот уред",
  "settings.general.row.colorScheme.title": "Шема на бои",
  "settings.general.row.colorScheme.description": "Изберете дали AWMate ја следи системската, светла или темна тема",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Приспособете како AWMate е тематизирана.",
  ...
  "settings.updates.row.startup.description": "Автоматски проверувајте дали има ажурирања кога ќе се стартува AWMate",
  ...
  "settings.updates.toast.latest.description": "Ја извршувате најновата верзија на AWMate.",
