export const dict = {
  ...
  "desktop.menu.documentation": "Documentação do AWMate",
  ...
  "desktop.menu.ariaLabel": "Menu do AWMate",
  ...
  "desktop.recovery.loadFailed": "Falha ao carregar o AWMate",
  "desktop.recovery.terminated": "A janela do AWMate foi encerrada inesperadamente",
  "desktop.recovery.unresponsive": "O AWMate não está respondendo",
  ...
  "desktop.wsl.error.installAWMate": "Falha na instalação do AWMate",
  "desktop.wsl.error.alreadyAdded": "{{distro}} já foi adicionada",
  "desktop.wsl.error.awmateMissing": "O awmate não está instalado nesta distribuição",
  "desktop.wsl.error.awmateCannotRun": "O awmate está instalado, mas não pôde ser executado",
  "desktop.wsl.error.awmateNotInstalled": "O AWMate não está instalado em {{distro}}",
  "desktop.wsl.error.updateVersion":
    "A atualização do AWMate foi concluída, mas {{distro}} ainda informa a versão {{installed}}; a versão esperada é {{expected}}",
  ...
  "dialog.provider.awmateGo.tagline": "Assinatura de baixo custo para todos",
  ...
  "provider.connect.awmateZen.visit.prefix": "Visite ",
  "provider.connect.awmateZen.visit.link": "opencode.ai/zen",
  "provider.connect.awmateZen.visit.suffix": " para obter sua chave de API.",
  ...
  "wsl.onboarding.checkingAWMate": "Verificando o AWMate...",
  "wsl.onboarding.checkingAWMateIn": "Verificando o AWMate em {{distro}}...",
  "wsl.onboarding.updatingAWMate": "Atualizando o AWMate...",
  "wsl.onboarding.updatingAWMateIn": "Atualizando o AWMate em {{distro}}...",
  "wsl.onboarding.updateAWMateIn": "Atualize o AWMate em {{distro}}.",
  "wsl.onboarding.updateAWMate": "Atualizar o AWMate",
  "wsl.onboarding.awmateReadyIn": "O AWMate está pronto em {{distro}}.",
  "wsl.onboarding.awmateReady": "O AWMate está pronto.",
  ...
  "wsl.onboarding.distroStatus.awmateMissing": "AWMate não instalado",
  ...
  "help.tabs.introduction": "Agora, o AWMate Desktop é organizado em abas.",
  "help.tabs.sessions":
