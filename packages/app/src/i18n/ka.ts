export const dict = {
  ...
  "desktop.menu.documentation": "AWMate დოკუმენტაცია",
  ...
  "desktop.menu.ariaLabel": "AWMate მენიუ",
  ...
  "desktop.recovery.loadFailed": "AWMate ვერ ჩაიტვირთა",
  "desktop.recovery.terminated": "AWMate ფანჯარა მოულოდნელად შეწყდა",
  "desktop.recovery.unresponsive": "AWMate არ პასუხობს",
  ...
  "desktop.wsl.error.installAWMate": "AWMate ინსტალაცია ვერ მოხერხდა",
  "desktop.wsl.error.alreadyAdded": "{{distro}} უკვე დამატებულია",
  "desktop.wsl.error.awmateMissing": "awmate არ არის დაინსტალირებული ამ დისტროში",
  "desktop.wsl.error.awmateCannotRun": "awmate დაინსტალირებულია, მაგრამ ვერ გაშვება",
  "desktop.wsl.error.awmateNotInstalled": "AWMate არ არის დაინსტალირებული {{distro}}",
  "desktop.wsl.error.updateVersion":
    "AWMate განახლება დასრულდა, მაგრამ {{distro}} კვლავ იუწყება {{installed}}; მოსალოდნელია {{expected}}",
  ...
  "dialog.provider.awmate.note": "კურირებული მოდელები, მათ შორის Claude, GPT, Gemini და სხვა",
  "dialog.provider.awmate.tagline": "სანდო ოპტიმიზებული მოდელები",
  "dialog.provider.awmateGo.tagline": "დაბალფასიანი გამოწერა ყველასთვის",
  ...
  "dialog.model.unpaid.freeModels.title": "უფასო მოდელები მოწოდებულია AWMate",
  ...
  "provider.connect.apiKey.description":
    "შეიყვანეთ თქვენი {{provider}} API გასაღები თქვენი ანგარიშის დასაკავშირებლად და გამოიყენეთ {{provider}} მოდელები AWMate-ში.",
  ...
  "provider.connect.awmateZen.line1":
    "AWMate Zen გაძლევთ წვდომას კოდირების აგენტებისთვის საიმედო ოპტიმიზირებული მოდელების კურირებულ კომპლექტზე.",
  ...
  "provider.connect.awmateZen.visit.prefix": "ეწვიეთ ",
  "provider.connect.awmateZen.visit.link": "opencode.ai/zen",
  "provider.connect.awmateZen.visit.suffix": " თქვენი API გასაღების შესაგროვებლად.",
  "provider.connect.oauth.code.visit.prefix": "ეწვიეთ ",
  "provider.connect.oauth.code.visit.link": "ეს ბმული",
  "provider.connect.oauth.code.visit.suffix":
    " შეაგროვეთ თქვენი ავტორიზაციის კოდი თქვენი ანგარიშის დასაკავშირებლად და გამოიყენოთ {{provider}} მოდელები AWMate-ში.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " და შეიყვანეთ ქვემოთ კოდი თქვენი ანგარიშის დასაკავშირებლად და გამოიყენეთ {{provider}} მოდელები AWMate-ში.",
  ...
  "dialog.plugins.empty": "პლაგინები კონფიგურირებულია awmate.json-ში",
  ...
  "dialog.server.description": "გადართეთ რომელ AWMate სერვერს უკავშირდება ეს აპი.",
  ...
  "wsl.onboarding.checkingAWMate": "შემოწმებულია AWMate...",
  "wsl.onboarding.checkingAWMateIn": "შემოწმებულია AWMate-ში {{distro}}...",
  "wsl.onboarding.updatingAWMate": "განახლება AWMate...",
  "wsl.onboarding.updatingAWMateIn": "AWMate განახლება ხდება {{distro}}...",
  "wsl.onboarding.updateAWMateIn": "განახლება AWMate {{distro}}-ში.",
  "wsl.onboarding.updateAWMate": "განახლება AWMate",
  "wsl.onboarding.awmateReadyIn": "AWMate მზად არის {{distro}}-ში.",
  "wsl.onboarding.awmateReady": "AWMate მზად არის.",
  "wsl.onboarding.installAWMateIn": "დააინსტალირეთ AWMate {{distro}}-ში.",
  "wsl.onboarding.installAWMate": "დააინსტალირეთ AWMate",
  ...
  "wsl.onboarding.distroStatus.awmateMissing": "AWMate არ არის დაინსტალირებული",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows ქვესისტემა Linux-ისთვის) საჭიროა, სანამ AWMate შეძლებს WSL სერვერის დამატებას",
  "wsl.onboarding.wslUnavailable.title": "WSL მიუწვდომელია",
  "wsl.onboarding.wslUnavailable.description": "AWMate ვერ დაადასტურა WSL ამ მოწყობილობაზე.",
  "wsl.onboarding.installWsl": "დააინსტალირეთ WSL",
  "wsl.onboarding.windowsRestartRequired":
    "გადატვირთეთ Windows WSL-ის ინსტალაციის დასასრულებლად, შემდეგ ხელახლა გახსენით AWMate.",
  ...
  "help.tabs.introduction": "AWMate სამუშაო მაგიდა ახლა აგებულია ჩანართების გარშემო.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "AWMate-ის ({{version}}) ახალი ვერსია ახლა ხელმისაწვდომია დასაინსტალირებლად.",
  ...
  "error.page.report.prefix": "გთხოვთ, შეატყობინოთ ეს შეცდომა AWMate გუნდს",
  ...
  "error.chain.checkConfig": "შეამოწმეთ თქვენი კონფიგურაცია (awmate.json) პროვაიდერის/მოდელების სახელები",
  "error.chain.mcpFailed":
    'MCP სერვერი "{{name}}" ვერ მოხერხდა. შენიშვნა, AWMate ჯერ არ უჭერს მხარს MCP ავთენტიფიკაციას.',
  ...
  "sidebar.gettingStarted.line1": "AWMate მოიცავს უფასო მოდელებს, ასე რომ თქვენ შეგიძლიათ დაუყოვნებლივ დაიწყოთ.",
  ...
  "app.name.desktop": "AWMate სამუშაო მაგიდა",
  ...
  "settings.desktop.wsl.description": "გაუშვით AWMate სერვერი WSL-ში Windows-ზე.",
  ...
  "settings.general.row.language.description": "შეცვალეთ ჩვენების ენა AWMate",
  ...
  "settings.general.row.appearance.description": "მორგეთ, როგორ გამოიყურება AWMate თქვენს მოწყობილობაზე",
  "settings.general.row.colorScheme.title": "ფერთა სქემა",
  "settings.general.row.colorScheme.description": "აირჩიეთ, მიჰყვება თუ არა AWMate სისტემას, ღია თუ ბნელ თემას",
  "settings.general.row.theme.title": "თემა",
  "settings.general.row.theme.description": "მორგება, თუ როგორ არის AWMate თემატური.",
  ...
  "settings.updates.row.startup.description": "ავტომატურად შეამოწმეთ განახლებები, როდესაც AWMate გაშვება",
  ...
  "settings.updates.toast.latest.description": "თქვენ იყენებთ AWMate-ის უახლეს ვერსიას.",
