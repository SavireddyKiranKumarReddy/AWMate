export const dict = {
  ...
  "desktop.menu.documentation": "AWMate دیاں دستاویزاں",
  ...
  "desktop.recovery.loadFailed": "AWMate لوڈ نئیں ہو سکیا",
  "desktop.recovery.terminated": "AWMate دی ونڈو اچانک بند ہو گئی",
  "desktop.recovery.unresponsive": "AWMate جواب نئیں دے رہیا",
  ...
  "desktop.wsl.error.installAWMate": "AWMate دی تنصیب ناکام ہو گئی",
  "desktop.wsl.error.alreadyAdded": "{{distro}} پہلے ای شامل اے",
  "desktop.wsl.error.awmateMissing": "اس ڈسٹرو وچ awmate انسٹال نئیں اے",
  "desktop.wsl.error.awmateCannotRun": "awmate انسٹال اے پر چل نئیں سکیا",
  "desktop.wsl.error.awmateNotInstalled": "{{distro}} وچ AWMate انسٹال نئیں اے",
  "desktop.wsl.error.updateVersion":
    "AWMate دی اپ ڈیٹ پوری ہو گئی پر {{distro}} ہلے وی {{installed}} دس رہیا اے؛ {{expected}} چاہیدا سی",
  ...
  "dialog.provider.awmate.note": "Claude، GPT، Gemini تے ہور سمیت کیوریٹڈ ماڈل",
  "dialog.provider.awmate.tagline": "قابل اعتماد اصلاح شدہ ماڈل",
  "dialog.provider.awmateGo.tagline": "ہر اک لئی گھٹ قیمت دی رکنیت",
  ...
  "dialog.model.unpaid.freeModels.title": "AWMate دے ذریعہ فراہم کردہ مفت ماڈل",
  ...
  "provider.connect.apiKey.description":
    "اپنے اکاؤنٹ نوں جوڑن لئی اپنی {{provider}} API کلید درج کرو تے AWMate وچ {{provider}} ماڈل ورتو۔",
  ...
  "provider.connect.awmateZen.visit.prefix": "ویکھو ",
  "provider.connect.awmateZen.visit.link": "opencode.ai/zen",
  "provider.connect.awmateZen.visit.suffix": " اپنی API کلید حاصل کرن لئی۔",
  "provider.connect.oauth.code.visit.prefix": "ویکھو ",
  "provider.connect.oauth.code.visit.link": "ایہہ لنک",
  "provider.connect.oauth.code.visit.suffix":
    " اپنے اکاؤنٹ نوں جوڑن تے AWMate وچ {{provider}} ماڈل ورتن لئی اپنا اجازت کوڈ حاصل کرن لئی۔",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " تے اپنے اکاؤنٹ نوں جوڑن تے AWMate وچ {{provider}} ماڈل ورتن لئی تھلے دتا کوڈ درج کرو۔",
  ...
  "dialog.plugins.empty": "awmate.json وچ سیٹ کیتے پلگ اِن",
  ...
  "dialog.server.description": "ایہہ ایپ کس AWMate سرور نال جڑدی اے، اس نوں سوئچ کرو۔",
  ...
  "wsl.onboarding.checkingAWMate": "AWMate چیک کر رئے آں...",
  "wsl.onboarding.checkingAWMateIn": "{{distro}} چ AWMate دی جانچ پڑتال...",
  "wsl.onboarding.updatingAWMate": "AWMate نو اپ ڈیٹ کر رئے آں...",
  "wsl.onboarding.updatingAWMateIn": "{{distro}} وچ AWMate نو اپ ڈیٹ کر رئے آں...",
  "wsl.onboarding.updateAWMateIn": "{{distro}} وچ AWMate نو اپ ڈیٹ کرو۔",
  "wsl.onboarding.updateAWMate": "AWMate اپ ڈیٹ کرو",
  "wsl.onboarding.awmateReadyIn": "AWMate {{distro}} چ تیار اے۔",
  "wsl.onboarding.awmateReady": "AWMate تیار اے۔",
  "wsl.onboarding.installAWMateIn": "{{distro}} وچ AWMate انسٹال کرو۔",
  "wsl.onboarding.installAWMate": "AWMate انسٹال کرو",
  ...
  "wsl.onboarding.distroStatus.awmateMissing": "AWMate انسٹال نئیں کیتا گیا",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "AWMate دے WSL سرور شامل کرن توں پہلاں WSL (Windows Subsystem for Linux) دی لوڑ اے",
  "wsl.onboarding.wslUnavailable.title": "WSL دستیاب نئیں",
  "wsl.onboarding.wslUnavailable.description": "AWMate ایس مشین تے WSL دی تصدیق نئیں کر سکیا۔",
  "wsl.onboarding.installWsl": "WSL انسٹال کرو",
  "wsl.onboarding.windowsRestartRequired":
    "WSL دی تنصیب پوری کرن لئی Windows نوں دوبارہ شروع کرو، فیر AWMate دوبارہ کھولو۔",
  ...
  "help.tabs.introduction": "AWMate Desktop ہن ٹیباں دے گرد بنایا گیا اے۔",
  "help.tabs.sessions":
  ...
  "toast.update.description": "AWMate ({{version}}) دا اک نواں ورژن ہن انسٹال کرن لئی دستیاب اے۔",
  ...
  "error.page.report.prefix": "مہربانی کر کے اس غلطی دی اطلاع AWMate ٹیم نوں دیو",
  ...
  "error.chain.checkConfig": "اپنی کنفگ (awmate.json) وچ پرووائیڈر/ماڈل دے ناں چیک کرو",
  "error.chain.mcpFailed": 'MCP سرور "{{name}}" ناکام ہو گیا۔ نوٹ، AWMate ہلے تک MCP تصدیق دی حمایت نئیں کردا۔',
  ...
  "sidebar.gettingStarted.line1": "AWMate چ مفت ماڈل شامل نیں تاکہ تسی فوری طور تے شروع کر سکو۔",
  ...
  "settings.desktop.wsl.description": "Windows تے WSL دے اندر AWMate سرور چلاؤ۔",
  ...
  "settings.general.row.language.description": "AWMate لئی ڈسپلے دی بولی بدلو",
  ...
  "settings.general.row.appearance.description": "اپنے آلے تے AWMate کیویں لگدا اے، اپنی مرضی دے مطابق بناؤ",
  "settings.general.row.colorScheme.title": "رنگ سکیم",
  "settings.general.row.colorScheme.description": "چنو کہ آیا AWMate سسٹم، لائٹ، یا ڈارک تھیم دی پیروی کردا اے",
  "settings.general.row.theme.title": "تھیم",
  "settings.general.row.theme.description": "AWMate نوں کس طرح تھیم کیتا گیا اے، اپنی مرضی دے مطابق بناؤ۔",
  ...
  "settings.updates.row.startup.description": "جدوں AWMate لانچ ہوندا اے تے خودبخود اپ ڈیٹس چیک کرو",
  ...
  "settings.updates.toast.latest.description": "تسی AWMate دا تازہ ترین ورژن چلا رئے او۔",
