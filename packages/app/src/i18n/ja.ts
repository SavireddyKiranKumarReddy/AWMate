export const dict = {
  ...
  "desktop.recovery.loadFailed": "AWMateを読み込めませんでした",
  "desktop.recovery.terminated": "AWMateのウインドウが予期せず終了しました",
  "desktop.recovery.unresponsive": "AWMateが応答していません",
  ...
  "desktop.wsl.error.installAWMate": "AWMateのインストールに失敗しました",
  "desktop.wsl.error.alreadyAdded": "{{distro}}はすでに追加されています",
  "desktop.wsl.error.awmateMissing": "このディストリビューションにはawmateがインストールされていません",
  "desktop.wsl.error.awmateCannotRun": "awmateはインストールされていますが、実行できませんでした",
  "desktop.wsl.error.awmateNotInstalled": "{{distro}}にはAWMateがインストールされていません",
  "desktop.wsl.error.updateVersion":
    "AWMateのアップデートは完了しましたが、{{distro}}から報告されたバージョンはまだ{{installed}}です。想定されるバージョンは{{expected}}です",
  ...
  "dialog.provider.awmateGo.tagline": "すべての人に低価格のサブスクリプション",
  ...
  "provider.connect.awmateZen.line2": "1つのAPIキーで、Claude、GPT、Gemini、GLMなどのモデルにアクセスできます。",
  "provider.connect.awmateZen.visit.prefix": " ",
  "provider.connect.awmateZen.visit.link": "opencode.ai/zen",
  "provider.connect.awmateZen.visit.suffix": " にアクセスしてAPIキーを取得してください。",
  ...
  "wsl.onboarding.checkingAWMate": "AWMateを確認中...",
  "wsl.onboarding.checkingAWMateIn": "{{distro}}内のAWMateを確認中...",
  "wsl.onboarding.updatingAWMate": "AWMateを更新中...",
  "wsl.onboarding.updatingAWMateIn": "{{distro}}内のAWMateを更新中...",
  "wsl.onboarding.updateAWMateIn": "{{distro}}内のAWMateを更新してください。",
  "wsl.onboarding.updateAWMate": "AWMateを更新",
  "wsl.onboarding.awmateReadyIn": "{{distro}}内のAWMateの準備ができました。",
  "wsl.onboarding.awmateReady": "AWMateの準備ができました。",
  ...
  "wsl.onboarding.distroStatus.awmateMissing": "AWMateがインストールされていません",
  ...
  "help.tabs.introduction": "AWMate Desktopでタブを中心とした操作ができるようになりました。",
  "help.tabs.sessions":
