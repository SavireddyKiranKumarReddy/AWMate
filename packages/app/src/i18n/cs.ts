export const dict = {
  ...
  "desktop.menu.documentation": "AWMate Dokumentace",
  ...
  "desktop.menu.ariaLabel": "Nabídka AWMate",
  ...
  "desktop.recovery.loadFailed": "AWMate se nepodařilo načíst",
  "desktop.recovery.terminated": "AWMate okno bylo neočekávaně ukončeno",
  "desktop.recovery.unresponsive": "AWMate nereaguje",
  ...
  "desktop.wsl.error.installAWMate": "AWMate instalace se nezdařila",
  "desktop.wsl.error.alreadyAdded": "{{distro}} je již přidáno",
  "desktop.wsl.error.awmateMissing": "awmate není v této distribuci nainstalováno",
  "desktop.wsl.error.awmateCannotRun": "awmate je nainstalován, ale nelze jej spustit",
  "desktop.wsl.error.awmateNotInstalled": "AWMate není nainstalován v {{distro}}",
  "desktop.wsl.error.updateVersion":
    "AWMate aktualizace dokončena, ale {{distro}} stále hlásí {{installed}}; očekává se {{expected}}",
  ...
  "dialog.provider.awmate.note": "Vybrané modely včetně Claude, GPT, Gemini a dalších",
  "dialog.provider.awmate.tagline": "Spolehlivé optimalizované modely",
  "dialog.provider.awmateGo.tagline": "Nízkonákladové předplatné pro každého",
  ...
  "provider.connect.apiKey.description":
    "Zadejte klíč API služby {{provider}}, připojte účet a používejte modely {{provider}} v AWMate.",
  ...
  "provider.connect.awmateZen.line1":
    "AWMate Zen vám poskytuje přístup k upravené sadě spolehlivých optimalizovaných modelů pro kódovací agenty.",
  ...
  "provider.connect.awmateZen.visit.prefix": "Návštěva ",
  "provider.connect.awmateZen.visit.link": "opencode.ai/zen",
  "provider.connect.awmateZen.visit.suffix": " vyzvedněte svůj klíč API.",
  "provider.connect.oauth.code.visit.prefix": "Návštěva ",
  "provider.connect.oauth.code.visit.link": "tento odkaz",
  "provider.connect.oauth.code.visit.suffix":
    " k vyzvednutí autorizačního kódu pro připojení vašeho účtu a používání {{provider}} modelů v AWMate.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " a zadejte níže uvedený kód pro připojení svého účtu a používání {{provider}} modelů v AWMate.",
  ...
  "dialog.plugins.empty": "Pluginy nakonfigurované v awmate.json",
  ...
  "dialog.server.description": "Přepněte, ke kterému AWMate serveru se tato aplikace připojuje.",
  ...
  "wsl.onboarding.checkingAWMate": "Kontrola AWMate...",
  "wsl.onboarding.checkingAWMateIn": "Kontrola AWMate v {{distro}}...",
  "wsl.onboarding.updatingAWMate": "Aktualizace AWMate...",
  "wsl.onboarding.updatingAWMateIn": "Aktualizace AWMate v {{distro}}...",
  "wsl.onboarding.updateAWMateIn": "Aktualizace AWMate v {{distro}}.",
  "wsl.onboarding.updateAWMate": "Aktualizovat AWMate",
  "wsl.onboarding.awmateReadyIn": "AWMate je připraveno v {{distro}}.",
  "wsl.onboarding.awmateReady": "AWMate je připraven.",
  "wsl.onboarding.installAWMateIn": "Nainstalujte AWMate do {{distro}}.",
  "wsl.onboarding.installAWMate": "Instalovat AWMate",
  ...
  "wsl.onboarding.distroStatus.awmateMissing": "AWMate není nainstalováno",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystém pro Linux) je vyžadován předtím, než AWMate může přidat server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL není k dispozici",
  "wsl.onboarding.wslUnavailable.description": "AWMate nemohl ověřit WSL na tomto počítači.",
  "wsl.onboarding.installWsl": "Instalovat WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Restartujte Windows pro dokončení instalace WSL a poté znovu otevřete AWMate.",
  ...
  "help.tabs.introduction": "AWMate Plocha je nyní postavena na kartách.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nyní je k dispozici k instalaci nová verze AWMate ({{version}}).",
  ...
  "error.page.report.prefix": "Nahlaste tuto chybu týmu AWMate",
  ...
  "error.chain.checkConfig": "Zkontrolujte název poskytovatele/modelu konfigurace (awmate.json).",
  "error.chain.mcpFailed": 'MCP server "{{name}}" selhal. Poznámka: AWMate zatím nepodporuje ověřování MCP.',
  ...
  "sidebar.gettingStarted.line1": "AWMate obsahuje bezplatné modely, takže můžete začít okamžitě.",
  ...
  "settings.desktop.wsl.description": "Spusťte server AWMate uvnitř WSL na Windows.",
  ...
  "settings.general.row.language.description": "Změnit jazyk zobrazení pro AWMate",
  ...
  "settings.general.row.appearance.description": "Přizpůsobte si vzhled AWMate na vašem zařízení",
  "settings.general.row.colorScheme.title": "Barevné schéma",
  "settings.general.row.colorScheme.description":
    "Zvolte, zda bude AWMate následovat systémové, světlé nebo tmavé téma",
  "settings.general.row.theme.title": "téma",
  "settings.general.row.theme.description": "Přizpůsobte, jak je téma AWMate.",
  ...
  "settings.updates.row.startup.description": "Automaticky kontrolovat aktualizace při spuštění AWMate",
  ...
  "settings.updates.toast.latest.description": "Používáte nejnovější verzi AWMate.",
