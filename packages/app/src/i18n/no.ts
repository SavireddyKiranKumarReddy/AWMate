...
export const dict = {
  ...
  "desktop.menu.documentation": "AWMate-dokumentasjon",
  ...
  "desktop.recovery.loadFailed": "AWMate kunne ikke lastes inn",
  "desktop.recovery.terminated": "AWMate-vinduet ble uventet avsluttet",
  ...
  "desktop.wsl.error.installAWMate": "Installasjonen av AWMate mislyktes",
  "desktop.wsl.error.alreadyAdded": "{{distro}} er allerede lagt til",
  "desktop.wsl.error.awmateMissing": "awmate er ikke installert i denne distribusjonen",
  "desktop.wsl.error.awmateCannotRun": "awmate er installert, men kunne ikke kjøres",
  "desktop.wsl.error.awmateNotInstalled": "AWMate er ikke installert i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Oppdateringen av AWMate er fullført, men {{distro}} rapporterer fortsatt {{installed}}; forventet {{expected}}",
  ...
  "dialog.provider.awmateGo.tagline": "Rimelig abonnement for alle",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn API-nøkkelen din for {{provider}} for å koble til kontoen din og bruke {{provider}}-modeller i AWMate.",
  ...
  "provider.connect.awmateZen.visit.prefix": "Besøk ",
  "provider.connect.awmateZen.visit.link": "opencode.ai/zen",
  "provider.connect.awmateZen.visit.suffix": " for å hente API-nøkkelen din.",
  ...
  "dialog.plugins.empty": "Programtillegg konfigurert i awmate.json",
  ...
  "settings.general.row.colorScheme.description":
    "Velg om AWMate skal følge systeminnstillingen eller bruke lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass temaet i AWMate.",
  ...
  "settings.updates.toast.latest.title": "AWMate er oppdatert",
  ...
  "wsl.onboarding.checkingAWMate": "Sjekker AWMate...",
  "wsl.onboarding.checkingAWMateIn": "Sjekker AWMate i {{distro}}...",
  "wsl.onboarding.updatingAWMate": "Oppdaterer AWMate...",
  "wsl.onboarding.updatingAWMateIn": "Oppdaterer AWMate i {{distro}}...",
  "wsl.onboarding.updateAWMateIn": "Oppdater AWMate i {{distro}}.",
  "wsl.onboarding.updateAWMate": "Oppdater AWMate",
  ...
  "wsl.onboarding.distroStatus.awmateMissing": "AWMate er ikke installert",
  ...
  "help.tabs.introduction": "AWMate Desktop er nå bygget rundt faner.",
  "help.tabs.sessions":
