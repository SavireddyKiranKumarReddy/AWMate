export const dict = {
  ...
  "desktop.menu.documentation": "Tài liệu AWMate",
  ...
  "desktop.recovery.loadFailed": "Không tải được AWMate",
  "desktop.recovery.terminated": "Cửa sổ AWMate đã bị đóng đột ngột",
  "desktop.recovery.unresponsive": "AWMate không phản hồi",
  ...
  "desktop.wsl.error.installAWMate": "Không cài đặt được AWMate",
  "desktop.wsl.error.alreadyAdded": "{{distro}} đã được thêm",
  "desktop.wsl.error.awmateMissing": "awmate chưa được cài đặt trong bản phân phối này",
  "desktop.wsl.error.awmateCannotRun": "awmate đã được cài đặt nhưng không thể chạy",
  "desktop.wsl.error.awmateNotInstalled": "AWMate chưa được cài đặt trong {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Đã cập nhật AWMate nhưng {{distro}} vẫn báo phiên bản {{installed}}; phiên bản dự kiến là {{expected}}",
  ...
  "dialog.provider.awmate.note": "Các mô hình được tuyển chọn, gồm Claude, GPT, Gemini và nhiều mô hình khác",
  "dialog.provider.awmate.tagline": "Các mô hình tối ưu hóa đáng tin cậy",
  "dialog.provider.awmateGo.tagline": "Đăng ký chi phí thấp cho mọi người",
  ...
  "dialog.model.unpaid.freeModels.title": "Các mô hình miễn phí do AWMate cung cấp",
  ...
  "provider.connect.apiKey.description":
    "Nhập khóa API {{provider}} để kết nối tài khoản và sử dụng các mô hình {{provider}} trong AWMate.",
  ...
  "provider.connect.awmateZen.line1":
    "AWMate Zen cho phép bạn truy cập một bộ mô hình được tuyển chọn, tối ưu hóa và đáng tin cậy dành cho tác nhân lập trình.",
  ...
  "provider.connect.awmateZen.visit.prefix": "Truy cập ",
  "provider.connect.awmateZen.visit.link": "opencode.ai/zen",
  "provider.connect.awmateZen.visit.suffix": " để lấy khóa API của bạn.",
  "provider.connect.oauth.code.visit.prefix": "Truy cập ",
  "provider.connect.oauth.code.visit.link": "liên kết này",
  "provider.connect.oauth.code.visit.suffix":
    " để lấy mã ủy quyền, kết nối tài khoản và sử dụng các mô hình {{provider}} trong AWMate.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " và nhập mã bên dưới để kết nối tài khoản của bạn và sử dụng các mô hình {{provider}} trong AWMate.",
  ...
  "dialog.plugins.empty": "Các plugin được định cấu hình trong awmate.json",
  ...
  "dialog.server.description": "Chuyển máy chủ AWMate mà ứng dụng này kết nối tới.",
  ...
  "wsl.onboarding.checkingAWMate": "Đang kiểm tra AWMate...",
  "wsl.onboarding.checkingAWMateIn": "Đang kiểm tra AWMate trong {{distro}}...",
  "wsl.onboarding.updatingAWMate": "Đang cập nhật AWMate...",
  "wsl.onboarding.updatingAWMateIn": "Đang cập nhật AWMate trong {{distro}}...",
  "wsl.onboarding.updateAWMateIn": "Cập nhật AWMate trong {{distro}}.",
  "wsl.onboarding.updateAWMate": "Cập nhật AWMate",
  "wsl.onboarding.awmateReadyIn": "AWMate đã sẵn sàng trong {{distro}}.",
  "wsl.onboarding.awmateReady": "AWMate đã sẵn sàng.",
  "wsl.onboarding.installAWMateIn": "Cài đặt AWMate trong {{distro}}.",
  "wsl.onboarding.installAWMate": "Cài đặt AWMate",
  ...
  "wsl.onboarding.distroStatus.awmateMissing": "AWMate chưa được cài đặt",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Cần có WSL (Hệ thống con Windows dành cho Linux) trước khi AWMate có thể thêm máy chủ WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL không có sẵn",
  "wsl.onboarding.wslUnavailable.description": "AWMate không thể xác minh WSL trên máy này.",
  "wsl.onboarding.installWsl": "Cài đặt WSL",
  "wsl.onboarding.windowsRestartRequired": "Khởi động lại Windows để hoàn tất cài đặt WSL, sau đó mở lại AWMate.",
  ...
  "help.tabs.introduction": "AWMate Desktop nay được xây dựng xoay quanh các tab.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Hiện đã có phiên bản mới của AWMate ({{version}}) để cài đặt.",
  ...
  "error.page.report.prefix": "Vui lòng báo cáo lỗi này cho nhóm AWMate",
  ...
  "error.chain.checkConfig": "Kiểm tra tên nhà cung cấp/mô hình cấu hình (awmate.json) của bạn",
  "error.chain.mcpFailed": 'Máy chủ MCP "{{name}}" gặp lỗi. Lưu ý: AWMate chưa hỗ trợ xác thực MCP.',
  ...
  "sidebar.gettingStarted.line1": "AWMate bao gồm các mô hình miễn phí để bạn có thể bắt đầu ngay lập tức.",
  ...
  "settings.desktop.wsl.description": "Chạy máy chủ AWMate bên trong WSL trên Windows.",
  ...
  "settings.general.row.language.description": "Thay đổi ngôn ngữ hiển thị cho AWMate",
  ...
  "settings.general.row.appearance.description": "Tùy chỉnh giao diện của AWMate trên thiết bị",
  "settings.general.row.colorScheme.title": "Cách phối màu",
  "settings.general.row.colorScheme.description": "Chọn xem AWMate tuân theo hệ thống, chủ đề sáng hay tối",
  "settings.general.row.theme.title": "Chủ đề",
  "settings.general.row.theme.description": "Tùy chỉnh chủ đề của AWMate.",
  ...
  "settings.updates.row.startup.description": "Tự động kiểm tra các bản cập nhật khi AWMate khởi chạy",
  ...
  "settings.updates.toast.latest.description": "Bạn đang chạy phiên bản mới nhất của AWMate.",
