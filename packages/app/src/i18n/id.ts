export const dict = {
  ...
  "desktop.recovery.loadFailed": "AWMate gagal dimuat",
  "desktop.recovery.terminated": "Jendela AWMate berhenti secara tidak terduga",
  "desktop.recovery.unresponsive": "AWMate tidak merespons",
  ...
  "desktop.wsl.error.installAWMate": "Instalasi AWMate gagal",
  "desktop.wsl.error.alreadyAdded": "{{distro}} sudah ditambahkan",
  "desktop.wsl.error.awmateMissing": "awmate belum terinstal di distro ini",
  "desktop.wsl.error.awmateCannotRun": "awmate telah terinstal, tetapi tidak dapat dijalankan",
  "desktop.wsl.error.awmateNotInstalled": "AWMate belum terinstal di {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Pembaruan AWMate selesai, tetapi {{distro}} masih melaporkan {{installed}}; seharusnya {{expected}}",
  ...
  "dialog.provider.awmate.note": "Model pilihan, termasuk Claude, GPT, Gemini, dan lainnya",
  "dialog.provider.awmate.tagline": "Model andal yang dioptimalkan",
  "dialog.provider.awmateGo.tagline": "Langganan terjangkau untuk semua orang",
  ...
  "dialog.model.unpaid.freeModels.title": "Model gratis disediakan oleh AWMate",
  ...
  "provider.connect.apiKey.description":
    "Masukkan kunci API {{provider}} untuk menghubungkan akun Anda dan gunakan model {{provider}} di AWMate.",
  ...
  "provider.connect.awmateZen.line1":
    "AWMate Zen memberi Anda akses ke serangkaian model andal yang dioptimalkan untuk agen pengodean.",
  ...
  "provider.connect.awmateZen.visit.prefix": "Kunjungi ",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " untuk mendapatkan kode otorisasi guna menghubungkan akun Anda dan menggunakan model {{provider}} di AWMate.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dan masukkan kode di bawah untuk menghubungkan akun dan menggunakan model {{provider}} di AWMate.",
  ...
  "dialog.plugins.empty": "Plugin dikonfigurasi di awmate.json",
  ...
  "dialog.server.description": "Ganti server AWMate mana yang terhubung dengan aplikasi ini.",
  ...
  "wsl.onboarding.checkingAWMate": "Memeriksa AWMate...",
  "wsl.onboarding.checkingAWMateIn": "Memeriksa AWMate di {{distro}}...",
  "wsl.onboarding.updatingAWMate": "Memperbarui AWMate...",
  "wsl.onboarding.updatingAWMateIn": "Memperbarui AWMate di {{distro}}...",
  "wsl.onboarding.updateAWMateIn": "Perbarui AWMate di {{distro}}.",
  "wsl.onboarding.updateAWMate": "Perbarui AWMate",
  "wsl.onboarding.awmateReadyIn": "AWMate siap di {{distro}}.",
  "wsl.onboarding.awmateReady": "AWMate siap.",
  "wsl.onboarding.installAWMateIn": "Instal AWMate di {{distro}}.",
  "wsl.onboarding.installAWMate": "Instal AWMate",
  ...
  "wsl.onboarding.distroStatus.awmateMissing": "AWMate belum terinstal",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) diperlukan sebelum AWMate dapat menambahkan server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL tidak tersedia",
  "wsl.onboarding.wslUnavailable.description": "AWMate tidak dapat memverifikasi WSL di komputer ini.",
  "wsl.onboarding.installWsl": "Instal WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Mulai ulang Windows untuk menyelesaikan instalasi WSL, lalu buka kembali AWMate.",
  ...
  "help.tabs.introduction": "AWMate Desktop kini dirancang dengan tab sebagai pusatnya.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Versi baru AWMate ({{version}}) sekarang tersedia untuk diinstal.",
  ...
  "error.page.report.prefix": "Harap laporkan kesalahan ini ke tim AWMate",
  ...
  "error.chain.checkConfig": "Periksa nama penyedia/model di konfigurasi Anda (awmate.json)",
  "error.chain.mcpFailed": 'Server MCP "{{name}}" gagal. Catatan: AWMate belum mendukung autentikasi MCP.',
  ...
  "sidebar.gettingStarted.line1": "AWMate menyertakan model gratis sehingga Anda dapat memulai dengan segera.",
  ...
  "settings.desktop.wsl.description": "Jalankan server AWMate di dalam WSL di Windows.",
  ...
  "settings.general.row.language.description": "Ubah bahasa tampilan untuk AWMate",
  ...
  "settings.general.row.appearance.description": "Sesuaikan tampilan AWMate di perangkat Anda",
  "settings.general.row.colorScheme.title": "Skema warna",
  "settings.general.row.colorScheme.description": "Pilih apakah AWMate mengikuti tema sistem, terang, atau gelap",
  ...
  "settings.updates.row.startup.description": "Secara otomatis memeriksa pembaruan saat AWMate diluncurkan",
  ...
  "settings.updates.toast.latest.description": "Anda menjalankan versi terbaru AWMate.",
