export const dict = {
  ...
  "desktop.menu.documentation": "Documentație AWMate",
  ...
  "desktop.menu.ariaLabel": "Meniu AWMate",
  ...
  "desktop.recovery.loadFailed": "AWMate nu a putut fi încărcat",
  "desktop.recovery.terminated": "Fereastra AWMate s-a închis neașteptat",
  "desktop.recovery.unresponsive": "AWMate nu răspunde",
  ...
  "desktop.wsl.error.installAWMate": "Instalarea AWMate a eșuat",
  "desktop.wsl.error.alreadyAdded": "{{distro}} este deja adăugată",
  "desktop.wsl.error.awmateMissing": "awmate nu este instalat în această distribuție",
  "desktop.wsl.error.awmateCannotRun": "awmate este instalat, dar nu a putut fi pornit",
  "desktop.wsl.error.awmateNotInstalled": "AWMate nu este instalat în {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Actualizarea AWMate s-a terminat, dar {{distro}} raportează tot {{installed}}; era așteptat {{expected}}",
  ...
  "dialog.provider.awmate.note": "Modele selectate, inclusiv Claude, GPT, Gemini și altele",
  "dialog.provider.awmate.tagline": "Modele optimizate, fiabile",
  "dialog.provider.awmateGo.tagline": "Abonament accesibil pentru toți",
  ...
  "dialog.model.unpaid.freeModels.title": "Modele gratuite oferite de AWMate",
  ...
  "provider.connect.apiKey.description":
    "Introdu cheia API {{provider}} pentru a-ți conecta contul și a folosi modelele {{provider}} în AWMate.",
  ...
  "provider.connect.awmateZen.line1":
    "AWMate Zen îți oferă acces la un set selectat de modele optimizate și fiabile pentru agenți de programare.",
  "provider.connect.awmateZen.line2":
    "Cu o singură cheie API ai acces la modele precum Claude, GPT, Gemini, GLM și altele.",
  "provider.connect.awmateZen.visit.prefix": "Vizitează",
  "provider.connect.awmateZen.visit.link": "opencode.ai/zen",
  "provider.connect.awmateZen.visit.suffix": "pentru a obține cheia ta API.",
  "provider.connect.oauth.code.visit.prefix": "Vizitează",
  "provider.connect.oauth.code.visit.link": "acest link",
  "provider.connect.oauth.code.visit.suffix":
    " pentru a obține codul de autorizare și a-ți conecta contul ca să folosești modelele {{provider}} în AWMate.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " și introdu codul de mai jos pentru a-ți conecta contul și a folosi modelele {{provider}} în AWMate.",
  ...
  "dialog.plugins.empty": "Pluginuri configurate în awmate.json",
  ...
  "dialog.server.description": "Schimbă serverul AWMate la care se conectează aplicația.",
  ...
  "wsl.onboarding.checkingAWMate": "Se verifică AWMate...",
  "wsl.onboarding.checkingAWMateIn": "Se verifică AWMate în {{distro}}...",
  "wsl.onboarding.updatingAWMate": "Se actualizează AWMate...",
  "wsl.onboarding.updatingAWMateIn": "Se actualizează AWMate în {{distro}}...",
  "wsl.onboarding.updateAWMateIn": "Actualizează AWMate în {{distro}}.",
  "wsl.onboarding.updateAWMate": "Actualizează AWMate",
  "wsl.onboarding.awmateReadyIn": "AWMate este gata în {{distro}}.",
  "wsl.onboarding.awmateReady": "AWMate este gata.",
  "wsl.onboarding.installAWMateIn": "Instalează AWMate în {{distro}}.",
  "wsl.onboarding.installAWMate": "Instalează AWMate",
  ...
  "wsl.onboarding.distroStatus.awmateMissing": "AWMate nu este instalat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Subsistemul Windows pentru Linux) este necesar înainte ca AWMate să poată adăuga un server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponibil",
  "wsl.onboarding.wslUnavailable.description": "AWMate nu a putut verifica WSL pe acest calculator.",
  "wsl.onboarding.installWsl": "Instalează WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Repornește Windows pentru a finaliza instalarea WSL, apoi redeschide AWMate.",
  ...
  "help.tabs.introduction": "AWMate Desktop este acum construit în jurul filelor.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "O nouă versiune AWMate ({{version}}) este disponibilă pentru instalare.",
  ...
  "error.page.report.prefix": "Te rugăm să raportezi această eroare echipei AWMate",
  ...
  "error.chain.checkConfig": "Verifică numele provider/model în config (awmate.json)",
  "error.chain.mcpFailed": 'Serverul MCP "{{name}}" a eșuat. Atenție, AWMate nu suportă încă autentificarea MCP.',
  ...
  "sidebar.gettingStarted.line1": "AWMate include modele gratuite ca să poți începe imediat.",
  ...
  "settings.desktop.wsl.description": "Rulează serverul AWMate în WSL pe Windows.",
  ...
  "settings.general.row.language.description": "Schimbă limba de afișare pentru AWMate",
  ...
  "settings.general.row.appearance.description": "Personalizează aspectul AWMate pe dispozitivul tău",
  "settings.general.row.colorScheme.title": "Scheamă de culori",
  "settings.general.row.colorScheme.description": "Alege dacă AWMate urmează sistemul, tema deschisă sau închisă",
  "settings.general.row.theme.title": "Temă",
  "settings.general.row.theme.description": "Personalizează tema AWMate.",
  ...
  "settings.updates.row.startup.description": "Verifică automat actualizările la lansarea AWMate",
  ...
  "settings.updates.toast.latest.description": "Folosești cea mai recentă versiune AWMate.",
