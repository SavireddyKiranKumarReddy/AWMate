export const dict = {
  ...
  "desktop.recovery.loadFailed": "โหลด AWMate ไม่สำเร็จ",
  "desktop.recovery.terminated": "หน้าต่าง AWMate หยุดทำงานโดยไม่คาดคิด",
  "desktop.recovery.unresponsive": "AWMate ไม่ตอบสนอง",
  ...
  "desktop.wsl.error.installAWMate": "การติดตั้ง AWMate ล้มเหลว",
  "desktop.wsl.error.alreadyAdded": "เพิ่ม {{distro}} แล้ว",
  "desktop.wsl.error.awmateMissing": "ไม่ได้ติดตั้ง awmate ในดิสโทรนี้",
  "desktop.wsl.error.awmateCannotRun": "ติดตั้ง awmate แล้ว แต่ไม่สามารถเรียกใช้ได้",
  "desktop.wsl.error.awmateNotInstalled": "ไม่ได้ติดตั้ง AWMate ใน {{distro}}",
  "desktop.wsl.error.updateVersion":
    "อัปเดต AWMate เสร็จแล้ว แต่ {{distro}} ยังคงรายงานเวอร์ชัน {{installed}} ทั้งที่ควรเป็น {{expected}}",
  ...
  "dialog.provider.awmateGo.tagline": "การสมัครสมาชิกราคาประหยัดสำหรับทุกคน",
  ...
  "provider.connect.awmateZen.visit.prefix": "เยี่ยมชม ",
  "provider.connect.awmateZen.visit.link": "opencode.ai/zen",
  "provider.connect.awmateZen.visit.suffix": " เพื่อรับคีย์ API ของคุณ",
  "provider.connect.oauth.code.visit.prefix": "เยี่ยมชม ",
  "provider.connect.oauth.code.visit.link": "ลิงก์นี้",
  "provider.connect.oauth.code.visit.suffix":
    " เพื่อรับรหัสการอนุญาตสำหรับเชื่อมต่อบัญชีและใช้โมเดล {{provider}} ใน AWMate",
  ...
  "wsl.onboarding.checkingAWMate": "กำลังตรวจสอบ AWMate...",
  "wsl.onboarding.checkingAWMateIn": "กำลังตรวจสอบ AWMate ใน {{distro}}...",
  "wsl.onboarding.updatingAWMate": "กำลังอัปเดต AWMate...",
  "wsl.onboarding.updatingAWMateIn": "กำลังอัปเดต AWMate ใน {{distro}}...",
  "wsl.onboarding.updateAWMateIn": "อัปเดต AWMate ใน {{distro}}",
  "wsl.onboarding.updateAWMate": "อัปเดต AWMate",
  "wsl.onboarding.awmateReadyIn": "AWMate พร้อมใช้งานใน {{distro}} แล้ว",
  "wsl.onboarding.awmateReady": "AWMate พร้อมใช้งานแล้ว",
  ...
  "wsl.onboarding.distroStatus.awmateMissing": "ยังไม่ได้ติดตั้ง AWMate",
  ...
  "help.tabs.introduction": "ตอนนี้ AWMate Desktop สร้างขึ้นโดยใช้แท็บเป็นหลัก",
  "help.tabs.sessions":
  ...
  "settings.general.row.appearance.description": "ปรับแต่งรูปลักษณ์ของ AWMate บนอุปกรณ์ของคุณ",
  ...
  "settings.general.row.theme.description": "ปรับแต่งธีมของ AWMate",
