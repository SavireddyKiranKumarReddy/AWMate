export const dict = {
  ...
  "desktop.menu.documentation": "AWMate Resminamalar",
  ...
  "desktop.menu.ariaLabel": "AWMate menýusy",
  ...
  "desktop.recovery.loadFailed": "AWMate ýükläp bilmedi",
  "desktop.recovery.terminated": "AWMate penjiresi garaşylmadyk ýagdaýda bes edildi",
  "desktop.recovery.unresponsive": "AWMate jogap berenok",
  ...
  "desktop.wsl.error.installAWMate": "AWMate gurmak şowsuz",
  "desktop.wsl.error.alreadyAdded": "{{distro}} eýýäm goşuldy",
  "desktop.wsl.error.awmateMissing": "açyk kod bu distroda gurlanok",
  "desktop.wsl.error.awmateCannotRun": "awmate guruldy, ýöne işledip bilmedi",
  "desktop.wsl.error.awmateNotInstalled": "AWMate {{distro}} gurulmady",
  "desktop.wsl.error.updateVersion":
    "AWMate täzelenmesi gutardy, ýöne {{distro}} henizem {{installed}} habar berýär; garaşylýan {{expected}}",
  ...
  "dialog.provider.awmate.note": "Claude, GPT, Gemini we ş.m.",
  "dialog.provider.awmate.tagline": "Ygtybarly optimal modeller",
  "dialog.provider.awmateGo.tagline": "Hemmeler üçin arzan bahaly abuna",
  ...
  "dialog.model.unpaid.freeModels.title": "AWMate tarapyndan mugt modeller",
  ...
  "provider.connect.apiKey.description":
    "Hasabyňyzy birikdirmek we AWMate-da {{provider}} modellerini ulanmak üçin {{provider}} API açaryňyzy giriziň.",
  ...
  "provider.connect.awmateZen.line1":
    "AWMate Zen kodlaşdyrmak serişdeleri üçin ygtybarly optimallaşdyrylan modelleriň toplumyna girmäge mümkinçilik berýär.",
  "provider.connect.awmateZen.line2":
    "Zekeje API açary bilen Claude, GPT, Gemini, GLM we başgalar ýaly modellere girip bilersiňiz.",
  "provider.connect.awmateZen.visit.prefix": "Sapar ",
  "provider.connect.awmateZen.visit.link": "opencode.ai/zen",
  "provider.connect.awmateZen.visit.suffix": " API açaryňyzy ýygnamak.",
  "provider.connect.oauth.code.visit.prefix": "Sapar ",
  "provider.connect.oauth.code.visit.link": "Bu baglanyşyk",
  "provider.connect.oauth.code.visit.suffix":
    " hasabyňyzy birikdirmek we {{provider}} modellerini AWMate-de ulanmak üçin ygtyýarnama koduňyzy ýygnamak.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " hasabyňyzy birikdirmek we {{provider}} modellerini AWMate-de ulanmak üçin aşakdaky kody giriziň.",
  ...
  "dialog.plugins.empty": "awmate.json-de düzülen pluginler",
  ...
  "dialog.server.description": "Bu programmanyň haýsy AWMate serwerine birikýändigini üýtgediň.",
  ...
  "wsl.onboarding.checkingAWMate": "AWMate barlamak ...",
  "wsl.onboarding.checkingAWMateIn": "{{distro}} içinde AWMate barlanýar...",
  "wsl.onboarding.updatingAWMate": "AWMate täzelenmek ...",
  "wsl.onboarding.updatingAWMateIn": "{{distro}}-de AWMate täzelenmek ...",
  "wsl.onboarding.updateAWMateIn": "AWMate-ni {{distro}}-de täzeläň.",
  "wsl.onboarding.updateAWMate": "AWMate täzeläň",
  "wsl.onboarding.awmateReadyIn": "AWMate {{distro}}-de taýýar.",
  "wsl.onboarding.awmateReady": "AWMate taýýar.",
  "wsl.onboarding.installAWMateIn": "{{distro}}-de AWMate guruň.",
  "wsl.onboarding.installAWMate": "AWMate guruň",
  ...
  "wsl.onboarding.distroStatus.awmateMissing": "AWMate gurulmady",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Linux üçin Windows kiçi ulgamy) AWMate WSL serwerini goşmazdan ozal talap edilýär",
  "wsl.onboarding.wslUnavailable.title": "WSL elýeterli däl",
  "wsl.onboarding.wslUnavailable.description": "AWMate bu enjamda WSL barlap bilmedi.",
  "wsl.onboarding.installWsl": "WSL guruň",
  "wsl.onboarding.windowsRestartRequired": "WSL gurnamagy gutarmak üçin Windows-i täzeden açyň, soňra AWMate açyň.",
  ...
  "help.tabs.introduction": "AWMate Desktop indi goýmalaryň töwereginde guruldy.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Indi gurmak üçin AWMate ({{version}}) -iň täze wersiýasy bar.",
  ...
  "error.page.report.prefix": "Bu ýalňyşlygy AWMate toparyna habar bermegiňizi haýyş edýäris",
  ...
  "error.chain.checkConfig": "Konfigurasiýaňyzy (awmate.json) üpjün edijiniň / model atlaryny barlaň",
  "error.chain.mcpFailed": 'MCP serweri "{{name}}" şowsuz. Üns beriň, AWMate entek MCP tassyklamasyny goldamaýar.',
  ...
  "sidebar.gettingStarted.line1": "AWMate mugt modelleri öz içine alýar, derrew başlap bilersiňiz.",
  ...
  "settings.desktop.wsl.description": "AWMate serwerini WSL-de Windows-de işlediň.",
  ...
  "settings.general.row.language.description": "AWMate üçin displeý dilini üýtgediň",
  ...
  "settings.general.row.appearance.description": "AWMate enjamyňyzda nähili görünýändigini düzüň",
  "settings.general.row.colorScheme.title": "Reňk shemasy",
  "settings.general.row.colorScheme.description":
    "AWMate ulgamy, ýagtylygy ýa-da garaňky temany yzarlaýandygyny saýlaň",
  "settings.general.row.theme.title": "Mowzuk",
  "settings.general.row.theme.description": "AWMate-iň mowzuklydygyny düzüň.",
  ...
  "settings.updates.row.startup.description": "AWMate işe başlanda täzelenmeleri awtomatiki barlaň",
  ...
  "settings.updates.toast.latest.description": "AWMate-iň iň soňky wersiýasyny işleýärsiňiz.",
