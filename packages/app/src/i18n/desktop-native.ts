...
export const DESKTOP_NATIVE_ENGLISH = {
  ...
  "desktop.recovery.loadFailed": "AWMate failed to load",
  "desktop.recovery.terminated": "AWMate window terminated unexpectedly",
  "desktop.recovery.unresponsive": "AWMate is not responding",
  ...
  "desktop.wsl.error.installAWMate": "AWMate installation failed",
  "desktop.wsl.error.alreadyAdded": "{{distro}} is already added",
  "desktop.wsl.error.awmateMissing": "awmate is not installed in this distro",
  "desktop.wsl.error.awmateCannotRun": "awmate is installed but could not run",
  "desktop.wsl.error.awmateNotInstalled": "AWMate is not installed in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "AWMate update finished but {{distro}} still reports {{installed}}; expected {{expected}}",
