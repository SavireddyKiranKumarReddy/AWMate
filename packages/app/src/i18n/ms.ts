export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentasi AWMate",
  ...
  "desktop.recovery.loadFailed": "AWMate gagal dimuatkan",
  "desktop.recovery.terminated": "Tetingkap AWMate ditamatkan secara tidak dijangka",
  "desktop.recovery.unresponsive": "AWMate tidak memberi respons",
  ...
  "desktop.wsl.error.installAWMate": "Pemasangan AWMate gagal",
  "desktop.wsl.error.alreadyAdded": "{{distro}} telah pun ditambah",
  "desktop.wsl.error.awmateMissing": "awmate tidak dipasang dalam distro ini",
  "desktop.wsl.error.awmateCannotRun": "awmate dipasang tetapi tidak dapat dijalankan",
  "desktop.wsl.error.awmateNotInstalled": "AWMate tidak dipasang dalam {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Kemas kini AWMate selesai tetapi {{distro}} masih melaporkan {{installed}}; sepatutnya {{expected}}",
  ...
  "dialog.provider.awmate.note": "Model terpilih termasuk Claude, GPT, Gemini dan banyak lagi",
  "dialog.provider.awmate.tagline": "Model dioptimumkan yang boleh dipercayai",
  "dialog.provider.awmateGo.tagline": "Langganan kos rendah untuk semua",
  ...
  "dialog.model.unpaid.freeModels.title": "Model percuma yang disediakan oleh AWMate",
  ...
  "provider.connect.apiKey.description":
    "Masukkan kunci API {{provider}} anda untuk menghubungkan akaun anda dan menggunakan model {{provider}} dalam AWMate.",
  ...
  "provider.connect.awmateZen.line1":
    "AWMate Zen memberi anda akses kepada set model terpilih yang boleh dipercayai dan dioptimumkan untuk ejen pengekodan.",
  ...
  "provider.connect.awmateZen.visit.prefix": "Layari",
  "provider.connect.awmateZen.visit.link": "opencode.ai/zen",
  "provider.connect.awmateZen.visit.suffix": "untuk mendapatkan kunci API anda.",
  "provider.connect.oauth.code.visit.prefix": "Layari",
  "provider.connect.oauth.code.visit.link": "pautan ini",
  "provider.connect.oauth.code.visit.suffix":
    " untuk mendapatkan kod kebenaran anda bagi menghubungkan akaun dan menggunakan model {{provider}} dalam AWMate.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dan masukkan kod di bawah untuk menghubungkan akaun anda dan menggunakan model {{provider}} dalam AWMate.",
  ...
  "dialog.plugins.empty": "Plugin dikonfigurasi dalam awmate.json",
  ...
  "dialog.server.description": "Tukar pelayan AWMate yang disambungkan oleh aplikasi ini.",
  ...
  "wsl.onboarding.checkingAWMate": "Sedang menyemak AWMate...",
  "wsl.onboarding.checkingAWMateIn": "Sedang menyemak AWMate dalam {{distro}}...",
  "wsl.onboarding.updatingAWMate": "Sedang mengemas kini AWMate...",
  "wsl.onboarding.updatingAWMateIn": "Sedang mengemas kini AWMate dalam {{distro}}...",
  "wsl.onboarding.updateAWMateIn": "Kemas kini AWMate dalam {{distro}}.",
  "wsl.onboarding.updateAWMate": "Kemas kini AWMate",
  "wsl.onboarding.awmateReadyIn": "AWMate sedia digunakan dalam {{distro}}.",
  "wsl.onboarding.awmateReady": "AWMate sedia digunakan.",
  "wsl.onboarding.installAWMateIn": "Pasang AWMate dalam {{distro}}.",
  "wsl.onboarding.installAWMate": "Pasang AWMate",
  ...
  "wsl.onboarding.distroStatus.awmateMissing": "AWMate belum dipasang",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) diperlukan sebelum AWMate boleh menambah pelayan WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL tidak tersedia",
  "wsl.onboarding.wslUnavailable.description": "AWMate tidak dapat mengesahkan WSL pada mesin ini.",
  "wsl.onboarding.installWsl": "Pasang WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Mulakan semula Windows untuk menyiapkan pemasangan WSL, kemudian buka semula AWMate.",
  ...
  "help.tabs.introduction": "AWMate Desktop kini dibina berasaskan tab.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Versi baharu AWMate ({{version}}) kini tersedia untuk dipasang.",
  ...
  "error.page.report.prefix": "Sila laporkan ralat ini kepada pasukan AWMate",
  ...
  "error.chain.checkConfig": "Semak konfigurasi anda (awmate.json) nama penyedia/model",
  "error.chain.mcpFailed": 'Pelayan MCP "{{name}}" gagal. Nota, AWMate belum menyokong pengesahan MCP.',
  ...
  "sidebar.gettingStarted.line1": "AWMate merangkumi model percuma supaya anda boleh bermula serta-merta.",
  ...
  "settings.desktop.wsl.description": "Jalankan pelayan AWMate dalam WSL di Windows.",
  ...
  "settings.general.row.language.description": "Tukar bahasa paparan untuk AWMate",
  ...
  "settings.general.row.appearance.description": "Sesuaikan rupa AWMate pada peranti anda",
  "settings.general.row.colorScheme.title": "Skema warna",
  "settings.general.row.colorScheme.description": "Pilih sama ada AWMate mengikut sistem, tema cerah, atau gelap",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Sesuaikan tema AWMate.",
  ...
  "settings.updates.row.startup.description": "Semak kemas kini secara automatik apabila AWMate dilancarkan",
  ...
  "settings.updates.toast.latest.description": "Anda sedang menggunakan versi terkini AWMate.",
