...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "AWMate yüklenemedi",
  "desktop.recovery.terminated": "AWMate penceresi beklenmedik şekilde sonlandırıldı",
  "desktop.recovery.unresponsive": "AWMate yanıt vermiyor",
  ...
  "desktop.wsl.error.installAWMate": "AWMate kurulamadı",
  "desktop.wsl.error.alreadyAdded": "{{distro}} zaten eklendi",
  "desktop.wsl.error.awmateMissing": "awmate bu dağıtımda kurulu değil",
  "desktop.wsl.error.awmateCannotRun": "awmate kurulu ancak çalıştırılamadı",
  "desktop.wsl.error.awmateNotInstalled": "AWMate, {{distro}} içinde kurulu değil",
  "desktop.wsl.error.updateVersion":
    "AWMate güncellemesi tamamlandı ancak {{distro}} hâlâ {{installed}} sürümünü bildiriyor; beklenen sürüm: {{expected}}",
  ...
  "dialog.provider.awmateGo.tagline": "Herkes için düşük maliyetli abonelik",
  ...
  "provider.connect.awmateZen.visit.suffix": " adresini ziyaret ederek API anahtarınızı alın.",
  ...
  "wsl.onboarding.checkingAWMate": "AWMate kontrol ediliyor...",
  "wsl.onboarding.checkingAWMateIn": "{{distro}} içinde AWMate kontrol ediliyor...",
  "wsl.onboarding.updatingAWMate": "AWMate güncelleniyor...",
  "wsl.onboarding.updatingAWMateIn": "{{distro}} içinde AWMate güncelleniyor...",
  "wsl.onboarding.updateAWMateIn": "{{distro}} içindeki AWMate'u güncelleyin.",
  "wsl.onboarding.updateAWMate": "AWMate'u güncelle",
  "wsl.onboarding.awmateReadyIn": "{{distro}} içinde AWMate hazır.",
  "wsl.onboarding.awmateReady": "AWMate hazır.",
  ...
  "wsl.onboarding.distroStatus.awmateMissing": "AWMate kurulu değil",
  ...
  "help.tabs.introduction": "AWMate Desktop artık sekmeler üzerine kurulu.",
  "help.tabs.sessions":
  ...
  "error.page.report.prefix": "Lütfen bu hatayı AWMate ekibine",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızdaki (awmate.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" çalıştırılamadı. Not: AWMate henüz MCP kimlik doğrulamasını desteklemiyor.',
