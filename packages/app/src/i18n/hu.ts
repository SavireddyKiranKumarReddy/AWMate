...
const desktop = [
  ...
  "Kilépés",
  "Az AWMate betöltése sikertelen",
  "Az AWMate ablaka váratlanul leállt",
  "Az AWMate nem válaszol",
  ...
  "Az AWMate telepítése sikertelen",
  "A(z) {{distro}} már hozzá van adva",
  "Az awmate nincs telepítve ebben a disztribúcióban",
  "Az awmate telepítve van, de nem futtatható",
  "Az AWMate nincs telepítve ebben: {{distro}}",
  "Az AWMate frissítése befejeződött, de a(z) {{distro}} továbbra is ezt jelenti: {{installed}}; a várt érték: {{expected}}",
  "nincs verzió",
...
export const dict = {
  ...
  "dialog.provider.awmate.note": "Összeválogatott modellek, köztük Claude, GPT, Gemini és még sok más",
  "dialog.provider.awmate.tagline": "Megbízható optimalizált modellek",
  "dialog.provider.awmateGo.tagline": "Olcsó előfizetés mindenki számára",
  ...
  "dialog.model.unpaid.freeModels.title": "A AWMate ingyenes modelljei",
  ...
  "provider.connect.apiKey.description":
    "Enter az Ön {{provider}} API kulcsa fiókja összekapcsolásához és a {{provider}} modellek használatához a AWMate-ben.",
  ...
  "provider.connect.awmateZen.line1":
    "A AWMate Zen hozzáférést biztosít a kódoló ügynökök számára megbízható, optimalizált modellek válogatott készletéhez.",
  ...
  "provider.connect.awmateZen.visit.prefix": "Látogatás",
  "provider.connect.awmateZen.visit.link": "opencode.ai/zen",
  "provider.connect.awmateZen.visit.suffix": "hogy átvegye a API kulcsát.",
  "provider.connect.oauth.code.visit.prefix": "Látogatás",
  "provider.connect.oauth.code.visit.link": "ezt a linket",
  "provider.connect.oauth.code.visit.suffix":
    "az engedélyezési kód összegyűjtéséhez fiókja összekapcsolásához és a {{provider}} modellek használatához a AWMate-ben.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "és írja be az alábbi kódot fiókja összekapcsolásához, és használja a {{provider}} modelleket a AWMate-ben.",
  ...
  "dialog.plugins.empty": "Az awmate.json fájlban konfigurált beépülő modulok",
  ...
  "dialog.server.description": "Állítsa be, hogy ez az alkalmazás melyik AWMate szerverhez csatlakozzon.",
  ...
  "wsl.onboarding.checkingAWMate": "AWMate ellenőrzése...",
  "wsl.onboarding.checkingAWMateIn": "AWMate ellenőrzése a {{distro}}-ben...",
  "wsl.onboarding.updatingAWMate": "AWMate frissítése...",
  "wsl.onboarding.updatingAWMateIn": "AWMate frissítése a {{distro}}-ben...",
  "wsl.onboarding.updateAWMateIn": "Frissítse a AWMate-t a {{distro}}-ben.",
  "wsl.onboarding.updateAWMate": "Frissítse a AWMate-t",
  "wsl.onboarding.awmateReadyIn": "A AWMate készen áll a {{distro}}-ben.",
  "wsl.onboarding.awmateReady": "A AWMate készen áll.",
  "wsl.onboarding.installAWMateIn": "Telepítse a AWMate-t a {{distro}}-be.",
  "wsl.onboarding.installAWMate": "Telepítse a AWMate-t",
  ...
  "wsl.onboarding.distroStatus.awmateMissing": "A AWMate nincs telepítve",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "A WSL (Windows alrendszer a Linux számára) szükséges ahhoz, hogy a AWMate hozzáadhasson egy WSL szervert",
  "wsl.onboarding.wslUnavailable.title": "A WSL nem elérhető",
  "wsl.onboarding.wslUnavailable.description": "A AWMate nem tudta ellenőrizni a WSL jelet ezen a gépen.",
  "wsl.onboarding.installWsl": "Telepítse a WSL-t",
  "wsl.onboarding.windowsRestartRequired":
    "Indítsa újra a Windows programot a WSL telepítésének befejezéséhez, majd nyissa meg újra a AWMate programot.",
  ...
  "help.tabs.introduction": "A AWMate Desktop mostantól lapokra épül.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "A AWMate ({{version}}) új verziója már telepíthető.",
  ...
  "error.page.report.prefix": "Kérjük, jelentse ezt a hibát a AWMate csapatának",
  ...
  "error.chain.checkConfig": "Ellenőrizze a konfigurációs (awmate.json) szolgáltató/modell nevét",
  "error.chain.mcpFailed":
    'A "{{name}}" MCP szerver meghibásodott. Megjegyzés: a AWMate még nem támogatja a MCP hitelesítést.',
  ...
  "sidebar.gettingStarted.line1": "A AWMate ingyenes modelleket tartalmaz, így azonnal elkezdheti.",
  ...
  "app.name.desktop": "AWMate asztali számítógép",
  ...
  "settings.desktop.wsl.description": "Futtassa a AWMate szervert a WSL belsejében a Windows rendszeren.",
  ...
  "settings.general.row.language.description": "Módosítsa a AWMate kijelző nyelvét",
  ...
  "settings.general.row.appearance.description": "Szabja személyre, hogyan néz ki a AWMate az eszközén",
  "settings.general.row.colorScheme.title": "Színséma",
  "settings.general.row.colorScheme.description":
    "Válassza ki, hogy a AWMate a rendszer, a világos vagy a sötét témát követi-e",
  "settings.general.row.theme.title": "Téma",
  "settings.general.row.theme.description": "Szabja személyre a AWMate témáját.",
  ...
  "settings.updates.row.startup.description": "A AWMate indításakor automatikusan ellenőrizze a frissítéseket",
  ...
  "settings.updates.toast.latest.description": "Ön a AWMate legújabb verzióját futtatja.",
