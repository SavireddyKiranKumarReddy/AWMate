export const dict: Record<string, string> = {
  ...
  "desktop.menu.documentation": "AWMate कागजात",
  ...
  "desktop.menu.ariaLabel": "AWMate मेनु",
  ...
  "desktop.recovery.loadFailed": "AWMate लोड हुन सकेन",
  "desktop.recovery.terminated": "AWMate विन्डो अप्रत्याशित रूपमा समाप्त भयो",
  "desktop.recovery.unresponsive": "AWMate ले प्रतिक्रिया दिइरहेको छैन",
  ...
  "desktop.wsl.error.installAWMate": "AWMate स्थापना असफल भयो",
  "desktop.wsl.error.alreadyAdded": "{{distro}} पहिले नै थपिएको छ",
  "desktop.wsl.error.awmateMissing": "AWMate यस distro मा स्थापित छैन",
  "desktop.wsl.error.awmateCannotRun": "awmate स्थापित छ तर चलाउन सकिएन",
  "desktop.wsl.error.awmateNotInstalled": "AWMate {{distro}} मा स्थापित छैन",
  "desktop.wsl.error.updateVersion":
    "AWMate अद्यावधिक समाप्त भयो तर {{distro}} ले अझै पनि रिपोर्ट गर्छ {{installed}}; अपेक्षित {{expected}}",
  ...
  "dialog.provider.awmate.note": "Claude, GPT, Gemini र थप सहित क्युरेट गरिएका मोडेलहरू",
  "dialog.provider.awmate.tagline": "भरपर्दो अनुकूलित मोडेलहरू",
  "dialog.provider.awmateGo.tagline": "सबैको लागि कम लागत सदस्यता",
  ...
  "dialog.model.unpaid.freeModels.title": "AWMate द्वारा प्रदान गरिएको नि:शुल्क मोडेलहरू",
  ...
  "provider.connect.apiKey.description":
    "आफ्नो खाता जडान गर्न आफ्नो {{provider}} API कुञ्जी प्रविष्ट गर्नुहोस् र AWMate मा {{provider}} मोडेलहरू प्रयोग गर्नुहोस्।",
  ...
  "provider.connect.awmateZen.line1":
    "AWMate Zen ले तपाईंलाई कोडिङ एजेन्टहरूका लागि भरपर्दो अनुकूलित मोडेलहरूको क्युरेट गरिएको सेटमा पहुँच दिन्छ।",
  ...
  "provider.connect.awmateZen.visit.prefix": "भ्रमण गर्नुहोस्",
  "provider.connect.awmateZen.visit.link": "opencode.ai/zen",
  "provider.connect.awmateZen.visit.suffix": "तपाईँको API कुञ्जी सङ्कलन गर्न।",
  "provider.connect.oauth.code.visit.prefix": "भ्रमण गर्नुहोस्",
  "provider.connect.oauth.code.visit.link": "यो लिङ्क",
  "provider.connect.oauth.code.visit.suffix":
    "आफ्नो खाता जडान गर्न र AWMate मा {{provider}} मोडेलहरू प्रयोग गर्न आफ्नो प्राधिकरण कोड सङ्कलन गर्न।",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "र आफ्नो खाता जडान गर्न तलको कोड प्रविष्ट गर्नुहोस् र {{provider}} मोडेलहरू AWMate मा प्रयोग गर्नुहोस्।",
  ...
  "dialog.plugins.empty": "awmate.json मा कन्फिगर गरिएका प्लगइनहरू",
  ...
  "dialog.server.description": "यो एप जडान भएको AWMate सर्भरलाई स्विच गर्नुहोस्।",
  ...
  "wsl.onboarding.checkingAWMate": "AWMate जाँच गर्दै...",
  "wsl.onboarding.checkingAWMateIn": "{{distro}} मा AWMate जाँच गर्दै...",
  "wsl.onboarding.updatingAWMate": "अद्यावधिक गर्दै AWMate...",
  "wsl.onboarding.updatingAWMateIn": "{{distro}} मा AWMate अद्यावधिक गर्दै...",
  "wsl.onboarding.updateAWMateIn": "अपडेट गर्नुहोस् AWMate {{distro}} मा।",
  "wsl.onboarding.updateAWMate": "अपडेट गर्नुहोस् AWMate",
  "wsl.onboarding.awmateReadyIn": "AWMate {{distro}} मा तयार छ।",
  "wsl.onboarding.awmateReady": "AWMate तयार छ।",
  "wsl.onboarding.installAWMateIn": "{{distro}} मा AWMate स्थापना गर्नुहोस्।",
  "wsl.onboarding.installAWMate": "AWMate स्थापना गर्नुहोस्",
  ...
  "wsl.onboarding.distroStatus.awmateMissing": "AWMate स्थापित छैन",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Linux को लागि सबसिस्टम) AWMate ले WSL सर्भर थप्न अघि आवश्यक छ।",
  "wsl.onboarding.wslUnavailable.title": "WSL उपलब्ध छैन",
  "wsl.onboarding.wslUnavailable.description": "AWMate ले यो मेसिनमा WSL प्रमाणित गर्न सकेन।",
  "wsl.onboarding.installWsl": "WSL स्थापना गर्नुहोस्",
  "wsl.onboarding.windowsRestartRequired":
    "WSL स्थापना पूरा गर्न Windows पुन: सुरु गर्नुहोस्, त्यसपछि AWMate पुन: खोल्नुहोस्।",
  ...
  "help.tabs.introduction": "AWMate डेस्कटप अब ट्याब वरिपरि बनाइएको छ।",
  "help.tabs.sessions":
  ...
  "toast.update.description": "AWMate ({{version}}) को नयाँ संस्करण अब स्थापना गर्न उपलब्ध छ।",
  ...
  "error.page.report.prefix": "कृपया यो त्रुटि AWMate टोलीलाई रिपोर्ट गर्नुहोस्",
  ...
  "error.chain.checkConfig": "आफ्नो कन्फिगरेसन (awmate.json) प्रदायक/मोडेल नामहरू जाँच गर्नुहोस्",
  "error.chain.mcpFailed":
    'MCP सर्भर "{{name}}" असफल भयो। नोट गर्नुहोस्, AWMate ले अझै पनि MCP प्रमाणीकरणलाई समर्थन गर्दैन।',
  ...
  "sidebar.gettingStarted.line1": "AWMate मा नि:शुल्क मोडेलहरू समावेश छन् ताकि तपाईं तुरुन्तै सुरु गर्न सक्नुहुन्छ।",
  ...
  "app.name.desktop": "AWMate डेस्कटप",
  ...
  "settings.desktop.wsl.description": "AWMate सर्भर भित्र WSL Windows मा चलाउनुहोस्।",
  ...
  "settings.general.row.language.description": "AWMate को लागि प्रदर्शन भाषा परिवर्तन गर्नुहोस्",
  ...
  "settings.general.row.appearance.description": "आफ्नो यन्त्रमा AWMate कस्तो देखिन्छ अनुकूलित गर्नुहोस्",
  "settings.general.row.colorScheme.title": "रंग योजना",
  "settings.general.row.colorScheme.description":
    "AWMate ले प्रणाली, उज्यालो वा गाढा विषयवस्तुलाई फलो गर्छ कि गर्दैन भन्ने छनौट गर्नुहोस्",
  "settings.general.row.theme.title": "विषयवस्तु",
  "settings.general.row.theme.description": "कसरी AWMate विषयवस्तुलाई अनुकूलित गर्नुहोस्।",
  ...
  "settings.updates.row.startup.description": "AWMate सुरु हुँदा अद्यावधिकहरूको लागि स्वचालित रूपमा जाँच गर्नुहोस्",
  ...
  "settings.updates.toast.latest.description": "तपाईं AWMate को नवीनतम संस्करण चलाइरहनुभएको छ।",
