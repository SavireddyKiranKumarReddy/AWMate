export const dict = {
  ...
  "dialog.provider.awmate.note": "Modelli selezionati tra cui Claude, GPT, Gemini e altri",
  "dialog.provider.awmate.tagline": "Modelli affidabili e ottimizzati",
  "dialog.provider.awmateGo.tagline": "Abbonamento economico per tutti",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelli gratuiti forniti da AWMate",
  ...
  "provider.connect.apiKey.description":
    "Inserisci la chiave API di {{provider}} per connettere il tuo account e utilizzare i modelli {{provider}} in AWMate.",
  ...
  "provider.connect.awmateZen.line1":
    "AWMate Zen offre l'accesso a una selezione di modelli affidabili e ottimizzati per gli agenti di programmazione.",
  "provider.connect.awmateZen.line2":
    "Con una sola chiave API avrai accesso a modelli come Claude, GPT, Gemini, GLM e altri.",
  "provider.connect.awmateZen.visit.prefix": "Visita ",
  "provider.connect.awmateZen.visit.link": "opencode.ai/zen",
  "provider.connect.awmateZen.visit.suffix": " per ottenere la tua chiave API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "questo collegamento",
  "provider.connect.oauth.code.visit.suffix":
    " per ottenere il codice di autorizzazione, connettere il tuo account e usare i modelli {{provider}} in AWMate.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e inserisci il codice qui sotto per connettere il tuo account e usare i modelli {{provider}} in AWMate.",
  ...
  "dialog.plugins.empty": "Plugin configurati in awmate.json",
  ...
  "dialog.server.description": "Cambia il server AWMate a cui si connette l'app.",
  ...
  "wsl.onboarding.checkingAWMate": "Controllo AWMate...",
  "wsl.onboarding.checkingAWMateIn": "Controllo AWMate in {{distro}}...",
  "wsl.onboarding.updatingAWMate": "Aggiornamento AWMate...",
  "wsl.onboarding.updatingAWMateIn": "Aggiornamento AWMate in {{distro}}...",
  "wsl.onboarding.updateAWMateIn": "Aggiorna AWMate in {{distro}}.",
  "wsl.onboarding.updateAWMate": "Aggiorna AWMate",
  "wsl.onboarding.awmateReadyIn": "AWMate è pronto in {{distro}}.",
  "wsl.onboarding.awmateReady": "AWMate è pronto.",
  "wsl.onboarding.installAWMateIn": "Installa AWMate in {{distro}}.",
  "wsl.onboarding.installAWMate": "Installa AWMate",
  ...
  "wsl.onboarding.distroStatus.awmateMissing": "AWMate non installato",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Sottosistema Windows per Linux) è necessario prima che AWMate possa aggiungere un server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL non disponibile",
  "wsl.onboarding.wslUnavailable.description": "AWMate non ha potuto verificare WSL su questa macchina.",
  "wsl.onboarding.installWsl": "Installa WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Riavvia Windows per completare l'installazione WSL, quindi riapri AWMate.",
  ...
  "help.tabs.introduction": "AWMate Desktop ora è incentrato sulle schede.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nuova versione di AWMate ({{version}}) è ora disponibile per l'installazione.",
  ...
  "error.page.report.prefix": "Segnala questo errore al team AWMate",
  ...
  "error.chain.checkConfig": "Controlla i nomi di provider e modelli nella configurazione (awmate.json)",
  "error.chain.mcpFailed":
    'Il server MCP "{{name}}" non ha funzionato. Nota: AWMate non supporta ancora l\'autenticazione MCP.',
  ...
  "sidebar.gettingStarted.line1": "AWMate include modelli gratuiti così puoi iniziare immediatamente.",
  ...
  "settings.desktop.wsl.description": "Esegui il server AWMate all'interno di WSL su Windows.",
  ...
  "settings.general.row.language.description": "Cambia la lingua di visualizzazione per AWMate",
  ...
  "settings.general.row.appearance.description": "Personalizza l'aspetto di AWMate sul tuo dispositivo",
  "settings.general.row.colorScheme.title": "Combinazione di colori",
  "settings.general.row.colorScheme.description": "Scegli se AWMate segue il tema di sistema, chiaro o scuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalizza il tema di AWMate.",
  ...
  "settings.updates.row.startup.description": "Controlla automaticamente gli aggiornamenti all'avvio di AWMate",
  ...
  "settings.updates.toast.latest.title": "AWMate è aggiornato",
  "settings.updates.toast.latest.description": "Stai utilizzando l'ultima versione di AWMate.",
  ...
  "desktop.menu.documentation": "Documentazione di AWMate",
  ...
  "desktop.menu.ariaLabel": "Menu AWMate",
  ...
  "desktop.recovery.loadFailed": "Impossibile caricare AWMate",
  "desktop.recovery.terminated": "La finestra di AWMate si è chiusa in modo imprevisto",
  "desktop.recovery.unresponsive": "AWMate non risponde",
  ...
  "desktop.wsl.error.installAWMate": "Installazione di AWMate non riuscita",
  "desktop.wsl.error.alreadyAdded": "{{distro}} è già stata aggiunta",
  "desktop.wsl.error.awmateMissing": "awmate non è installato in questa distribuzione",
  "desktop.wsl.error.awmateCannotRun": "awmate è installato, ma non è stato possibile eseguirlo",
  "desktop.wsl.error.awmateNotInstalled": "AWMate non è installato in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "L'aggiornamento di AWMate è terminato, ma {{distro}} segnala ancora la versione {{installed}}; era prevista la versione {{expected}}",
