export const dict = {
  ...
  "desktop.menu.documentation": "AWMate hujjatlari",
  ...
  "desktop.menu.ariaLabel": "AWMate menyusi",
  ...
  "desktop.recovery.loadFailed": "AWMate yuklanmadi",
  "desktop.recovery.terminated": "AWMate oynasi kutilmaganda tugatildi",
  "desktop.recovery.unresponsive": "AWMate javob bermayapti",
  ...
  "desktop.wsl.error.installAWMate": "AWMate oʻrnatilmadi",
  "desktop.wsl.error.alreadyAdded": "{{distro}} allaqachon qo'shilgan",
  "desktop.wsl.error.awmateMissing": "AWMate ushbu tarqatishda o'rnatilmagan",
  "desktop.wsl.error.awmateCannotRun": "awmate o'rnatilgan, lekin ishga tushirilmadi",
  "desktop.wsl.error.awmateNotInstalled": "AWMate {{distro}} da o'rnatilmagan",
  "desktop.wsl.error.updateVersion":
    "AWMate yangilanishi tugallandi, lekin {{distro}} hali ham {{installed}} haqida xabar beradi; kutilgan {{expected}}",
  ...
  "dialog.provider.awmate.note": "Tanlangan modellar, jumladan Claude, GPT, Gemini va boshqalar",
  "dialog.provider.awmate.tagline": "Ishonchli optimallashtirilgan modellar",
  "dialog.provider.awmateGo.tagline": "Hamma uchun arzon obuna",
  ...
  "dialog.model.unpaid.freeModels.title": "AWMate tomonidan taqdim etilgan bepul modellar",
  ...
  "provider.connect.apiKey.description":
    "Hisobingizni ulash va AWMate’da {{provider}} modellaridan foydalanish uchun {{provider}} API kalitini kiriting.",
  ...
  "provider.connect.awmateZen.line1":
    "AWMate Zen sizga kodlash agentlari uchun ishonchli optimallashtirilgan modellar to'plamiga kirish imkonini beradi.",
  ...
  "provider.connect.awmateZen.visit.prefix": "Tashrif buyuring ",
  "provider.connect.awmateZen.visit.link": "opencode.ai/zen",
  "provider.connect.awmateZen.visit.suffix": " API kalitingizni olish uchun.",
  "provider.connect.oauth.code.visit.prefix": "Tashrif buyuring ",
  "provider.connect.oauth.code.visit.link": "bu havola",
  "provider.connect.oauth.code.visit.suffix":
    " hisobingizni ulash va AWMate da {{provider}} modellaridan foydalanish uchun avtorizatsiya kodingizni yig'ish.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " va hisobingizni ulash uchun quyidagi kodni kiriting va AWMate da {{provider}} modellaridan foydalaning.",
  ...
  "dialog.plugins.empty": "awmate.json da sozlangan plaginlar",
  ...
  "dialog.server.description": "Ushbu ilova qaysi AWMate serveriga ulanishini almashtiring.",
  ...
  "wsl.onboarding.checkingAWMate": "AWMate tekshirilmoqda...",
  "wsl.onboarding.checkingAWMateIn": "AWMate {{distro}} da tekshirilmoqda...",
  "wsl.onboarding.updatingAWMate": "AWMate yangilanmoqda...",
  "wsl.onboarding.updatingAWMateIn": "AWMate {{distro}} da yangilanmoqda...",
  "wsl.onboarding.updateAWMateIn": "AWMate-ni {{distro}}-da yangilang.",
  "wsl.onboarding.updateAWMate": "AWMate-ni yangilang",
  "wsl.onboarding.awmateReadyIn": "AWMate {{distro}} da tayyor.",
  "wsl.onboarding.awmateReady": "AWMate tayyor.",
  "wsl.onboarding.installAWMateIn": "AWMate-ni {{distro}}-ga o'rnating.",
  "wsl.onboarding.installAWMate": "AWMate-ni o'rnating",
  ...
  "wsl.onboarding.distroStatus.awmateMissing": "AWMate o'rnatilmagan",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "AWMate WSL serverini qoʻshishdan oldin WSL (Linux uchun Windows quyi tizimi) talab qilinadi.",
  "wsl.onboarding.wslUnavailable.title": "WSL mavjud emas",
  "wsl.onboarding.wslUnavailable.description": "AWMate WSL ni ushbu mashinada tasdiqlay olmadi.",
  "wsl.onboarding.installWsl": "WSL-ni o'rnating",
  "wsl.onboarding.windowsRestartRequired":
    "WSL-ni o'rnatishni tugatish uchun Windows-ni qayta ishga tushiring, so'ngra AWMate-ni qayta oching.",
  ...
  "help.tabs.introduction": "AWMate Desktop endi yorliqlar atrofida qurilgan.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "AWMate ({{version}}) yangi versiyasi endi oʻrnatish mumkin.",
  ...
  "error.page.report.prefix": "Iltimos, ushbu xato haqida AWMate jamoasiga xabar bering",
  ...
  "error.chain.checkConfig": "Konfiguratsiya (awmate.json) provayder/model nomlarini tekshiring",
  "error.chain.mcpFailed":
    "MCP \"{{name}}\" serveri muvaffaqiyatsiz tugadi. E'tibor bering, AWMate hali MCP autentifikatsiyasini qo'llab-quvvatlamaydi.",
  ...
  "sidebar.gettingStarted.line1":
    "AWMate bepul modellarni o'z ichiga oladi, shuning uchun siz darhol boshlashingiz mumkin.",
  ...
  "settings.desktop.wsl.description": "Windows da WSL ichidagi AWMate serverini ishga tushiring.",
  ...
  "settings.general.row.language.description": "AWMate uchun ekran tilini o'zgartiring",
  ...
  "settings.general.row.appearance.description": "AWMate qurilmangizda qanday koʻrinishini sozlang",
  "settings.general.row.colorScheme.title": "Rang sxemasi",
  "settings.general.row.colorScheme.description":
    "AWMate tizimga, yorugʻlik yoki qorongʻi mavzuga amal qilishini tanlang",
  "settings.general.row.theme.title": "Mavzu",
  "settings.general.row.theme.description": "AWMate mavzusini sozlash.",
  ...
  "settings.updates.row.startup.description": "AWMate ishga tushganda avtomatik ravishda yangilanishlarni tekshiring",
  ...
  "settings.updates.toast.latest.description": "Siz AWMate oxirgi versiyasini ishga tushiryapsiz.",
