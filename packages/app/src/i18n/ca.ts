export const dict = {
  ...
  "desktop.menu.documentation": "AWMate Documentació",
  ...
  "desktop.menu.ariaLabel": "menú AWMate.",
  ...
  "desktop.recovery.loadFailed": "AWMate no s'ha pogut carregar",
  "desktop.recovery.terminated": "La finestra AWMate s'ha acabat inesperadament",
  "desktop.recovery.unresponsive": "AWMate no respon",
  ...
  "desktop.wsl.error.installAWMate": "La instal·lació de AWMate ha fallat",
  "desktop.wsl.error.alreadyAdded": "{{distro}} ja està afegit",
  "desktop.wsl.error.awmateMissing": "awmate no està instal·lat en aquesta distribució",
  "desktop.wsl.error.awmateCannotRun": "awmate està instal·lat però no s'ha pogut executar",
  "desktop.wsl.error.awmateNotInstalled": "AWMate no està instal·lat a {{distro}}",
  "desktop.wsl.error.updateVersion":
    "AWMate actualització acabada però {{distro}} encara informa {{installed}}; esperat {{expected}}",
  ...
  "dialog.provider.awmate.note": "Models seleccionats que inclouen Claude, GPT, Gemini i més",
  "dialog.provider.awmate.tagline": "Models optimitzats fiables",
  "dialog.provider.awmateGo.tagline": "Subscripció de baix cost per a tothom",
  ...
  "dialog.model.unpaid.freeModels.title": "Models gratuïts proporcionats per AWMate",
  ...
  "provider.connect.apiKey.description":
    "Introduïu la clau API de {{provider}} per connectar el compte i utilitzar els models de {{provider}} a AWMate.",
  ...
  "provider.connect.awmateZen.line1":
    "AWMate Zen us ofereix accés a un conjunt seleccionat de models optimitzats fiables per a agents de codificació.",
  ...
  "provider.connect.awmateZen.visit.suffix": " per recollir la teva clau API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "aquest enllaç",
  "provider.connect.oauth.code.visit.suffix":
    " per recollir el vostre codi d'autorització per connectar el vostre compte i utilitzar {{provider}} models a AWMate.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i introduïu el codi següent per connectar el vostre compte i utilitzar {{provider}} models a AWMate.",
  ...
  "dialog.plugins.empty": "Connectors configurats a awmate.json",
  ...
  "dialog.server.description": "Canvia a quin AWMate servidor es connecta aquesta aplicació.",
  ...
  "wsl.onboarding.checkingAWMate": "S'està comprovant AWMate...",
  "wsl.onboarding.checkingAWMateIn": "S'està registrant AWMate a {{distro}}...",
  "wsl.onboarding.updatingAWMate": "S'està actualitzant AWMate...",
  "wsl.onboarding.updatingAWMateIn": "S'està actualitzant AWMate a {{distro}}...",
  "wsl.onboarding.updateAWMateIn": "Actualitza AWMate a {{distro}}.",
  "wsl.onboarding.updateAWMate": "Actualització AWMate",
  "wsl.onboarding.awmateReadyIn": "AWMate està llest a {{distro}}.",
  "wsl.onboarding.awmateReady": "AWMate està llest.",
  "wsl.onboarding.installAWMateIn": "Instal·leu AWMate a {{distro}}.",
  "wsl.onboarding.installAWMate": "Instal·la AWMate",
  ...
  "wsl.onboarding.distroStatus.awmateMissing": "AWMate no instal·lat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsistema per a Linux) és necessari abans que AWMate pugui afegir un WSL servidor",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "AWMate no ha pogut verificar WSL en aquesta màquina.",
  "wsl.onboarding.installWsl": "Instal·la WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicieu Windows per acabar d'instal·lar WSL i, a continuació, torneu a obrir AWMate.",
  ...
  "help.tabs.introduction": "AWMate L'escriptori ara està construït al voltant de pestanyes.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nova versió de AWMate ({{version}}) ja està disponible per instal·lar-la.",
  ...
  "error.page.report.prefix": "Informeu aquest error a l'equip AWMate.",
  ...
  "error.chain.checkConfig": "Comproveu els noms del vostre proveïdor/model de configuració (awmate.json).",
  "error.chain.mcpFailed":
    'El servidor MCP "{{name}}" ha fallat. Tingueu en compte que AWMate encara no admet l\'autenticació MCP.',
  ...
  "sidebar.gettingStarted.line1": "AWMate inclou models gratuïts perquè pugueu començar immediatament.",
  ...
  "app.name.desktop": "AWMate Escriptori",
  ...
  "settings.desktop.wsl.description": "Executeu el servidor AWMate dins de WSL a Windows.",
  ...
  "settings.general.row.language.description": "Canvia l'idioma de visualització per a AWMate",
  ...
  "settings.general.row.appearance.description": "Personalitza com es veu AWMate al teu dispositiu",
  "settings.general.row.colorScheme.title": "Esquema de colors",
  "settings.general.row.colorScheme.description": "Trieu si AWMate segueix el tema del sistema, clar o fosc",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalitza la temàtica de AWMate.",
  ...
  "settings.updates.row.startup.description":
    "Comprova automàticament si hi ha actualitzacions quan s'iniciï AWMate.",
  ...
  "settings.updates.toast.latest.description": "Esteu executant la darrera versió de AWMate.",
