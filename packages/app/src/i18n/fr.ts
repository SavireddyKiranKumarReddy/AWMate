export const dict = {
  ...
  "desktop.menu.documentation": "Documentation d'AWMate",
  ...
  "desktop.recovery.loadFailed": "Échec du chargement d'AWMate",
  "desktop.recovery.terminated": "La fenêtre AWMate s'est arrêtée de manière inattendue",
  "desktop.recovery.unresponsive": "AWMate ne répond pas",
  ...
  "desktop.wsl.error.installAWMate": "Échec de l'installation d'AWMate",
  "desktop.wsl.error.alreadyAdded": "{{distro}} a déjà été ajoutée",
  "desktop.wsl.error.awmateMissing": "awmate n'est pas installé dans cette distribution",
  "desktop.wsl.error.awmateCannotRun": "awmate est installé, mais n'a pas pu s'exécuter",
  "desktop.wsl.error.awmateNotInstalled": "AWMate n'est pas installé dans {{distro}}",
  "desktop.wsl.error.updateVersion":
    "La mise à jour d'AWMate est terminée, mais {{distro}} indique toujours {{installed}} au lieu de {{expected}}",
  ...
  "dialog.provider.awmateGo.tagline": "Abonnement abordable pour tous",
  ...
  "provider.connect.awmateZen.visit.prefix": "Visitez ",
  "provider.connect.awmateZen.visit.link": "opencode.ai/zen",
  "provider.connect.awmateZen.visit.suffix": " pour récupérer votre clé API.",
  ...
  "dialog.plugins.empty": "Extensions configurées dans awmate.json",
  ...
  "wsl.onboarding.checkingAWMate": "Vérification d'AWMate...",
  "wsl.onboarding.checkingAWMateIn": "Vérification d'AWMate dans {{distro}}...",
  "wsl.onboarding.updatingAWMate": "Mise à jour d'AWMate...",
  "wsl.onboarding.updatingAWMateIn": "Mise à jour d'AWMate dans {{distro}}...",
  "wsl.onboarding.updateAWMateIn": "Mettez à jour AWMate dans {{distro}}.",
  "wsl.onboarding.updateAWMate": "Mettre à jour AWMate",
  "wsl.onboarding.awmateReadyIn": "AWMate est prêt dans {{distro}}.",
  "wsl.onboarding.awmateReady": "AWMate est prêt.",
  ...
  "wsl.onboarding.distroStatus.awmateMissing": "AWMate non installé",
  ...
  "help.tabs.introduction": "AWMate Desktop s'articule désormais autour d'onglets.",
  "help.tabs.sessions":
  ...
  "error.chain.checkConfig": "Vérifiez les noms de fournisseur et de modèle dans votre configuration (awmate.json)",
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'AWMate ne prend pas encore en charge l'authentification MCP.",
