export const dict: Record<string, string> = {
  ...
  "desktop.menu.documentation": "AWMate ডকুমেন্টেশন",
  ...
  "desktop.menu.ariaLabel": "AWMate মেনু",
  ...
  "desktop.recovery.loadFailed": "AWMate লোড হতে ব্যর্থ হয়েছে৷",
  "desktop.recovery.terminated": "AWMate উইন্ডো অপ্রত্যাশিতভাবে বন্ধ হয়ে গেছে",
  "desktop.recovery.unresponsive": "AWMate সাড়া দিচ্ছে না",
  ...
  "desktop.wsl.error.installAWMate": "AWMate ইনস্টলেশন ব্যর্থ হয়েছে৷",
  "desktop.wsl.error.alreadyAdded": "{{distro}} ইতিমধ্যেই যোগ করা হয়েছে৷",
  "desktop.wsl.error.awmateMissing": "এই ডিস্ট্রোতে awmate ইনস্টল করা নেই",
  "desktop.wsl.error.awmateCannotRun": "awmate ইনস্টল করা আছে কিন্তু চালানো যায়নি",
  "desktop.wsl.error.awmateNotInstalled": "AWMate {{distro}} এ ইনস্টল করা নেই",
  "desktop.wsl.error.updateVersion":
    "AWMate আপডেট শেষ হয়েছে কিন্তু {{distro}} এখনও রিপোর্ট করে {{installed}}; প্রত্যাশিত {{expected}}",
  ...
  "dialog.provider.awmate.note": "Claude, GPT, Gemini এবং আরও অনেক কিছু সহ কিউরেট করা মডেল",
  "dialog.provider.awmate.tagline": "নির্ভরযোগ্য অপ্টিমাইজ করা মডেল",
  "dialog.provider.awmateGo.tagline": "সবার জন্য কম খরচে সাবস্ক্রিপশন",
  ...
  "dialog.model.unpaid.freeModels.title": "বিনামূল্যের মডেলগুলি AWMate দ্বারা প্রদত্ত",
  ...
  "provider.connect.apiKey.description":
    "আপনার অ্যাকাউন্ট সংযোগ করতে আপনার {{provider}} API কী লিখুন এবং AWMate-এ {{provider}} মডেলগুলি ব্যবহার করুন৷",
  ...
  "provider.connect.awmateZen.line1":
    "AWMate Zen আপনাকে কোডিং এজেন্টের জন্য নির্ভরযোগ্য অপ্টিমাইজ করা মডেলের একটি কিউরেটেড সেটে অ্যাক্সেস দেয়।",
  ...
  "provider.connect.awmateZen.visit.prefix": "ভিজিট করুন",
  "provider.connect.awmateZen.visit.link": "opencode.ai/zen",
  "provider.connect.awmateZen.visit.suffix": "আপনার API কী সংগ্রহ করতে।",
  "provider.connect.oauth.code.visit.prefix": "ভিজিট করুন",
  "provider.connect.oauth.code.visit.link": "এই লিঙ্ক",
  "provider.connect.oauth.code.visit.suffix":
    "আপনার অ্যাকাউন্ট সংযোগ করতে আপনার অনুমোদন কোড সংগ্রহ করতে এবং {{provider}} মডেলগুলি AWMate-এ ব্যবহার করতে।",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "এবং আপনার অ্যাকাউন্ট সংযোগ করতে নীচের কোডটি লিখুন এবং {{provider}} মডেলগুলি AWMate-এ ব্যবহার করুন৷",
  ...
  "dialog.plugins.empty": "awmate.json এ কনফিগার করা প্লাগইন",
  ...
  "dialog.server.description": "এই অ্যাপটি কোন AWMate সার্ভারের সাথে সংযোগ করে তা পরিবর্তন করুন।",
  ...
  "wsl.onboarding.checkingAWMate": "AWMate পরীক্ষা করা হচ্ছে...",
  "wsl.onboarding.checkingAWMateIn": "{{distro}} এ AWMate চেক করা হচ্ছে...",
  "wsl.onboarding.updatingAWMate": "আপডেট করা হচ্ছে AWMate...",
  "wsl.onboarding.updatingAWMateIn": "{{distro}}-এ AWMate আপডেট করা হচ্ছে...",
  "wsl.onboarding.updateAWMateIn": "{{distro}}-এ AWMate আপডেট করুন।",
  "wsl.onboarding.updateAWMate": "AWMate আপডেট করুন",
  "wsl.onboarding.awmateReadyIn": "AWMate {{distro}}-এ প্রস্তুত।",
  "wsl.onboarding.awmateReady": "AWMate প্রস্তুত।",
  "wsl.onboarding.installAWMateIn": "{{distro}}-এ AWMate ইনস্টল করুন।",
  "wsl.onboarding.installAWMate": "AWMate ইনস্টল করুন",
  ...
  "wsl.onboarding.distroStatus.awmateMissing": "AWMate ইনস্টল করা নেই",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Linux এর জন্য Windows সাবসিস্টেম) AWMate একটি WSL সার্ভার যোগ করার আগে প্রয়োজন",
  "wsl.onboarding.wslUnavailable.title": "WSL অনুপলব্ধ",
  "wsl.onboarding.wslUnavailable.description": "AWMate এই মেশিনে WSL যাচাই করতে পারেনি।",
  "wsl.onboarding.installWsl": "WSL ইনস্টল করুন",
  "wsl.onboarding.windowsRestartRequired":
    "WSL ইনস্টল করা শেষ করতে Windows পুনরায় চালু করুন, তারপর AWMate আবার খুলুন।",
  ...
  "help.tabs.introduction": "AWMate ডেস্কটপ এখন ট্যাবের চারপাশে তৈরি।",
  "help.tabs.sessions":
  ...
  "toast.update.description": "AWMate ({{version}}) এর একটি নতুন সংস্করণ এখন ইনস্টল করার জন্য উপলব্ধ৷",
  ...
  "error.page.report.prefix": "অনুগ্রহ করে এই ত্রুটিটি AWMate টিমের কাছে রিপোর্ট করুন",
  ...
  "error.chain.checkConfig": "আপনার কনফিগারেশন (awmate.json) প্রদানকারী/মডেলের নাম পরীক্ষা করুন",
  "error.chain.mcpFailed":
    'MCP সার্ভার "{{name}}" ব্যর্থ হয়েছে৷ মনে রাখবেন, AWMate এখনও MCP প্রমাণীকরণ সমর্থন করে না।',
  ...
  "sidebar.gettingStarted.line1": "AWMate বিনামূল্যে মডেল অন্তর্ভুক্ত করে যাতে আপনি অবিলম্বে শুরু করতে পারেন।",
  ...
  "app.name.desktop": "AWMate ডেস্কটপ",
  ...
  "settings.desktop.wsl.description": "Windows-এ WSL-এর ভিতরে AWMate সার্ভার চালান।",
  ...
  "settings.general.row.language.description": "AWMate-এর জন্য প্রদর্শনের ভাষা পরিবর্তন করুন",
  ...
  "settings.general.row.appearance.description": "আপনার ডিভাইসে AWMate কেমন দেখায় তা কাস্টমাইজ করুন",
  "settings.general.row.colorScheme.title": "রঙের স্কিম",
  "settings.general.row.colorScheme.description": "AWMate সিস্টেম, হালকা বা অন্ধকার থিম অনুসরণ করে কিনা তা বেছে নিন",
  "settings.general.row.theme.title": "থিম",
  "settings.general.row.theme.description": "কিভাবে AWMate থিম করা হয় তা কাস্টমাইজ করুন।",
  ...
  "settings.updates.row.startup.description": "AWMate চালু হলে স্বয়ংক্রিয়ভাবে আপডেটের জন্য চেক করুন",
  ...
  "settings.updates.toast.latest.description": "আপনি AWMate এর সর্বশেষ সংস্করণ চালাচ্ছেন।",
