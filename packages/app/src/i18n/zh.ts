...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "AWMate 加载失败",
  "desktop.recovery.terminated": "AWMate 窗口意外终止",
  "desktop.recovery.unresponsive": "AWMate 未响应",
  ...
  "desktop.wsl.error.installAWMate": "AWMate 安装失败",
  "desktop.wsl.error.alreadyAdded": "已添加 {{distro}}",
  "desktop.wsl.error.awmateMissing": "此发行版中未安装 awmate",
  "desktop.wsl.error.awmateCannotRun": "已安装 awmate，但无法运行",
  "desktop.wsl.error.awmateNotInstalled": "{{distro}} 中未安装 AWMate",
  "desktop.wsl.error.updateVersion":
    "AWMate 更新已完成，但 {{distro}} 仍报告版本 {{installed}}；预期版本为 {{expected}}",
  ...
  "dialog.provider.awmate.note": "精选模型，包括 Claude、GPT、Gemini 等",
  "dialog.provider.awmate.tagline": "可靠的优化模型",
  "dialog.provider.awmateGo.tagline": "适合所有人的低成本订阅",
  ...
  "provider.connect.apiKey.description":
    "输入你的 {{provider}} API 密钥以连接账户，并在 AWMate 中使用 {{provider}} 模型。",
  ...
  "provider.connect.awmateZen.line1": "AWMate Zen 为你提供一组精选的可靠优化模型，用于代码智能体。",
  "provider.connect.awmateZen.line2": "只需一个 API 密钥，你就能使用 Claude、GPT、Gemini、GLM 等模型。",
  "provider.connect.awmateZen.visit.prefix": "访问 ",
  "provider.connect.awmateZen.visit.link": "opencode.ai/zen",
  "provider.connect.awmateZen.visit.suffix": " 获取你的 API 密钥。",
  "provider.connect.oauth.code.visit.prefix": "访问 ",
  "provider.connect.oauth.code.visit.link": "此链接",
  "provider.connect.oauth.code.visit.suffix": " 获取授权码，以连接你的账户并在 AWMate 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix": " 并输入以下代码，以连接你的账户并在 AWMate 中使用 {{provider}} 模型。",
  ...
  "wsl.onboarding.checkingAWMate": "正在检查 AWMate...",
  "wsl.onboarding.checkingAWMateIn": "正在检查 {{distro}} 中的 AWMate...",
  "wsl.onboarding.updatingAWMate": "正在更新 AWMate...",
  "wsl.onboarding.updatingAWMateIn": "正在更新 {{distro}} 中的 AWMate...",
  "wsl.onboarding.updateAWMateIn": "更新 {{distro}} 中的 AWMate。",
  "wsl.onboarding.updateAWMate": "更新 AWMate",
  "wsl.onboarding.awmateReadyIn": "{{distro}} 中的 AWMate 已就绪。",
  "wsl.onboarding.awmateReady": "AWMate 已就绪。",
  ...
  "wsl.onboarding.distroStatus.awmateMissing": "未安装 AWMate",
  ...
  "help.tabs.introduction": "AWMate Desktop 现已采用以标签页为核心的设计。",
  "help.tabs.sessions":
