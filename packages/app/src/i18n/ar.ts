export const dict = {
  ...
  "desktop.recovery.loadFailed": "فشل تحميل AWMate",
  "desktop.recovery.terminated": "توقفت نافذة AWMate بشكل غير متوقع",
  "desktop.recovery.unresponsive": "AWMate لا يستجيب",
  ...
  "desktop.wsl.error.installAWMate": "فشل تثبيت AWMate",
  "desktop.wsl.error.alreadyAdded": "تمت إضافة {{distro}} بالفعل",
  "desktop.wsl.error.awmateMissing": "awmate غير مثبت في هذه التوزيعة",
  "desktop.wsl.error.awmateCannotRun": "awmate مثبت، لكن تعذر تشغيله",
  "desktop.wsl.error.awmateNotInstalled": "AWMate غير مثبت في {{distro}}",
  "desktop.wsl.error.updateVersion":
    "اكتمل تحديث AWMate، لكن {{distro}} ما زالت تعرض الإصدار {{installed}}؛ الإصدار المتوقع هو {{expected}}",
  ...
  "dialog.provider.awmateGo.tagline": "اشتراك منخفض التكلفة للجميع",
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح API الخاص بـ {{provider}} لتوصيل حسابك واستخدام نماذج {{provider}} في AWMate.",
  ...
  "provider.connect.awmateZen.visit.prefix": "قم بزيارة ",
  "provider.connect.awmateZen.visit.link": "opencode.ai/zen",
  "provider.connect.awmateZen.visit.suffix": " للحصول على مفتاح API الخاص بك.",
  ...
  "wsl.onboarding.checkingAWMate": "جارٍ التحقق من AWMate...",
  "wsl.onboarding.checkingAWMateIn": "جارٍ التحقق من AWMate في {{distro}}...",
  "wsl.onboarding.updatingAWMate": "جارٍ تحديث AWMate...",
  "wsl.onboarding.updatingAWMateIn": "جارٍ تحديث AWMate في {{distro}}...",
  "wsl.onboarding.updateAWMateIn": "حدّث AWMate في {{distro}}.",
  "wsl.onboarding.updateAWMate": "تحديث AWMate",
  "wsl.onboarding.awmateReadyIn": "AWMate جاهز في {{distro}}.",
  "wsl.onboarding.awmateReady": "AWMate جاهز.",
  ...
  "wsl.onboarding.distroStatus.awmateMissing": "AWMate غير مثبت",
  ...
  "help.tabs.introduction": "أصبح AWMate Desktop الآن قائمًا على علامات التبويب.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "يتوفر الآن إصدار جديد من AWMate ({{version}}) للتثبيت.",
