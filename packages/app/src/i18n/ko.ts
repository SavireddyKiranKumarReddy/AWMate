export const dict = {
  ...
  "dialog.provider.awmateGo.tagline": "모두를 위한 저렴한 구독",
  ...
  "provider.connect.awmateZen.line2": "단일 API 키로 Claude, GPT, Gemini, GLM 등 다양한 모델에 액세스할 수 있습니다.",
  "provider.connect.awmateZen.visit.prefix": "다음 ",
  "provider.connect.awmateZen.visit.link": "opencode.ai/zen",
  "provider.connect.awmateZen.visit.suffix": "을 방문하여 API 키를 받으세요.",
  ...
  "wsl.onboarding.checkingAWMate": "AWMate 확인 중...",
  "wsl.onboarding.checkingAWMateIn": "{{distro}}에서 AWMate 확인 중...",
  "wsl.onboarding.updatingAWMate": "AWMate 업데이트 중...",
  "wsl.onboarding.updatingAWMateIn": "{{distro}}에서 AWMate 업데이트 중...",
  "wsl.onboarding.updateAWMateIn": "{{distro}}에서 AWMate를 업데이트하세요.",
  "wsl.onboarding.updateAWMate": "AWMate 업데이트",
  "wsl.onboarding.awmateReadyIn": "{{distro}}에서 AWMate를 사용할 준비가 되었습니다.",
  "wsl.onboarding.awmateReady": "AWMate가 준비되었습니다.",
  ...
  "wsl.onboarding.distroStatus.awmateMissing": "AWMate가 설치되지 않음",
  ...
  "help.tabs.introduction": "이제 AWMate Desktop은 탭을 중심으로 구성됩니다.",
  "help.tabs.sessions":
  ...
  "desktop.recovery.loadFailed": "AWMate를 불러오지 못했습니다",
  "desktop.recovery.terminated": "AWMate 윈도우가 예기치 않게 종료되었습니다",
  "desktop.recovery.unresponsive": "AWMate가 응답하지 않습니다",
  ...
  "desktop.wsl.error.installAWMate": "AWMate 설치 실패",
  "desktop.wsl.error.alreadyAdded": "{{distro}} 배포판은 이미 추가되었습니다",
  "desktop.wsl.error.awmateMissing": "이 배포판에 awmate가 설치되어 있지 않습니다",
  "desktop.wsl.error.awmateCannotRun": "awmate가 설치되어 있지만 실행할 수 없습니다",
  "desktop.wsl.error.awmateNotInstalled": "{{distro}}에 AWMate가 설치되어 있지 않습니다",
  "desktop.wsl.error.updateVersion":
    "AWMate 업데이트가 완료되었지만 {{distro}}에서 여전히 {{installed}} 버전으로 표시됩니다. 예상 버전: {{expected}}",
