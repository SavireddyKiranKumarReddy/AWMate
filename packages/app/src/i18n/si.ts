export const dict: Record<string, string> = {
  ...
  "desktop.menu.documentation": "AWMate ලේඛනගත කිරීම",
  ...
  "desktop.menu.ariaLabel": "AWMate මෙනුව",
  ...
  "desktop.recovery.loadFailed": "AWMate පූරණය කිරීමට අසමත් විය",
  "desktop.recovery.terminated": "AWMate කවුළුව අනපේක්ෂිත ලෙස අවසන් විය",
  "desktop.recovery.unresponsive": "AWMate ප්‍රතිචාර නොදක්වයි",
  ...
  "desktop.wsl.error.installAWMate": "AWMate ස්ථාපනය අසාර්ථක විය",
  "desktop.wsl.error.alreadyAdded": "{{distro}} දැනටමත් එක් කර ඇත",
  "desktop.wsl.error.awmateMissing": "මෙම distro හි awmate ස්ථාපනය කර නොමැත",
  "desktop.wsl.error.awmateCannotRun": "awmate ස්ථාපනය කර ඇති නමුත් ධාවනය කල නොහැක",
  "desktop.wsl.error.awmateNotInstalled": "AWMate {{distro}} හි ස්ථාපනය කර නැත",
  "desktop.wsl.error.updateVersion":
    "AWMate යාවත්කාලීන කිරීම අවසන් නමුත් {{distro}} තවමත් වාර්තා කරන්නේ {{installed}}; අපේක්ෂිත {{expected}}",
  ...
  "dialog.provider.awmate.note": "Claude, GPT, Gemini සහ තවත් දේ ඇතුළුව සංවෘත ආකෘති",
  "dialog.provider.awmate.tagline": "විශ්වසනීය ප්රශස්ත මාදිලි",
  "dialog.provider.awmateGo.tagline": "සෑම කෙනෙකුටම අඩු වියදම් දායකත්වයක්",
  ...
  "dialog.model.unpaid.freeModels.title": "AWMate මඟින් සපයනු ලබන නිදහස් මාදිලි",
  ...
  "provider.connect.apiKey.description":
    "ඔබගේ ගිණුම සම්බන්ධ කිරීමට ඔබගේ {{provider}} API යතුර ඇතුලත් කරන්න සහ AWMate හි {{provider}} මාදිලි භාවිතා කරන්න.",
  ...
  "provider.connect.awmateZen.line1":
    "AWMate Zen ඔබට කේතීකරණ නියෝජිතයන් සඳහා විශ්වාසදායක ප්‍රශස්ත මාදිලි සමූහයකට ප්‍රවේශය ලබා දෙයි.",
  "provider.connect.awmateZen.line2":
    "තනි API යතුරක් සමඟින් ඔබට Claude, GPT, Gemini, GLM සහ තවත් ආකෘති වෙත ප්‍රවේශය ලැබෙනු ඇත.",
  "provider.connect.awmateZen.visit.prefix": "පිවිසෙන්න",
  "provider.connect.awmateZen.visit.link": "opencode.ai/zen",
  "provider.connect.awmateZen.visit.suffix": "ඔබගේ API යතුර එකතු කිරීමට.",
  "provider.connect.oauth.code.visit.prefix": "පිවිසෙන්න",
  "provider.connect.oauth.code.visit.link": "මෙම සබැඳිය",
  "provider.connect.oauth.code.visit.suffix":
    "ඔබගේ ගිණුම සම්බන්ධ කිරීමට සහ AWMate හි {{provider}} මාදිලි භාවිතා කිරීමට ඔබගේ අවසර කේතය එකතු කිරීමට.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "සහ ඔබගේ ගිණුම සම්බන්ධ කිරීමට පහත කේතය ඇතුළු කර {{provider}} මාදිලි AWMate තුළ භාවිතා කරන්න.",
  ...
  "dialog.plugins.empty": "ප්ලගීන awmate.json හි වින්‍යාස කර ඇත",
  ...
  "dialog.server.description": "මෙම යෙදුම සම්බන්ධ වන්නේ කුමන AWMate සේවාදායකයටද යන්න මාරු කරන්න.",
  ...
  "wsl.onboarding.checkingAWMate": "AWMate පරීක්ෂා කරමින්...",
  "wsl.onboarding.checkingAWMateIn": "{{distro}} හි AWMate පරීක්ෂා කරමින්...",
  "wsl.onboarding.updatingAWMate": "AWMate යාවත්කාලීන කරමින්...",
  "wsl.onboarding.updatingAWMateIn": "{{distro}} හි AWMate යාවත්කාලීන කරමින්...",
  "wsl.onboarding.updateAWMateIn": "{{distro}} හි AWMate යාවත්කාලීන කරන්න.",
  "wsl.onboarding.updateAWMate": "AWMate යාවත්කාලීන කරන්න",
  "wsl.onboarding.awmateReadyIn": "AWMate {{distro}} හි සූදානම්ය.",
  "wsl.onboarding.awmateReady": "AWMate සූදානම්.",
  "wsl.onboarding.installAWMateIn": "{{distro}} හි AWMate ස්ථාපනය කරන්න.",
  "wsl.onboarding.installAWMate": "AWMate ස්ථාපනය කරන්න",
  ...
  "wsl.onboarding.distroStatus.awmateMissing": "AWMate ස්ථාපනය කර නැත",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Linux සඳහා උප පද්ධතිය) AWMate WSL සේවාදායකයක් එක් කිරීමට පෙර අවශ්‍ය වේ",
  "wsl.onboarding.wslUnavailable.title": "WSL නොමැත",
  "wsl.onboarding.wslUnavailable.description": "AWMate හට මෙම යන්ත්‍රයේ WSL සත්‍යාපනය කළ නොහැක.",
  "wsl.onboarding.installWsl": "WSL ස්ථාපනය කරන්න",
  "wsl.onboarding.windowsRestartRequired":
    "WSL ස්ථාපනය අවසන් කිරීමට Windows නැවත අරඹන්න, පසුව AWMate නැවත විවෘත කරන්න.",
  ...
  "help.tabs.introduction": "AWMate ඩෙස්ක්ටොප් එක දැන් ටැබ් වටා ගොඩනගා ඇත.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "AWMate හි නව අනුවාදයක් ({{version}}) ස්ථාපනය කිරීමට දැන් තිබේ.",
  ...
  "error.page.report.prefix": "කරුණාකර මෙම දෝෂය AWMate කණ්ඩායමට වාර්තා කරන්න",
  ...
  "error.chain.checkConfig": "ඔබගේ වින්‍යාසය (awmate.json) සපයන්නා/ආදර්ශ නම් පරීක්ෂා කරන්න",
  "error.chain.mcpFailed": 'MCP සේවාදායකය "{{name}}" අසාර්ථක විය. සටහන, AWMate තවමත් MCP සත්‍යාපනයට සහය නොදක්වයි.',
  ...
  "sidebar.gettingStarted.line1": "AWMate නොමිලේ ආකෘති ඇතුළත් වන නිසා ඔබට වහාම ආරම්භ කළ හැක.",
  ...
  "app.name.desktop": "AWMate ඩෙස්ක්ටොප්",
  ...
  "settings.desktop.wsl.description": "Windows හි WSL තුළ AWMate සේවාදායකය ධාවනය කරන්න.",
  ...
  "settings.general.row.language.description": "AWMate සඳහා සංදර්ශක භාෂාව වෙනස් කරන්න",
  ...
  "settings.general.row.appearance.description": "ඔබගේ උපාංගයේ AWMate පෙනෙන ආකාරය අභිරුචිකරණය කරන්න",
  "settings.general.row.colorScheme.title": "වර්ණ පටිපාටිය",
  "settings.general.row.colorScheme.description": "AWMate පද්ධතිය, ආලෝකය හෝ අඳුරු තේමාව අනුගමනය කරන්නේද යන්න තෝරන්න",
  "settings.general.row.theme.title": "තේමාව",
  "settings.general.row.theme.description": "AWMate තේමා කර ඇති ආකාරය අභිරුචිකරණය කරන්න.",
  ...
  "settings.updates.row.startup.description": "AWMate දියත් කරන විට යාවත්කාලීන සඳහා ස්වයංක්‍රීයව පරීක්ෂා කරන්න",
  ...
  "settings.updates.toast.latest.description": "ඔබ AWMate හි නවතම අනුවාදය ධාවනය කරයි.",
