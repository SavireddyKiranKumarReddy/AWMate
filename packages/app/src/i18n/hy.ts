export const dict = {
  ...
  "desktop.menu.documentation": "AWMate Փաստաթղթեր",
  ...
  "desktop.menu.ariaLabel": "AWMate մենյու",
  ...
  "desktop.recovery.loadFailed": "AWMate չհաջողվեց բեռնել",
  "desktop.recovery.terminated": "AWMate պատուհանն անսպասելիորեն ավարտվեց",
  "desktop.recovery.unresponsive": "AWMate-ը չի արձագանքում",
  ...
  "desktop.wsl.error.installAWMate": "AWMate տեղադրումը ձախողվեց",
  "desktop.wsl.error.alreadyAdded": "{{distro}} արդեն ավելացված է",
  "desktop.wsl.error.awmateMissing": "awmate-ը տեղադրված չէ այս բաշխում",
  "desktop.wsl.error.awmateCannotRun": "awmate-ը տեղադրված է, բայց չի կարող գործարկվել",
  "desktop.wsl.error.awmateNotInstalled": "AWMate տեղադրված չէ {{distro}}",
  "desktop.wsl.error.updateVersion":
    "AWMate թարմացումն ավարտված է, բայց {{distro}}-ը դեռ հայտնում է {{installed}}; սպասվում է {{expected}}",
  ...
  "dialog.provider.awmate.note": "Ընտրված մոդելներ, ներառյալ՝ Claude, GPT, Gemini և ավելին",
  "dialog.provider.awmate.tagline": "Վստահելի օպտիմիզացված մոդելներ",
  "dialog.provider.awmateGo.tagline": "Ցածր գնով բաժանորդագրություն բոլորի համար",
  ...
  "dialog.model.unpaid.freeModels.title": "Անվճար մոդելները տրամադրվում են AWMate",
  ...
  "provider.connect.apiKey.description":
    "Մուտքագրեք ձեր {{provider}} API բանալին՝ ձեր հաշիվը միացնելու և AWMate-ում {{provider}} մոդելներ օգտագործելու համար։",
  ...
  "provider.connect.awmateZen.line1":
    "AWMate Zen-ը թույլ է տալիս մուտք գործել կոդավորման գործակալների համար հուսալի օպտիմիզացված մոդելների հավաքածու։",
  ...
  "provider.connect.awmateZen.visit.prefix": "Այցելություն ",
  "provider.connect.awmateZen.visit.link": "opencode.ai/zen",
  "provider.connect.awmateZen.visit.suffix": " ձեր API բանալին հավաքելու համար",
  "provider.connect.oauth.code.visit.prefix": "Այցելություն ",
  "provider.connect.oauth.code.visit.link": "այս հղումը",
  "provider.connect.oauth.code.visit.suffix":
    " հավաքել ձեր թույլտվության կոդը՝ ձեր հաշիվը միացնելու և AWMate-ում {{provider}} մոդելներ օգտագործելու համար:",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " և մուտքագրեք ստորև ծածկագիրը՝ ձեր հաշիվը միացնելու և AWMate-ում {{provider}} մոդելներ օգտագործելու համար:",
  ...
  "dialog.plugins.empty": "Ընդլայնումները կազմաձևված են awmate.json-ում",
  ...
  "dialog.server.description": "Փոխարկեք, թե որ AWMate սերվերին է միանում այս հավելվածը։",
  ...
  "wsl.onboarding.checkingAWMate": "Ստուգում է AWMate...",
  "wsl.onboarding.checkingAWMateIn": "Ստուգում է AWMate-ը {{distro}}...",
  "wsl.onboarding.updatingAWMate": "Թարմացվում է AWMate...",
  "wsl.onboarding.updatingAWMateIn": "Թարմացվում է AWMate-ը {{distro}}...",
  "wsl.onboarding.updateAWMateIn": "Թարմացնել AWMate-ը {{distro}}-ում։",
  "wsl.onboarding.updateAWMate": "Թարմացնել AWMate",
  "wsl.onboarding.awmateReadyIn": "AWMate պատրաստ է {{distro}}-ում։",
  "wsl.onboarding.awmateReady": "AWMate պատրաստ է։",
  "wsl.onboarding.installAWMateIn": "Տեղադրեք AWMate-ը {{distro}}-ում։",
  "wsl.onboarding.installAWMate": "Տեղադրեք AWMate",
  ...
  "wsl.onboarding.distroStatus.awmateMissing": "AWMate տեղադրված չէ",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Ենթահամակարգը Linux-ի համար) անհրաժեշտ է, որպեսզի AWMate-ը կարողանա ավելացնել WSL սերվեր",
  "wsl.onboarding.wslUnavailable.title": "WSL անհասանելի է",
  "wsl.onboarding.wslUnavailable.description": "AWMate-ը չկարողացավ հաստատել WSL-ն այս մեքենայի վրա։",
  "wsl.onboarding.installWsl": "Տեղադրեք WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Վերագործարկեք Windows՝ WSL-ի տեղադրումն ավարտելու համար, այնուհետև նորից բացեք AWMate։",
  ...
  "help.tabs.introduction": "AWMate Desktop-ն այժմ կառուցված է ներդիրների շուրջ։",
  "help.tabs.sessions":
  ...
  "toast.update.description": "AWMate-ի ({{version}}) նոր տարբերակը այժմ հասանելի է տեղադրման համար:",
  ...
  "error.page.report.prefix": "Խնդրում ենք հայտնել այս սխալի մասին AWMate թիմին",
  ...
  "error.chain.checkConfig": "Ստուգեք ձեր կազմաձևը (awmate.json) մատակարարի/մոդելի անունները",
  "error.chain.mcpFailed":
    "MCP «{{name}}» սերվերը ձախողվեց: Նկատի ունեցեք, որ AWMate-ը դեռ չի աջակցում MCP նույնականացումը:",
  ...
  "sidebar.gettingStarted.line1": "AWMate ներառում է անվճար մոդելներ, որպեսզի կարողանաք անմիջապես սկսել:",
  ...
  "settings.desktop.wsl.description": "Գործարկեք AWMate սերվերը WSL-ի ներսում՝ Windows-ում։",
  ...
  "settings.general.row.language.description": "Փոխել ցուցադրման լեզուն AWMate",
  ...
  "settings.general.row.appearance.description": "Անհատականացրեք, թե ինչպես է AWMate տեսքը ձեր սարքում",
  "settings.general.row.colorScheme.title": "Գունային սխեման",
  "settings.general.row.colorScheme.description": "Ընտրեք՝ AWMate-ը հետևում է համակարգին, թեթև թե մուգ թեմային",
  "settings.general.row.theme.title": "Թեմա",
  "settings.general.row.theme.description": "Անհատականացրեք, թե ինչպես է AWMate-ի թեմատիկությունը։",
  ...
  "settings.updates.row.startup.description": "Ավտոմատ կերպով ստուգեք թարմացումների համար, երբ AWMate-ը գործարկվի",
  ...
  "settings.updates.toast.latest.description": "Դուք օգտագործում եք AWMate-ի վերջին տարբերակը։",
