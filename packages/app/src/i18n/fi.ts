export const dict = {
  ...
  "dialog.provider.awmate.note": "Kuratoituja malleja, kuten Claude, GPT, Gemini ja muita",
  "dialog.provider.awmate.tagline": "Luotettavat optimoidut mallit",
  "dialog.provider.awmateGo.tagline": "Edullinen tilaus kaikille",
  ...
  "dialog.model.unpaid.freeModels.title": "AWMaten tarjoamat ilmaiset mallit",
  ...
  "provider.connect.apiKey.description":
    "Anna {{provider}}-API-avaimesi yhdistääksesi tilisi ja käyttääksesi {{provider}}-malleja AWMatessa.",
  ...
  "provider.connect.awmateZen.line1":
    "AWMate Zen antaa sinulle pääsyn kuratoituun joukkoon luotettavia optimoituja malleja koodausagenteille.",
  ...
  "provider.connect.awmateZen.visit.prefix": "Avaa ",
  "provider.connect.awmateZen.visit.link": "opencode.ai/zen",
  "provider.connect.awmateZen.visit.suffix": " ja hae API-avaimesi.",
  "provider.connect.oauth.code.visit.prefix": "Avaa ",
  "provider.connect.oauth.code.visit.link": "tämä linkki",
  "provider.connect.oauth.code.visit.suffix":
    " ja hae valtuutuskoodi, jolla voit yhdistää tilisi ja käyttää {{provider}}-malleja AWMatessa.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " ja anna alla oleva koodi yhdistääksesi tilisi ja käyttääksesi {{provider}}-malleja AWMatessa.",
  ...
  "dialog.plugins.empty": "Laajennukset määritetään awmate.json-tiedostossa",
  ...
  "dialog.server.description": "Vaihda AWMate-palvelimeen, johon tämä sovellus muodostaa yhteyden.",
  ...
  "wsl.onboarding.checkingAWMate": "Tarkistetaan AWMatea...",
  "wsl.onboarding.checkingAWMateIn": "Tarkistetaan AWMatea kohteessa {{distro}}...",
  "wsl.onboarding.updatingAWMate": "Päivitetään AWMatea...",
  "wsl.onboarding.updatingAWMateIn": "Päivitetään AWMatea kohteessa {{distro}}...",
  "wsl.onboarding.updateAWMateIn": "Päivitä AWMate jakelussa {{distro}}.",
  "wsl.onboarding.updateAWMate": "Päivitä AWMate",
  "wsl.onboarding.awmateReadyIn": "AWMate on valmis jakelussa {{distro}}.",
  "wsl.onboarding.awmateReady": "AWMate on valmis.",
  "wsl.onboarding.installAWMateIn": "Asenna AWMate jakeluun {{distro}}.",
  "wsl.onboarding.installAWMate": "Asenna AWMate",
  ...
  "wsl.onboarding.distroStatus.awmateMissing": "AWMatea ei ole asennettu",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) vaaditaan ennen kuin AWMate voi lisätä WSL-palvelimen",
  "wsl.onboarding.wslUnavailable.title": "WSL ei ole käytettävissä",
  "wsl.onboarding.wslUnavailable.description": "AWMate ei voinut vahvistaa WSL:ää tällä koneella.",
  "wsl.onboarding.installWsl": "Asenna WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Viimeistele WSL:n asennus käynnistämällä Windows uudelleen ja avaa sitten AWMate uudelleen.",
  ...
  "toast.update.description": "AWMaten uusi versio ({{version}}) on nyt saatavana asennettavaksi.",
  ...
  "error.page.report.prefix": "Ilmoita tästä virheestä AWMate-tiimille",
  ...
  "error.chain.checkConfig": "Tarkista määritysten (awmate.json) palveluntarjoajien ja mallien nimet",
  "error.chain.mcpFailed": 'MCP-palvelin "{{name}}" epäonnistui. Huomaa, että AWMate ei vielä tue MCP-todennusta.',
  ...
  "sidebar.gettingStarted.line1": "AWMate sisältää ilmaisia malleja, joten voit aloittaa heti.",
  ...
  "settings.desktop.wsl.description": "Suorita AWMate-palvelin WSL:n sisällä Windowsissa.",
  ...
  "settings.general.row.language.description": "Vaihda AWMaten näyttökieli",
  ...
  "settings.general.row.appearance.description": "Mukauta, miltä AWMate näyttää laitteellasi",
  "settings.general.row.colorScheme.title": "Värimalli",
  "settings.general.row.colorScheme.description":
    "Valitse, käyttääkö AWMate järjestelmän mukaista, vaaleaa vai tummaa teemaa",
  "settings.general.row.theme.title": "Teema",
  "settings.general.row.theme.description": "Mukauta AWMaten teemaa.",
  ...
  "settings.updates.row.startup.description": "Tarkista päivitykset automaattisesti, kun AWMate käynnistyy",
  ...
  "settings.updates.toast.latest.description": "Käytät AWMaten uusinta versiota.",
  ...
  "desktop.menu.documentation": "AWMate-dokumentaatio",
  ...
  "desktop.menu.ariaLabel": "AWMate-valikko",
  ...
  "desktop.recovery.loadFailed": "AWMaten lataaminen epäonnistui",
  "desktop.recovery.terminated": "AWMate-ikkuna sulkeutui odottamatta",
  "desktop.recovery.unresponsive": "AWMate ei vastaa",
  ...
  "desktop.wsl.error.installAWMate": "AWMaten asennus epäonnistui",
  "desktop.wsl.error.alreadyAdded": "{{distro}} on jo lisätty",
  "desktop.wsl.error.awmateMissing": "awmatea ei ole asennettu tähän jakeluun",
  "desktop.wsl.error.awmateCannotRun": "awmate on asennettu, mutta sitä ei voitu suorittaa",
  "desktop.wsl.error.awmateNotInstalled": "AWMatea ei ole asennettu jakeluun {{distro}}",
  "desktop.wsl.error.updateVersion":
    "AWMaten päivitys valmistui, mutta {{distro}} ilmoittaa yhä version {{installed}}; odotettu versio on {{expected}}",
  ...
  "help.tabs.introduction": "AWMate Desktop perustuu nyt välilehtiin.",
  "help.tabs.sessions":
