export const dict = {
  ...
  "desktop.menu.documentation": "AWMate Τεκμηρίωση",
  ...
  "desktop.menu.ariaLabel": "AWMate μενού",
  ...
  "desktop.recovery.loadFailed": "AWMate απέτυχε η φόρτωση",
  "desktop.recovery.terminated": "AWMate το παράθυρο τερματίστηκε απροσδόκητα",
  "desktop.recovery.unresponsive": "AWMate δεν αποκρίνεται",
  ...
  "desktop.wsl.error.installAWMate": "AWMate η εγκατάσταση απέτυχε",
  "desktop.wsl.error.alreadyAdded": "{{distro}} έχει ήδη προστεθεί",
  "desktop.wsl.error.awmateMissing": "ο ανοιχτός κώδικας δεν είναι εγκατεστημένος σε αυτήν τη διανομή",
  "desktop.wsl.error.awmateCannotRun": "ο ανοιχτός κώδικας είναι εγκατεστημένος αλλά δεν ήταν δυνατή η εκτέλεση",
  "desktop.wsl.error.awmateNotInstalled": "AWMate δεν είναι εγκατεστημένο στο {{distro}}",
  "desktop.wsl.error.updateVersion":
    "AWMate η ενημέρωση ολοκληρώθηκε αλλά το {{distro}} εξακολουθεί να αναφέρει {{installed}}; αναμενόμενο {{expected}}",
  ...
  "dialog.provider.awmate.note": "Επιμελημένα μοντέλα συμπεριλαμβανομένων των Claude, GPT, Gemini και άλλων",
  "dialog.provider.awmate.tagline": "Αξιόπιστα βελτιστοποιημένα μοντέλα",
  "dialog.provider.awmateGo.tagline": "Συνδρομή χαμηλού κόστους για όλους",
  ...
  "dialog.model.unpaid.freeModels.title": "Δωρεάν μοντέλα παρέχονται από AWMate",
  ...
  "provider.connect.apiKey.description":
    "Εισαγάγετε το κλειδί {{provider}} API για να συνδέσετε τον λογαριασμό σας και χρησιμοποιήστε μοντέλα {{provider}} στο AWMate.",
  ...
  "provider.connect.awmateZen.line1":
    "AWMate Το Zen σάς δίνει πρόσβαση σε ένα επιμελημένο σύνολο αξιόπιστων βελτιστοποιημένων μοντέλων για πράκτορες κωδικοποίησης.",
  "provider.connect.awmateZen.line2":
    "Με ένα μόνο κλειδί API θα έχετε πρόσβαση σε μοντέλα όπως Claude, GPT, Gemini, GLM και άλλα.",
  "provider.connect.awmateZen.visit.prefix": "Επίσκεψη ",
  "provider.connect.awmateZen.visit.link": "opencode.ai/zen",
  "provider.connect.awmateZen.visit.suffix": " για τη συλλογή του κλειδιού σας API.",
  "provider.connect.oauth.code.visit.prefix": "Επίσκεψη ",
  "provider.connect.oauth.code.visit.link": "αυτός ο σύνδεσμος",
  "provider.connect.oauth.code.visit.suffix":
    " για να συλλέξετε τον κωδικό εξουσιοδότησης για να συνδέσετε τον λογαριασμό σας και να χρησιμοποιήσετε {{provider}} μοντέλα στο AWMate.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " και εισαγάγετε τον παρακάτω κωδικό για να συνδέσετε τον λογαριασμό σας και να χρησιμοποιήσετε {{provider}} μοντέλα στο AWMate.",
  ...
  "dialog.plugins.empty": "Προσθήκες ρυθμισμένες στο awmate.json",
  ...
  "dialog.server.description": "Αλλαγή σε ποιον διακομιστή AWMate συνδέεται αυτή η εφαρμογή.",
  ...
  "wsl.onboarding.checkingAWMate": "Έλεγχος AWMate...",
  "wsl.onboarding.checkingAWMateIn": "Έλεγχος AWMate σε {{distro}}...",
  "wsl.onboarding.updatingAWMate": "Ενημέρωση AWMate...",
  "wsl.onboarding.updatingAWMateIn": "Ενημέρωση AWMate σε {{distro}}...",
  "wsl.onboarding.updateAWMateIn": "Ενημέρωση AWMate σε {{distro}}.",
  "wsl.onboarding.updateAWMate": "Ενημέρωση AWMate",
  "wsl.onboarding.awmateReadyIn": "AWMate είναι έτοιμο στο {{distro}}.",
  "wsl.onboarding.awmateReady": "AWMate είναι έτοιμο.",
  "wsl.onboarding.installAWMateIn": "Εγκατάσταση του AWMate στο {{distro}}.",
  "wsl.onboarding.installAWMate": "Εγκατάσταση AWMate",
  ...
  "wsl.onboarding.distroStatus.awmateMissing": "AWMate δεν έχει εγκατασταθεί",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Υποσύστημα για Linux) απαιτείται για να μπορέσει ο AWMate να προσθέσει έναν διακομιστή WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL μη διαθέσιμο",
  "wsl.onboarding.wslUnavailable.description": "AWMate δεν μπόρεσε να επαληθεύσει το WSL σε αυτό το μηχάνημα.",
  "wsl.onboarding.installWsl": "Εγκατάσταση WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Επανεκκινήστε το Windows για να ολοκληρώσετε την εγκατάσταση του WSL και μετά ανοίξτε ξανά το AWMate.",
  ...
  "help.tabs.introduction": "AWMate Η επιφάνεια εργασίας είναι πλέον χτισμένη γύρω από καρτέλες.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Μια νέα έκδοση του AWMate ({{version}}) είναι τώρα διαθέσιμη για εγκατάσταση.",
  ...
  "error.page.report.prefix": "Αναφέρετε αυτό το σφάλμα στην ομάδα AWMate",
  ...
  "error.chain.checkConfig": "Ελέγξτε τη διαμόρφωση (awmate.json) ονόματα παρόχου/μοντέλων",
  "error.chain.mcpFailed":
    'MCP διακομιστής "{{name}}" απέτυχε. Σημείωση, το AWMate δεν υποστηρίζει ακόμη έλεγχο ταυτότητας MCP.',
  ...
  "sidebar.gettingStarted.line1": "AWMate περιλαμβάνει δωρεάν μοντέλα, ώστε να μπορείτε να ξεκινήσετε αμέσως.",
  ...
  "app.name.desktop": "AWMate Επιτραπέζιος υπολογιστής",
  ...
  "settings.desktop.wsl.description": "Εκτέλεση του διακομιστή AWMate μέσα στο WSL στο Windows.",
  ...
  "settings.general.row.language.description": "Αλλαγή της γλώσσας εμφάνισης για το AWMate",
  ...
  "settings.general.row.appearance.description": "Προσαρμογή της εμφάνισης του AWMate στη συσκευή σας",
  "settings.general.row.colorScheme.title": "Χρωματικός συνδυασμός",
  "settings.general.row.colorScheme.description":
    "Επιλέξτε εάν το AWMate ακολουθεί το σύστημα, το ανοιχτό ή το σκοτεινό θέμα",
  "settings.general.row.theme.title": "Θέμα",
  "settings.general.row.theme.description": "Προσαρμογή του τρόπου με τον οποίο έχει θέμα το AWMate.",
  ...
  "settings.updates.row.startup.description": "Αυτόματος έλεγχος για ενημερώσεις κατά την εκκίνηση του AWMate",
  ...
  "settings.updates.toast.latest.description": "Εκτελείτε την πιο πρόσφατη έκδοση του AWMate.",
