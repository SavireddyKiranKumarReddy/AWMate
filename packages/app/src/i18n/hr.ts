...
const desktop = [
  ...
  "Nastavi čekati",
  "Izađi",
  "AWMate se nije uspio učitati",
  "Prozor aplikacije AWMate neočekivano je zatvoren",
  "AWMate ne reagira",
  ...
  "Instalacija aplikacije AWMate nije uspjela",
  "Distribucija {{distro}} već je dodana",
  "awmate nije instaliran u ovoj distribuciji",
  "awmate je instaliran, ali se ne može pokrenuti",
  "AWMate nije instaliran u distribuciji {{distro}}",
  "Ažuriranje aplikacije AWMate je završeno, ali {{distro}} i dalje prijavljuje {{installed}}; očekivano je {{expected}}",
  "nema verzije",
...
export const dict = {
  ...
  "dialog.provider.awmate.note": "Odabrani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.awmate.tagline": "Pouzdani optimizirani modeli",
  "dialog.provider.awmateGo.tagline": "Niska cijena pretplate za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatne modele nudi AWMate",
  ...
  "provider.connect.apiKey.description":
    "Enter vaš {{provider}} API ključ za povezivanje vašeg računa i korištenje {{provider}} modela u AWMate.",
  ...
  "provider.connect.awmateZen.line1":
    "AWMate Zen vam daje pristup odabranom skupu pouzdanih optimiziranih modela za agente za kodiranje.",
  ...
  "provider.connect.awmateZen.visit.prefix": "Posjetiti",
  "provider.connect.awmateZen.visit.link": "otvoreni kod.ai/zen",
  "provider.connect.awmateZen.visit.suffix": "da preuzmete svoj ključ API.",
  "provider.connect.oauth.code.visit.prefix": "Posjetiti",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    "za prikupljanje vašeg autorizacijskog koda za povezivanje vašeg računa i korištenje {{provider}} modela u AWMate.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "i unesite kod ispod kako biste povezali svoj račun i koristili {{provider}} modele u AWMate.",
  ...
  "dialog.plugins.empty": "Dodaci konfigurirani u awmate.json",
  ...
  "dialog.server.description": "Promijenite na koji se AWMate poslužitelj povezuje ova aplikacija.",
  ...
  "wsl.onboarding.checkingAWMate": "Provjera AWMate...",
  "wsl.onboarding.checkingAWMateIn": "Provjera AWMate u {{distro}}...",
  "wsl.onboarding.updatingAWMate": "Ažuriranje AWMate...",
  "wsl.onboarding.updatingAWMateIn": "Ažuriranje AWMate u {{distro}}...",
  "wsl.onboarding.updateAWMateIn": "Ažurirajte AWMate u {{distro}}.",
  "wsl.onboarding.updateAWMate": "Ažurirajte AWMate",
  "wsl.onboarding.awmateReadyIn": "AWMate je spreman u {{distro}}.",
  "wsl.onboarding.awmateReady": "AWMate je spreman.",
  "wsl.onboarding.installAWMateIn": "Instalirajte AWMate u {{distro}}.",
  "wsl.onboarding.installAWMate": "Instalirajte AWMate",
  ...
  "wsl.onboarding.distroStatus.awmateMissing": "AWMate nije instaliran",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows podsustav za Linux) je potreban prije nego što AWMate može dodati WSL poslužitelj",
  "wsl.onboarding.wslUnavailable.title": "WSL nedostupan",
  "wsl.onboarding.wslUnavailable.description": "AWMate nije mogao potvrditi WSL na ovom stroju.",
  "wsl.onboarding.installWsl": "Instalirajte WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokrenite Windows da dovršite instalaciju WSL, zatim ponovno otvorite AWMate.",
  ...
  "help.tabs.introduction": "Radna površina AWMate sada je izgrađena oko kartica.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova verzija AWMate ({{version}}) sada je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Prijavite ovu grešku AWMate timu",
  ...
  "error.chain.checkConfig": "Provjerite nazive dobavljača/modela svoje konfiguracije (awmate.json).",
  "error.chain.mcpFailed":
    'MCP poslužitelj "{{name}}" nije uspio. Napomena, AWMate još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "AWMate uključuje besplatne modele tako da možete odmah početi.",
  ...
  "app.name.desktop": "AWMate Radna površina",
  ...
  "settings.desktop.wsl.description": "Pokrenite AWMate poslužitelj unutar WSL na Windows.",
  ...
  "settings.general.row.language.description": "Promijenite jezik prikaza za AWMate",
  ...
  "settings.general.row.appearance.description": "Prilagodite kako AWMate izgleda na vašem uređaju",
  "settings.general.row.colorScheme.title": "Shema boja",
  "settings.general.row.colorScheme.description":
    "Odaberite hoće li AWMate slijediti sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodite način na koji je AWMate tematiziran.",
  ...
  "settings.updates.row.startup.description": "Automatski provjeri ima li ažuriranja kada se AWMate pokrene",
  ...
  "settings.updates.toast.latest.description": "Imate najnoviju verziju AWMate.",
