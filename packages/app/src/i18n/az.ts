export const dict = {
  ...
  "desktop.recovery.loadFailed": "AWMate yüklənə bilmədi",
  "desktop.recovery.terminated": "AWMate pəncərəsinin işi gözlənilmədən dayandı",
  "desktop.recovery.unresponsive": "AWMate cavab vermir",
  ...
  "desktop.wsl.error.installAWMate": "AWMate quraşdırılması uğursuz oldu",
  "desktop.wsl.error.alreadyAdded": "{{distro}} artıq əlavə edilib",
  "desktop.wsl.error.awmateMissing": "Bu distribütivdə awmate quraşdırılmayıb",
  "desktop.wsl.error.awmateCannotRun": "awmate quraşdırılıb, lakin onu işə salmaq mümkün olmadı",
  "desktop.wsl.error.awmateNotInstalled": "AWMate {{distro}} distribütivində quraşdırılmayıb",
  "desktop.wsl.error.updateVersion":
    "AWMate yeniləməsi tamamlandı, lakin {{distro}} hələ də {{installed}} versiyasını bildirir; gözlənilən versiya: {{expected}}",
  ...
  "dialog.provider.awmate.note": "Claude, GPT, Gemini və daha çoxu daxil olmaqla seçilmiş modellər",
  "dialog.provider.awmate.tagline": "Etibarlı optimallaşdırılmış modellər",
  "dialog.provider.awmateGo.tagline": "Hamı üçün aşağı qiymətli abunəlik",
  ...
  "dialog.model.unpaid.freeModels.title": "AWMate tərəfindən təqdim olunan pulsuz modellər",
  ...
  "provider.connect.apiKey.description":
    "Hesabınızı qoşmaq və AWMate-da {{provider}} modellərindən istifadə etmək üçün {{provider}} API açarınızı daxil edin.",
  ...
  "provider.connect.awmateZen.line1":
    "AWMate Zen sizə kodlaşdırma agentləri üçün etibarlı optimallaşdırılmış seçilmiş modellər dəstinə giriş verir.",
  "provider.connect.awmateZen.line2":
    "Tək bir API açarı ilə Claude, GPT, Gemini, GLM və daha çox modellərə giriş əldə edəcəksiniz.",
  "provider.connect.awmateZen.visit.prefix": "",
  "provider.connect.awmateZen.visit.link": "opencode.ai/zen",
  "provider.connect.awmateZen.visit.suffix": " səhifəsinə daxil olub API açarınızı əldə edin.",
  "provider.connect.oauth.code.visit.prefix": "",
  "provider.connect.oauth.code.visit.link": "Bu linkə",
  "provider.connect.oauth.code.visit.suffix":
    " daxil olub hesabınızı qoşmaq və AWMate-da {{provider}} modellərindən istifadə etmək üçün avtorizasiya kodunuzu əldə edin.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " daxil olub aşağıdakı kodu daxil edərək hesabınızı qoşun və AWMate-da {{provider}} modellərindən istifadə edin.",
  ...
  "dialog.plugins.empty": "Plaginlər awmate.json-da konfiqurasiya edilib",
  ...
  "dialog.server.description": "Bu tətbiqin qoşulduğu AWMate serverini dəyişdirin.",
  ...
  "wsl.onboarding.checkingAWMate": "AWMate yoxlanılır...",
  "wsl.onboarding.checkingAWMateIn": "{{distro}}-də AWMate yoxlanılır...",
  "wsl.onboarding.updatingAWMate": "AWMate yenilənir...",
  "wsl.onboarding.updatingAWMateIn": "{{distro}}-də AWMate yenilənir...",
  "wsl.onboarding.updateAWMateIn": "{{distro}}-də AWMate-u yeniləyin.",
  "wsl.onboarding.updateAWMate": "AWMate-u yeniləyin",
  "wsl.onboarding.awmateReadyIn": "AWMate {{distro}}-də hazırdır.",
  "wsl.onboarding.awmateReady": "AWMate hazırdır.",
  "wsl.onboarding.installAWMateIn": "AWMate-u {{distro}}-də quraşdırın.",
  "wsl.onboarding.installAWMate": "AWMate quraşdırın",
  ...
  "wsl.onboarding.distroStatus.awmateMissing": "AWMate quraşdırılmayıb",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "AWMate WSL serveri əlavə etməzdən əvvəl WSL (Linux üçün Windows alt sistemi) tələb olunur",
  "wsl.onboarding.wslUnavailable.title": "WSL mövcud deyil",
  "wsl.onboarding.wslUnavailable.description": "AWMate bu maşında WSL-i doğrulaya bilmədi.",
  "wsl.onboarding.installWsl": "WSL quraşdırın",
  "wsl.onboarding.windowsRestartRequired":
    "WSL-nin quraşdırılmasını başa çatdırmaq üçün Windows-u yenidən başladın, sonra AWMate-u yenidən açın.",
  ...
  "help.tabs.introduction": "AWMate Desktop indi tablar əsasında qurulub.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "AWMate-un yeni versiyası ({{version}}) quraşdırma üçün mövcuddur.",
  ...
  "error.page.report.prefix": "Bu xətanı AWMate komandasına",
  ...
  "error.chain.checkConfig": "Konfiqurasiyanızdakı (awmate.json) provayder/model adlarını yoxlayın",
  "error.chain.mcpFailed":
    'MCP server "{{name}}" uğursuz oldu. Qeyd: AWMate hələ MCP autentifikasiyasını dəstəkləmir.',
  ...
  "sidebar.gettingStarted.line1": "AWMate-a pulsuz modellər daxildir, buna görə dərhal başlaya bilərsiniz.",
  ...
  "settings.desktop.wsl.description": "Windows-da WSL daxilində AWMate serverini işlət.",
  ...
  "settings.general.row.language.description": "AWMate üçün ekran dilini dəyişdirin",
  ...
  "settings.general.row.appearance.description": "AWMate-un cihazınızda necə göründüyünü fərdiləşdirin",
  "settings.general.row.colorScheme.title": "Rəng sxemi",
  "settings.general.row.colorScheme.description":
    "AWMate-un sistem, açıq və ya tünd mövzudan istifadə etməsini seçin",
  "settings.general.row.theme.title": "Mövzu",
  "settings.general.row.theme.description": "AWMate-un mövzusunu fərdiləşdirin.",
  ...
  "settings.updates.row.startup.description": "AWMate açıldıqda avtomatik yeniləmələri yoxla",
  ...
  "settings.updates.toast.latest.description": "AWMate-un ən son versiyasından istifadə edirsiniz.",
