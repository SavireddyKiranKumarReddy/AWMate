export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacioni AWMate",
  ...
  "desktop.menu.ariaLabel": "Menuja AWMate",
  ...
  "desktop.recovery.loadFailed": "AWMate nuk u ngarkua",
  "desktop.recovery.terminated": "Dritarja AWMate u mbyll papritur",
  "desktop.recovery.unresponsive": "AWMate nuk po përgjigjet",
  ...
  "desktop.wsl.error.installAWMate": "Instalimi i AWMate dështoi",
  "desktop.wsl.error.alreadyAdded": "{{distro}} është shtuar tashmë",
  "desktop.wsl.error.awmateMissing": "AWMate nuk është i instaluar në këtë shpërndarje",
  "desktop.wsl.error.awmateCannotRun": "AWMate është instaluar por nuk mund të ekzekutohet",
  "desktop.wsl.error.awmateNotInstalled": "AWMate nuk është i instaluar në {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Përditësimi i AWMate përfundoi, por {{distro}} ende raporton {{installed}}; pritet {{expected}}",
  ...
  "dialog.provider.awmate.note": "Modele të kuruara duke përfshirë Claude, GPT, Gemini dhe më shumë",
  "dialog.provider.awmate.tagline": "Modele të besueshme të optimizuara",
  "dialog.provider.awmateGo.tagline": "Abonim me kosto të ulët për të gjithë",
  ...
  "dialog.model.unpaid.freeModels.title": "Modele falas të ofruara nga AWMate",
  ...
  "provider.connect.apiKey.description":
    "Futni çelësin API të {{provider}} për të lidhur llogarinë dhe për të përdorur modelet {{provider}} në AWMate.",
  ...
  "provider.connect.awmateZen.line1":
    "AWMate Zen ju jep akses në një grup të kuruar modelesh të optimizuara të besueshme për agjentët e kodimit.",
  ...
  "provider.connect.awmateZen.visit.prefix": "Vizitoni ",
  "provider.connect.awmateZen.visit.link": "opencode.ai/zen",
  "provider.connect.awmateZen.visit.suffix": " për të mbledhur çelësin tuaj API.",
  "provider.connect.oauth.code.visit.prefix": "Vizitoni ",
  "provider.connect.oauth.code.visit.link": "kjo lidhje",
  "provider.connect.oauth.code.visit.suffix":
    " për të mbledhur kodin tuaj të autorizimit për të lidhur llogarinë tuaj dhe për të përdorur modelet {{provider}} në AWMate.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dhe futni kodin më poshtë për të lidhur llogarinë tuaj dhe për të përdorur modelet {{provider}} në AWMate.",
  ...
  "dialog.plugins.empty": "Shtojcat e konfiguruara në awmate.json",
  ...
  "dialog.server.description": "Ndrysho me cilin server AWMate lidhet ky aplikacion.",
  ...
  "wsl.onboarding.checkingAWMate": "Po kontrollon AWMate...",
  "wsl.onboarding.checkingAWMateIn": "Po kontrollon AWMate në {{distro}}...",
  "wsl.onboarding.updatingAWMate": "AWMate po përditësohet...",
  "wsl.onboarding.updatingAWMateIn": "Po përditëson AWMate në {{distro}}...",
  "wsl.onboarding.updateAWMateIn": "Përditëso AWMate në {{distro}}.",
  "wsl.onboarding.updateAWMate": "Përditëso AWMate",
  "wsl.onboarding.awmateReadyIn": "AWMate është gati në {{distro}}.",
  "wsl.onboarding.awmateReady": "AWMate është gati.",
  "wsl.onboarding.installAWMateIn": "Instaloni AWMate në {{distro}}.",
  "wsl.onboarding.installAWMate": "Instaloni AWMate",
  ...
  "wsl.onboarding.distroStatus.awmateMissing": "AWMate nuk është i instaluar",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Nënsistemi Windows për Linux) kërkohet përpara se AWMate të shtojë një server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL i padisponueshëm",
  "wsl.onboarding.wslUnavailable.description": "AWMate nuk mund ta verifikonte WSL në këtë makinë.",
  "wsl.onboarding.installWsl": "Instaloni WSL",
  "wsl.onboarding.windowsRestartRequired": "Rinis Windows për të përfunduar instalimin e WSL, më pas rihap AWMate.",
  ...
  "help.tabs.introduction": "AWMate Desktop tani është ndërtuar rreth skedave.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Një version i ri i AWMate ({{version}}) është tani i disponueshëm për t'u instaluar.",
  ...
  "error.page.report.prefix": "Ju lutemi raportoni këtë gabim te ekipi i AWMate",
  ...
  "error.chain.checkConfig": "Kontrolloni emrat e ofruesit/modelit tuaj të konfigurimit (awmate.json).",
  "error.chain.mcpFailed": 'Serveri MCP "{{name}}" dështoi. Shënim, AWMate nuk e mbështet ende vërtetimin MCP.',
  ...
  "sidebar.gettingStarted.line1": "AWMate përfshin modele falas, kështu që mund të filloni menjëherë.",
  ...
  "settings.desktop.wsl.description": "Ekzekutoni serverin AWMate brenda WSL në Windows.",
  ...
  "settings.general.row.language.description": "Ndryshoni gjuhën e ekranit për AWMate",
  ...
  "settings.general.row.appearance.description": "Personalizojeni se si duket AWMate në pajisjen tuaj",
  "settings.general.row.colorScheme.title": "Skema e ngjyrave",
  "settings.general.row.colorScheme.description":
    "Zgjidhni nëse AWMate ndjek temën e sistemit, të lehtë ose të errët",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalizojeni se si është tema e AWMate.",
  ...
  "settings.updates.row.startup.description": "Kontrolloni automatikisht për përditësime kur niset AWMate",
  ...
  "settings.updates.toast.latest.description": "Ju jeni duke ekzekutuar versionin më të fundit të AWMate.",
