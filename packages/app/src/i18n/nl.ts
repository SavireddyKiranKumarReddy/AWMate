export const dict = {
  ...
  "desktop.menu.documentation": "AWMate-documentatie",
  ...
  "desktop.recovery.loadFailed": "AWMate kan niet worden geladen",
  "desktop.recovery.terminated": "Het AWMate-venster is onverwacht beëindigd",
  "desktop.recovery.unresponsive": "AWMate reageert niet",
  ...
  "desktop.wsl.error.installAWMate": "Installatie van AWMate is mislukt",
  "desktop.wsl.error.alreadyAdded": "{{distro}} is al toegevoegd",
  "desktop.wsl.error.awmateMissing": "awmate is niet geïnstalleerd in deze distributie",
  "desktop.wsl.error.awmateCannotRun": "awmate is geïnstalleerd, maar kan niet worden uitgevoerd",
  "desktop.wsl.error.awmateNotInstalled": "AWMate is niet geïnstalleerd in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "De AWMate-update is voltooid, maar {{distro}} meldt nog steeds {{installed}}; verwacht: {{expected}}",
  ...
  "dialog.provider.awmate.note": "Samengestelde modellen, waaronder Claude, GPT, Gemini en meer",
  "dialog.provider.awmate.tagline": "Betrouwbare geoptimaliseerde modellen",
  "dialog.provider.awmateGo.tagline": "Goedkoop abonnement voor iedereen",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modellen geleverd door AWMate",
  ...
  "provider.connect.apiKey.description":
    "Voer je {{provider}}-API-sleutel in om je account te koppelen en {{provider}}-modellen in AWMate te gebruiken.",
  ...
  "provider.connect.awmateZen.line1":
    "AWMate Zen geeft je toegang tot een samengestelde set betrouwbare, geoptimaliseerde modellen voor codeeragenten.",
  "provider.connect.awmateZen.line2":
    "Met één API-sleutel krijg je toegang tot modellen zoals Claude, GPT, Gemini, GLM en meer.",
  "provider.connect.awmateZen.visit.prefix": "Ga naar ",
  "provider.connect.awmateZen.visit.link": "opencode.ai/zen",
  "provider.connect.awmateZen.visit.suffix": " om je API-sleutel op te halen.",
  "provider.connect.oauth.code.visit.prefix": "Ga naar ",
  "provider.connect.oauth.code.visit.link": "deze link",
  "provider.connect.oauth.code.visit.suffix":
    " om je autorisatiecode op te halen, je account te koppelen en {{provider}}-modellen in AWMate te gebruiken.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " en voer de onderstaande code in om je account te koppelen en {{provider}}-modellen in AWMate te gebruiken.",
  ...
  "dialog.plugins.empty": "Plug-ins geconfigureerd in awmate.json",
  ...
  "dialog.server.description": "Wijzig met welke AWMate-server deze app verbinding maakt.",
  ...
  "wsl.onboarding.checkingAWMate": "AWMate controleren...",
  "wsl.onboarding.checkingAWMateIn": "AWMate controleren in {{distro}}...",
  "wsl.onboarding.updatingAWMate": "AWMate bijwerken...",
  "wsl.onboarding.updatingAWMateIn": "AWMate bijwerken in {{distro}}...",
  "wsl.onboarding.updateAWMateIn": "Werk AWMate bij in {{distro}}.",
  "wsl.onboarding.updateAWMate": "AWMate bijwerken",
  "wsl.onboarding.awmateReadyIn": "AWMate is gereed in {{distro}}.",
  "wsl.onboarding.awmateReady": "AWMate is klaar.",
  "wsl.onboarding.installAWMateIn": "Installeer AWMate in {{distro}}.",
  "wsl.onboarding.installAWMate": "Installeer AWMate",
  ...
  "wsl.onboarding.distroStatus.awmateMissing": "AWMate niet geïnstalleerd",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows-subsysteem voor Linux) is vereist voordat AWMate een WSL-server kan toevoegen",
  "wsl.onboarding.wslUnavailable.title": "WSL niet beschikbaar",
  "wsl.onboarding.wslUnavailable.description": "AWMate kan WSL niet verifiëren op deze machine.",
  "wsl.onboarding.installWsl": "Installeer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows opnieuw om de installatie van WSL te voltooien en open vervolgens AWMate opnieuw.",
  ...
  "help.tabs.introduction": "AWMate Desktop is nu opgebouwd rond tabbladen.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Er is nu een nieuwe versie van AWMate ({{version}}) beschikbaar om te installeren.",
  ...
  "error.page.report.prefix": "Rapporteer deze fout aan het AWMate-team",
  ...
  "error.chain.checkConfig": "Controleer de provider- en modelnamen in je configuratie (awmate.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" is mislukt. Let op: AWMate ondersteunt nog geen MCP-authenticatie.',
  ...
  "sidebar.gettingStarted.line1": "AWMate bevat gratis modellen, zodat je direct aan de slag kunt.",
  ...
  "settings.desktop.wsl.description": "Voer de AWMate-server uit in WSL op Windows.",
  ...
  "settings.general.row.language.description": "Wijzig de weergavetaal voor AWMate",
  ...
  "settings.general.row.appearance.description": "Pas aan hoe AWMate eruitziet op je apparaat",
  "settings.general.row.colorScheme.title": "Kleurenschema",
  "settings.general.row.colorScheme.description":
    "Kies of AWMate het systeemthema, het lichte thema of het donkere thema gebruikt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Pas het thema van AWMate aan.",
  ...
  "settings.updates.row.startup.description": "Controleer automatisch op updates wanneer AWMate wordt gestart",
  ...
  "settings.updates.toast.latest.title": "AWMate is bijgewerkt",
  "settings.updates.toast.latest.description": "Je gebruikt de nieuwste versie van AWMate.",
