export const dict = {
  ...
  "dialog.provider.awmateGo.tagline": "Billigt abonnement for alle",
  ...
  "provider.connect.apiKey.description":
    "Indtast din API-nøgle til {{provider}} for at forbinde din konto og bruge modeller fra {{provider}} i AWMate.",
  ...
  "provider.connect.awmateZen.visit.prefix": "Besøg ",
  "provider.connect.awmateZen.visit.link": "opencode.ai/zen",
  "provider.connect.awmateZen.visit.suffix": " for at hente din API-nøgle.",
  "provider.connect.oauth.code.visit.prefix": "Besøg ",
  "provider.connect.oauth.code.visit.link": "dette link",
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode, forbinde din konto og bruge modeller fra {{provider}} i AWMate.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge modeller fra {{provider}} i AWMate.",
  ...
  "wsl.onboarding.checkingAWMate": "Tjekker AWMate...",
  "wsl.onboarding.checkingAWMateIn": "Tjekker AWMate i {{distro}}...",
  "wsl.onboarding.updatingAWMate": "Opdaterer AWMate...",
  "wsl.onboarding.updatingAWMateIn": "Opdaterer AWMate i {{distro}}...",
  "wsl.onboarding.updateAWMateIn": "Opdater AWMate i {{distro}}.",
  "wsl.onboarding.updateAWMate": "Opdater AWMate",
  "wsl.onboarding.awmateReadyIn": "AWMate er klar i {{distro}}.",
  "wsl.onboarding.awmateReady": "AWMate er klar.",
  ...
  "wsl.onboarding.distroStatus.awmateMissing": "AWMate er ikke installeret",
  ...
  "error.chain.checkConfig": "Kontrollér udbyder- og modelnavnene i din konfiguration (awmate.json)",
  ...
  "settings.general.row.colorScheme.description":
    "Vælg, om AWMate skal følge systemtemaet eller bruge et lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas AWMates tema.",
  ...
  "desktop.recovery.loadFailed": "AWMate kunne ikke indlæses",
  "desktop.recovery.terminated": "AWMate-vinduet blev uventet afsluttet",
  "desktop.recovery.unresponsive": "AWMate svarer ikke",
  ...
  "desktop.wsl.error.installAWMate": "Installationen af AWMate mislykkedes",
  "desktop.wsl.error.alreadyAdded": "{{distro}} er allerede tilføjet",
  "desktop.wsl.error.awmateMissing": "awmate er ikke installeret i denne distribution",
  "desktop.wsl.error.awmateCannotRun": "awmate er installeret, men kunne ikke køre",
  "desktop.wsl.error.awmateNotInstalled": "AWMate er ikke installeret i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Opdateringen af AWMate er fuldført, men {{distro}} rapporterer stadig {{installed}}. Forventet: {{expected}}",
  ...
  "help.tabs.introduction": "AWMate Desktop er nu bygget op omkring faner.",
  "help.tabs.sessions":
