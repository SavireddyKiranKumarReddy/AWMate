...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "AWMate 載入失敗",
  "desktop.recovery.terminated": "AWMate 視窗意外終止",
  "desktop.recovery.unresponsive": "AWMate 沒有回應",
  ...
  "desktop.wsl.error.installAWMate": "AWMate 安裝失敗",
  "desktop.wsl.error.alreadyAdded": "已新增 {{distro}}",
  "desktop.wsl.error.awmateMissing": "此發行版中未安裝 awmate",
  "desktop.wsl.error.awmateCannotRun": "已安裝 awmate，但無法執行",
  "desktop.wsl.error.awmateNotInstalled": "{{distro}} 中未安裝 AWMate",
  "desktop.wsl.error.updateVersion":
    "AWMate 更新完成，但 {{distro}} 回報的版本仍為 {{installed}}；預期版本為 {{expected}}",
  ...
  "dialog.provider.awmate.tagline": "經過最佳化的可靠模型",
  "dialog.provider.awmateGo.tagline": "適合所有人的低成本訂閱",
  ...
  "provider.connect.awmateZen.line1": "AWMate Zen 為你提供一組精選的可靠最佳化模型，用於程式碼代理程式。",
  "provider.connect.awmateZen.line2": "只需一個 API 金鑰，你就能使用 Claude、GPT、Gemini、GLM 等模型。",
  "provider.connect.awmateZen.visit.prefix": "造訪 ",
  "provider.connect.awmateZen.visit.link": "opencode.ai/zen",
  "provider.connect.awmateZen.visit.suffix": " 取得你的 API 金鑰。",
  ...
  "wsl.onboarding.checkingAWMate": "正在檢查 AWMate...",
  "wsl.onboarding.checkingAWMateIn": "正在檢查 {{distro}} 中的 AWMate...",
  ...
  "wsl.onboarding.awmateReadyIn": "{{distro}} 中的 AWMate 已就緒。",
  "wsl.onboarding.awmateReady": "AWMate 已就緒。",
  ...
  "wsl.onboarding.distroStatus.awmateMissing": "未安裝 AWMate",
  ...
  "help.tabs.introduction": "AWMate Desktop 現在以分頁為核心。",
  "help.tabs.sessions":
  ...
  "error.chain.mcpFailed": "MCP 伺服器「{{name}}」啟動失敗。注意：AWMate 尚不支援 MCP 驗證。",
