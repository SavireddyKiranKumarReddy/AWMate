export const dict = {
  ...
  "desktop.menu.documentation": "AWMate-dokumentation",
  ...
  "desktop.menu.ariaLabel": "AWMate-meny",
  ...
  "desktop.recovery.loadFailed": "AWMate kunde inte läsas in",
  "desktop.recovery.terminated": "AWMate-fönstret avslutades oväntat",
  "desktop.recovery.unresponsive": "AWMate svarar inte",
  ...
  "desktop.wsl.error.installAWMate": "Installationen av AWMate misslyckades",
  "desktop.wsl.error.alreadyAdded": "{{distro}} har redan lagts till",
  "desktop.wsl.error.awmateMissing": "awmate är inte installerat i den här distributionen",
  "desktop.wsl.error.awmateCannotRun": "awmate är installerat men kunde inte köras",
  "desktop.wsl.error.awmateNotInstalled": "AWMate är inte installerat i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "AWMate-uppdateringen slutfördes, men {{distro}} rapporterar fortfarande {{installed}}. {{expected}} förväntades",
  ...
  "dialog.provider.awmate.note": "Kurerade modeller inklusive Claude, GPT, Gemini och mer",
  "dialog.provider.awmate.tagline": "Pålitliga optimerade modeller",
  "dialog.provider.awmateGo.tagline": "Lågprisprenumeration för alla",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller tillhandahålls av AWMate",
  ...
  "provider.connect.apiKey.description":
    "Ange din {{provider}}-API-nyckel för att ansluta ditt konto och använda {{provider}}-modeller i AWMate.",
  ...
  "provider.connect.awmateZen.line1":
    "AWMate Zen ger dig tillgång till en utvald uppsättning pålitliga optimerade modeller för kodningsagenter.",
  "provider.connect.awmateZen.line2":
    "Med en enda API-nyckel får du tillgång till modeller som Claude, GPT, Gemini, GLM och mer.",
  "provider.connect.awmateZen.visit.prefix": "Besök ",
  "provider.connect.awmateZen.visit.link": "opencode.ai/zen",
  "provider.connect.awmateZen.visit.suffix": " för att hämta din API-nyckel.",
  "provider.connect.oauth.code.visit.prefix": "Besök ",
  "provider.connect.oauth.code.visit.link": "denna länk",
  "provider.connect.oauth.code.visit.suffix":
    " för att hämta auktoriseringskoden som ansluter ditt konto och låter dig använda {{provider}}-modeller i AWMate.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " och ange koden nedan för att ansluta ditt konto och använda {{provider}}-modeller i AWMate.",
  ...
  "dialog.plugins.empty": "Insticksprogram konfigurerade i awmate.json",
  ...
  "dialog.server.description": "Växla vilken AWMate-server som denna app ansluter till.",
  ...
  "wsl.onboarding.checkingAWMate": "Kontrollerar AWMate...",
  "wsl.onboarding.checkingAWMateIn": "Kontrollerar AWMate i {{distro}}...",
  "wsl.onboarding.updatingAWMate": "Uppdaterar AWMate...",
  "wsl.onboarding.updatingAWMateIn": "Uppdaterar AWMate i {{distro}}...",
  "wsl.onboarding.updateAWMateIn": "Uppdatera AWMate i {{distro}}.",
  "wsl.onboarding.updateAWMate": "Uppdatera AWMate",
  "wsl.onboarding.awmateReadyIn": "AWMate är redo i {{distro}}.",
  "wsl.onboarding.awmateReady": "AWMate är redo.",
  "wsl.onboarding.installAWMateIn": "Installera AWMate i {{distro}}.",
  "wsl.onboarding.installAWMate": "Installera AWMate",
  ...
  "wsl.onboarding.distroStatus.awmateMissing": "AWMate är inte installerat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) krävs innan AWMate kan lägga till en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL är inte tillgängligt",
  "wsl.onboarding.wslUnavailable.description": "AWMate kunde inte verifiera WSL på den här maskinen.",
  "wsl.onboarding.installWsl": "Installera WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Starta om Windows för att slutföra installationen av WSL och öppna sedan AWMate igen.",
  ...
  "help.tabs.introduction": "AWMate Desktop är nu uppbyggt kring flikar.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "En ny version av AWMate ({{version}}) är nu tillgänglig att installera.",
  ...
  "error.page.report.prefix": "Rapportera det här felet till AWMate-teamet",
  ...
  "error.chain.checkConfig": "Kontrollera leverantörs- och modellnamnen i konfigurationen (awmate.json)",
  "error.chain.mcpFailed": 'MCP-servern "{{name}}" misslyckades. Obs, AWMate stöder inte MCP-autentisering ännu.',
  ...
  "sidebar.gettingStarted.line1": "AWMate innehåller gratis modeller så att du kan börja direkt.",
  ...
  "settings.desktop.wsl.description": "Kör AWMate-servern inuti WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ändra visningsspråket för AWMate",
  ...
  "settings.general.row.appearance.description": "Anpassa hur AWMate ser ut på din enhet",
  "settings.general.row.colorScheme.title": "Färgschema",
  "settings.general.row.colorScheme.description": "Välj om AWMate följer system-, ljus- eller mörktemat",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Anpassa AWMates tema.",
  ...
  "settings.updates.row.startup.description": "Sök automatiskt efter uppdateringar när AWMate startas",
  ...
  "settings.updates.toast.latest.description": "Du kör den senaste versionen av AWMate.",
