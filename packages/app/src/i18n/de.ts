...
export const dict = {
  ...
  "dialog.provider.awmateGo.tagline": "Kostengünstiges Abo für alle",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren API-Schlüssel für {{provider}} ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in AWMate zu nutzen.",
  ...
  "provider.connect.awmateZen.visit.prefix": "Besuchen Sie ",
  "provider.connect.awmateZen.visit.link": "opencode.ai/zen",
  "provider.connect.awmateZen.visit.suffix": ", um Ihren API-Schlüssel zu erhalten.",
  ...
  "wsl.onboarding.checkingAWMate": "AWMate wird geprüft…",
  "wsl.onboarding.checkingAWMateIn": "AWMate in {{distro}} wird geprüft…",
  "wsl.onboarding.updatingAWMate": "AWMate wird aktualisiert…",
  "wsl.onboarding.updatingAWMateIn": "AWMate in {{distro}} wird aktualisiert…",
  "wsl.onboarding.updateAWMateIn": "Aktualisieren Sie AWMate in {{distro}}.",
  "wsl.onboarding.updateAWMate": "AWMate aktualisieren",
  "wsl.onboarding.awmateReadyIn": "AWMate ist in {{distro}} bereit.",
  "wsl.onboarding.awmateReady": "AWMate ist bereit.",
  ...
  "wsl.onboarding.distroStatus.awmateMissing": "AWMate nicht installiert",
  ...
  "error.chain.checkConfig": "Überprüfen Sie die Anbieter- und Modellnamen in Ihrer Konfiguration (awmate.json)",
  ...
  "home.providerTip":
    "AWMate mit über 75 Anbietern verbinden, um weitere Modelle wie Claude, GPT, Gemini und andere zu nutzen",
  ...
  "settings.updates.toast.latest.title": "AWMate ist auf dem neuesten Stand",
  "settings.updates.toast.latest.description": "Die aktuelle Version von AWMate wird verwendet.",
  ...
  "desktop.menu.ariaLabel": "AWMate-Menü",
  ...
  "desktop.recovery.loadFailed": "AWMate konnte nicht geladen werden",
  "desktop.recovery.terminated": "Das AWMate-Fenster wurde unerwartet beendet",
  "desktop.recovery.unresponsive": "AWMate reagiert nicht",
  ...
  "desktop.wsl.error.installAWMate": "AWMate-Installation fehlgeschlagen",
  "desktop.wsl.error.alreadyAdded": "{{distro}} wurde bereits hinzugefügt",
  "desktop.wsl.error.awmateMissing": "awmate ist in dieser Distribution nicht installiert",
  "desktop.wsl.error.awmateCannotRun": "awmate ist installiert, konnte aber nicht ausgeführt werden",
  "desktop.wsl.error.awmateNotInstalled": "AWMate ist in {{distro}} nicht installiert",
  "desktop.wsl.error.updateVersion":
    "Das AWMate-Update wurde abgeschlossen, aber {{distro}} meldet weiterhin {{installed}}; erwartet wurde {{expected}}",
  ...
  "help.tabs.introduction": "AWMate Desktop basiert jetzt auf Tabs.",
  "help.tabs.sessions":
