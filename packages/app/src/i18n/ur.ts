export const dict = {
  ...
  "desktop.menu.documentation": "AWMate دستاویزات",
  ...
  "desktop.menu.ariaLabel": "AWMate مینو",
  ...
  "desktop.recovery.loadFailed": "AWMate لوڈ نہیں ہو سکا",
  "desktop.recovery.terminated": "AWMate ونڈو غیر متوقع طور پر بند ہو گئی",
  "desktop.recovery.unresponsive": "AWMate جواب نہیں دے رہا",
  ...
  "desktop.wsl.error.installAWMate": "AWMate کی تنصیب ناکام ہو گئی",
  "desktop.wsl.error.alreadyAdded": "{{distro}} پہلے ہی شامل ہے",
  "desktop.wsl.error.awmateMissing": "اس ڈسٹری بیوشن میں awmate انسٹال نہیں ہے",
  "desktop.wsl.error.awmateCannotRun": "awmate انسٹال ہے لیکن چل نہیں سکا",
  "desktop.wsl.error.awmateNotInstalled": "{{distro}} میں AWMate انسٹال نہیں ہے",
  "desktop.wsl.error.updateVersion":
    "AWMate کی اپ ڈیٹ مکمل ہو گئی لیکن {{distro}} اب بھی {{installed}} کی اطلاع دے رہا ہے؛ متوقع ورژن {{expected}} ہے",
  ...
  "dialog.provider.awmate.note": "کیوریٹ شدہ ماڈلز بشمول Claude، GPT، Gemini اور مزید",
  "dialog.provider.awmate.tagline": "قابل اعتماد آپٹمائزڈ ماڈلز",
  "dialog.provider.awmateGo.tagline": "سب کے لیے کم لاگت کی رکنیت",
  ...
  "dialog.model.unpaid.freeModels.title": "AWMate کے ذریعہ فراہم کردہ مفت ماڈلز",
  ...
  "provider.connect.apiKey.description":
    "اپنا اکاؤنٹ منسلک کرنے اور AWMate میں {{provider}} ماڈلز استعمال کرنے کے لیے اپنی {{provider}} API کلید درج کریں۔",
  ...
  "provider.connect.awmateZen.line1":
    "AWMate Zen آپ کو کوڈنگ ایجنٹوں کے لیے قابل اعتماد اصلاح شدہ ماڈلز کے کیوریٹڈ سیٹ تک رسائی فراہم کرتا ہے۔",
  "provider.connect.awmateZen.line2":
    "ایک واحد API کلید کے ساتھ آپ Claude، GPT، Gemini، GLM اور مزید ماڈلز تک رسائی حاصل کریں گے۔",
  "provider.connect.awmateZen.visit.prefix": "ملاحظہ کریں ",
  "provider.connect.awmateZen.visit.link": "opencode.ai/zen",
  "provider.connect.awmateZen.visit.suffix": " اور اپنی API کلید حاصل کریں۔",
  "provider.connect.oauth.code.visit.prefix": "ملاحظہ کریں ",
  "provider.connect.oauth.code.visit.link": "یہ لنک",
  "provider.connect.oauth.code.visit.suffix":
    "، اپنا اجازت نامہ حاصل کریں، اکاؤنٹ منسلک کریں اور AWMate میں {{provider}} ماڈلز استعمال کریں۔",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " اور نیچے دیا گیا کوڈ درج کرکے اپنا اکاؤنٹ منسلک کریں اور AWMate میں {{provider}} ماڈلز استعمال کریں۔",
  ...
  "dialog.plugins.empty": "awmate.json میں کنفیگر کردہ پلگ انز",
  ...
  "dialog.server.description": "سوئچ کریں کہ یہ ایپ کس AWMate سرور سے منسلک ہے۔",
  ...
  "wsl.onboarding.checkingAWMate": "AWMate چیک کیا جا رہا ہے...",
  "wsl.onboarding.checkingAWMateIn": "{{distro}} میں AWMate چیک کیا جا رہا ہے...",
  "wsl.onboarding.updatingAWMate": "AWMate کو اپ ڈیٹ کیا جا رہا ہے...",
  "wsl.onboarding.updatingAWMateIn": "{{distro}} میں AWMate کو اپ ڈیٹ کیا جا رہا ہے...",
  "wsl.onboarding.updateAWMateIn": "{{distro}} میں AWMate کو اپ ڈیٹ کریں۔",
  "wsl.onboarding.updateAWMate": "AWMate کو اپ ڈیٹ کریں۔",
  "wsl.onboarding.awmateReadyIn": "AWMate {{distro}} میں تیار ہے۔",
  "wsl.onboarding.awmateReady": "AWMate تیار ہے۔",
  "wsl.onboarding.installAWMateIn": "{{distro}} میں AWMate انسٹال کریں۔",
  "wsl.onboarding.installAWMate": "AWMate انسٹال کریں۔",
  ...
  "wsl.onboarding.distroStatus.awmateMissing": "AWMate انسٹال نہیں ہے۔",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows سب سسٹم برائے Linux) کی ضرورت ہے اس سے پہلے کہ AWMate WSL سرور شامل کر سکے۔",
  "wsl.onboarding.wslUnavailable.title": "WSL دستیاب نہیں ہے۔",
  "wsl.onboarding.wslUnavailable.description": "AWMate اس مشین پر WSL کی تصدیق نہیں کر سکا۔",
  "wsl.onboarding.installWsl": "WSL انسٹال کریں۔",
  "wsl.onboarding.windowsRestartRequired":
    "WSL انسٹال کرنے کے لیے Windows کو دوبارہ شروع کریں، پھر AWMate کو دوبارہ کھولیں۔",
  ...
  "help.tabs.introduction": "AWMate Desktop اب ٹیبز پر مبنی ہے۔",
  "help.tabs.sessions":
  ...
  "toast.update.description": "AWMate ({{version}}) کا ایک نیا ورژن اب انسٹال کرنے کے لیے دستیاب ہے۔",
  ...
  "error.page.report.prefix": "براہ کرم AWMate ٹیم کو اس غلطی کی اطلاع دیں۔",
  ...
  "error.chain.checkConfig": "اپنی تشکیل (awmate.json) فراہم کنندہ/ماڈل کے نام چیک کریں۔",
  "error.chain.mcpFailed": 'MCP سرور "{{name}}" ناکام ہو گیا۔ نوٹ، AWMate ابھی تک MCP تصدیق کو سپورٹ نہیں کرتا ہے۔',
  ...
  "sidebar.gettingStarted.line1": "AWMate میں مفت ماڈل شامل ہیں لہذا آپ فوری طور پر شروع کر سکتے ہیں۔",
  ...
  "app.name.desktop": "AWMate ڈیسک ٹاپ",
  ...
  "settings.desktop.wsl.description": "Windows پر WSL کے اندر AWMate سرور چلائیں۔",
  ...
  "settings.general.row.language.description": "AWMate کے لیے ڈسپلے کی زبان تبدیل کریں۔",
  ...
  "settings.general.row.appearance.description": "اپنی مرضی کے مطابق بنائیں کہ آپ کے آلے پر AWMate کیسا لگتا ہے۔",
  "settings.general.row.colorScheme.title": "رنگ سکیم",
  "settings.general.row.colorScheme.description":
    "منتخب کریں کہ آیا AWMate سسٹم، لائٹ یا ڈارک تھیم کی پیروی کرتا ہے۔",
  "settings.general.row.theme.title": "تھیم",
  "settings.general.row.theme.description": "AWMate کی تھیم حسب ضرورت بنائیں۔",
  ...
  "settings.updates.row.startup.description": "AWMate لانچ ہونے پر اپ ڈیٹس کے لیے خودکار طور پر چیک کریں۔",
  ...
  "settings.updates.toast.latest.description": "آپ AWMate کا تازہ ترین ورژن چلا رہے ہیں۔",
