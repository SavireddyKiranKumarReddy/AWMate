export const dict = {
  ...
  "desktop.menu.documentation": "AWMate दस्तावेज़",
  ...
  "desktop.menu.ariaLabel": "AWMate मेन्यू",
  ...
  "desktop.recovery.loadFailed": "AWMate लोड नहीं हो सका",
  "desktop.recovery.terminated": "AWMate विंडो अनपेक्षित रूप से बंद हो गई",
  "desktop.recovery.unresponsive": "AWMate प्रतिसाद नहीं दे रहा है",
  ...
  "desktop.wsl.error.installAWMate": "AWMate इंस्टॉल नहीं हो सका",
  "desktop.wsl.error.alreadyAdded": "{{distro}} पहले ही जोड़ा जा चुका है",
  "desktop.wsl.error.awmateMissing": "इस डिस्ट्रो में awmate इंस्टॉल नहीं है",
  "desktop.wsl.error.awmateCannotRun": "awmate इंस्टॉल है, लेकिन चल नहीं सका",
  "desktop.wsl.error.awmateNotInstalled": "{{distro}} में AWMate इंस्टॉल नहीं है",
  "desktop.wsl.error.updateVersion":
    "AWMate अपडेट पूरा हो गया, लेकिन {{distro}} अब भी {{installed}} रिपोर्ट कर रहा है; अपेक्षित संस्करण {{expected}} है",
  ...
  "dialog.provider.awmate.note": "Claude, GPT, Gemini और अधिक सहित क्यूरेटेड मॉडल",
  "dialog.provider.awmate.tagline": "विश्वसनीय अनुकूलित मॉडल",
  "dialog.provider.awmateGo.tagline": "सभी के लिए कम लागत वाली सदस्यता",
  ...
  "dialog.model.unpaid.freeModels.title": "AWMate द्वारा उपलब्ध निःशुल्क मॉडल",
  ...
  "provider.connect.apiKey.description":
    "अपने खाते को कनेक्ट करने के लिए अपनी {{provider}} API कुंजी दर्ज करें और AWMate में {{provider}} मॉडल का उपयोग करें।",
  ...
  "provider.connect.awmateZen.line1":
    "AWMate Zen आपको कोडिंग एजेंटों के लिए चुने गए विश्वसनीय, अनुकूलित मॉडलों तक पहुँच देता है।",
  "provider.connect.awmateZen.line2": "एक API कुंजी से आपको Claude, GPT, Gemini, GLM जैसे कई मॉडलों तक पहुँच मिलेगी।",
  "provider.connect.awmateZen.visit.prefix": "यहाँ जाएँ: ",
  "provider.connect.awmateZen.visit.link": "opencode.ai/zen",
  "provider.connect.awmateZen.visit.suffix": " अपनी API कुंजी प्राप्त करने के लिए।",
  "provider.connect.oauth.code.visit.prefix": "यहाँ जाएँ: ",
  "provider.connect.oauth.code.visit.link": "इस लिंक",
  "provider.connect.oauth.code.visit.suffix":
    " अपने खाते को कनेक्ट करने और AWMate में {{provider}} मॉडल का उपयोग करने के लिए अपना प्राधिकरण कोड प्राप्त करें।",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " और अपने खाते को कनेक्ट करने तथा AWMate में {{provider}} मॉडल का उपयोग करने के लिए नीचे दिया गया कोड दर्ज करें।",
  ...
  "dialog.plugins.empty": "प्लगइन awmate.json में कॉन्फ़िगर किए गए हैं",
  ...
  "dialog.server.description": "स्विच करें कि यह ऐप किस AWMate सर्वर से कनेक्ट होता है।",
  ...
  "wsl.onboarding.checkingAWMate": "AWMate की जाँच हो रही है...",
  "wsl.onboarding.checkingAWMateIn": "{{distro}} में AWMate की जाँच हो रही है...",
  "wsl.onboarding.updatingAWMate": "AWMate अपडेट हो रहा है...",
  "wsl.onboarding.updatingAWMateIn": "{{distro}} में AWMate अपडेट हो रहा है...",
  "wsl.onboarding.updateAWMateIn": "{{distro}} में AWMate को अपडेट करें।",
  "wsl.onboarding.updateAWMate": "AWMate को अपडेट करें",
  "wsl.onboarding.awmateReadyIn": "AWMate {{distro}} में तैयार है।",
  "wsl.onboarding.awmateReady": "AWMate तैयार है।",
  "wsl.onboarding.installAWMateIn": "{{distro}} में AWMate स्थापित करें।",
  "wsl.onboarding.installAWMate": "AWMate स्थापित करें",
  ...
  "wsl.onboarding.distroStatus.awmateMissing": "AWMate स्थापित नहीं है",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "AWMate द्वारा WSL सर्वर जोड़ने से पहले WSL (Linux के लिए Windows सबसिस्टम) आवश्यक है",
  "wsl.onboarding.wslUnavailable.title": "WSL अनुपलब्ध है",
  "wsl.onboarding.wslUnavailable.description": "AWMate इस मशीन पर WSL को सत्यापित नहीं कर सका।",
  "wsl.onboarding.installWsl": "WSL स्थापित करें",
  "wsl.onboarding.windowsRestartRequired":
    "WSL की स्थापना समाप्त करने के लिए Windows को पुनरारंभ करें, फिर AWMate को फिर से खोलें।",
  ...
  "help.tabs.introduction": "AWMate Desktop अब टैब पर आधारित है।",
  "help.tabs.sessions":
  ...
  "toast.update.description": "AWMate ({{version}}) का एक नया संस्करण अब इंस्टॉल करने के लिए उपलब्ध है।",
  ...
  "error.page.report.prefix": "कृपया इस त्रुटि की रिपोर्ट AWMate टीम को करें",
  ...
  "error.chain.checkConfig": "अपने कॉन्फ़िगरेशन (awmate.json) प्रोवाइडर/मॉडल नामों की जाँच करें",
  "error.chain.mcpFailed":
    'MCP सर्वर "{{name}}" विफल रहा। ध्यान दें, AWMate अभी तक MCP प्रमाणीकरण का समर्थन नहीं करता है।',
  ...
  "sidebar.gettingStarted.line1": "AWMate में निःशुल्क मॉडल शामिल है ताकि आप तुरंत शुरू कर सकें।",
  ...
  "settings.desktop.wsl.description": "Windows पर WSL के अंदर AWMate सर्वर चलाएँ।",
  ...
  "settings.general.row.language.description": "AWMate के लिए प्रदर्शन भाषा बदलें",
  ...
  "settings.general.row.appearance.description": "अनुकूलित करें कि AWMate आपके डिवाइस पर कैसा दिखता है",
  "settings.general.row.colorScheme.title": "रंग योजना",
  "settings.general.row.colorScheme.description": "चुनें कि AWMate सिस्टम, हल्की या गहरी थीम में से किसका उपयोग करे",
  "settings.general.row.theme.title": "थीम",
  "settings.general.row.theme.description": "अनुकूलित करें कि AWMate की थीम कैसी है।",
  ...
  "settings.updates.row.startup.description": "AWMate लॉन्च होने पर अपने-आप अपडेट की जाँच करें",
  ...
  "settings.updates.toast.latest.description": "आप AWMate का नवीनतम संस्करण चला रहे हैं।",
