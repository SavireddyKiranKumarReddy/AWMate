import type { AWMateEvent, SessionMessageInfo, SessionPendingMessage } from "@awmate/client/promise"
...
export function createV2SessionReducer() {
  ...
  const reduce = (source: readonly SessionMessageInfo[], event: AWMateEvent): V2SessionReduction | undefined => {
