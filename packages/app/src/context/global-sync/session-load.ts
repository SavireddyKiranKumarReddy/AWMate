import type { SessionApi } from "@awmate/client/promise"
import { normalizeSessionInfo } from "@/utils/session"
import type { AWMateClient } from "@awmate/sdk/v2/client"
...
export async function loadRootSessionsV1(input: { client: AWMateClient; directory: string; limit: number }) {
  try {
