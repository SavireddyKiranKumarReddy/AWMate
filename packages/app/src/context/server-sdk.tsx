import type { AWMateEvent } from "@awmate/client/promise"
...
export type ServerEvent = Event & { current?: AWMateEvent }
...
export function adaptServerEvent(event: AWMateEvent): ServerEvent {
...
function currentDelta(event: AWMateEvent | undefined): CurrentDelta | undefined {
  if (
