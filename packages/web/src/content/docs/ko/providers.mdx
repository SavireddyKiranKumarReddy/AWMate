...
1. TUI에서 `/connect` 명령을 실행하고 `AWMate Zen`을 선택한 뒤, [ai.awmate.nxtgensec.org/auth](https://ai.awmate.nxtgensec.org/zen)로 이동합니다.
...
1. TUI에서 `/connect` 명령을 실행하고 `AWMate Go`를 선택한 뒤 [ai.awmate.nxtgensec.org/auth](https://ai.awmate.nxtgensec.org/zen)로 이동하십시오.
