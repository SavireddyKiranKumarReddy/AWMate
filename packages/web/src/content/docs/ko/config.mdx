...
server/runtime config schema는 [**`ai.awmate.nxtgensec.org/config.json`**](https://ai.awmate.nxtgensec.org/config.json)에 정의되어 있습니다.

TUI config는 [**`ai.awmate.nxtgensec.org/tui.json`**](https://ai.awmate.nxtgensec.org/tui.json)을 사용합니다.
