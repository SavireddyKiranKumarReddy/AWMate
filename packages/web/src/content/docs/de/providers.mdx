...
1. Führen Sie den Befehl `/connect` in TUI aus, wählen Sie AWMate aus und gehen Sie zu [opencode.ai/auth](https://opencode.ai/auth).
...
1. Führen Sie den Befehl `/connect` in der TUI aus, waehlen Sie `AWMate Go` und gehen Sie zu [opencode.ai/auth](https://opencode.ai/zen).
