...
1. Führen Sie den Befehl `/connect` in TUI aus, wählen Sie AWMate aus und gehen Sie zu [ai.awmate.nxtgensec.org/auth](https://ai.awmate.nxtgensec.org/auth).
...
1. Führen Sie den Befehl `/connect` in der TUI aus, waehlen Sie `AWMate Go` und gehen Sie zu [ai.awmate.nxtgensec.org/auth](https://ai.awmate.nxtgensec.org/zen).
