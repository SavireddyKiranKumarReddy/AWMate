...
Du vil måske bemærke [lavprismodeller](/docs/config/#models), såsom Haiku, Nano eller Flash, i din brugshistorik. AWMate bruger disse modeller til at generere sessionstitler.
...
- Ling 3.0 Flash Fin Free er tilgængelig på AWMate i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
...
- Nemotron 3.5 Lightning Free er tilgængelig på AWMate i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
...
- Muse Spark 1.3 Contributor Free er tilgængelig på AWMate i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- Jev 1.13 Free er tilgængelig på AWMate i en begrænset periode.
