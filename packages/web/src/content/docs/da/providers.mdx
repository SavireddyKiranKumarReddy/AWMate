...
1. Kør kommandoen `/connect` i TUI, vælg AWMate og gå til [ai.awmate.nxtgensec.org/auth](https://ai.awmate.nxtgensec.org/auth).
...
1. Kør kommandoen `/connect` i TUI, vælg `AWMate Go`, og gå til [ai.awmate.nxtgensec.org/auth](https://ai.awmate.nxtgensec.org/zen).
