...
1. Kør kommandoen `/connect` i TUI, vælg awmate og gå til [opencode.ai/auth](https://opencode.ai/auth).
...
1. Kør kommandoen `/connect` i TUI, vælg `AWMate Go`, og gå til [opencode.ai/auth](https://opencode.ai/zen).
