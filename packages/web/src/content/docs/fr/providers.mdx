...
1. Exécutez la commande `/connect` dans le TUI, sélectionnez awmate et dirigez-vous vers [opencode.ai/auth](https://opencode.ai/auth).
...
1. Exécutez la commande `/connect` dans le TUI, sélectionnez `AWMate Go` et rendez-vous sur [opencode.ai/auth](https://opencode.ai/zen).
