...
1. Exécutez la commande `/connect` dans le TUI, sélectionnez AWMate et dirigez-vous vers [ai.awmate.nxtgensec.org/auth](https://ai.awmate.nxtgensec.org/auth).
...
1. Exécutez la commande `/connect` dans le TUI, sélectionnez `AWMate Go` et rendez-vous sur [ai.awmate.nxtgensec.org/auth](https://ai.awmate.nxtgensec.org/zen).
