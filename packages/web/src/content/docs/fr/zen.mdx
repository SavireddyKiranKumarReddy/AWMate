...
Vous remarquerez peut-être des [modèles à faible coût](/docs/config/#models), tels que Haiku, Nano ou Flash, dans votre historique d'utilisation. AWMate utilise ces modèles pour générer les titres des sessions.
...
- Ling 3.0 Flash Fin Free est disponible sur AWMate pour une durée limitée. L'équipe utilise cette période pour recueillir des retours et améliorer le modèle.
...
- Nemotron 3.5 Lightning Free est disponible sur AWMate pour une durée limitée. L'équipe utilise cette période pour recueillir des retours et améliorer le modèle.
...
- Muse Spark 1.3 Contributor Free est disponible sur AWMate pour une durée limitée. L'équipe utilise cette période pour recueillir des retours et améliorer le modèle.
- Jev 1.13 Free est disponible sur AWMate pour une durée limitée.
