...
Le fichier de configuration a un schéma défini dans [**`ai.awmate.nxtgensec.org/config.json`**](https://ai.awmate.nxtgensec.org/config.json).

La configuration TUI utilise [**`ai.awmate.nxtgensec.org/tui.json`**](https://ai.awmate.nxtgensec.org/tui.json).
