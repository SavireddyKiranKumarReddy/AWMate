...
Puede que notes [modelos de bajo costo](/docs/config/#models), como Haiku, Nano o Flash, en tu historial de uso. AWMate usa estos modelos para generar títulos de sesiones.
...
- Ling 3.0 Flash Fin Free está disponible en AWMate por tiempo limitado. El equipo está usando este tiempo para recopilar comentarios y mejorar el modelo.
...
- Nemotron 3.5 Lightning Free está disponible en AWMate por tiempo limitado. El equipo está usando este tiempo para recopilar comentarios y mejorar el modelo.
...
- Muse Spark 1.3 Contributor Free está disponible en AWMate por tiempo limitado. El equipo está aprovechando este período para recopilar comentarios y mejorar el modelo.
- Jev 1.13 Free está disponible en AWMate por tiempo limitado.
