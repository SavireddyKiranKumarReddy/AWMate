...
1. Ejecute el comando `/connect` en TUI, seleccione awmate y diríjase a [opencode.ai/auth](https://opencode.ai/auth).
...
1. Ejecute el comando `/connect` en TUI, seleccione `AWMate Go` y diríjase a [opencode.ai/auth](https://opencode.ai/zen).
