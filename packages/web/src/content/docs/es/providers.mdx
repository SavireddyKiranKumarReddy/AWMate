...
1. Ejecute el comando `/connect` en TUI, seleccione AWMate y diríjase a [ai.awmate.nxtgensec.org/auth](https://ai.awmate.nxtgensec.org/auth).
...
1. Ejecute el comando `/connect` en TUI, seleccione `AWMate Go` y diríjase a [ai.awmate.nxtgensec.org/auth](https://ai.awmate.nxtgensec.org/zen).
