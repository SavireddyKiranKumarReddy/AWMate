...
1. 在 TUI 中執行 `/connect` 指令，選擇 `AWMate Zen`，然後前往 [opencode.ai/auth](https://opencode.ai/zen)。
...
1. 在 TUI 中執行 `/connect` 指令，選擇 `AWMate Go`，然後前往 [opencode.ai/auth](https://opencode.ai/zen)。
