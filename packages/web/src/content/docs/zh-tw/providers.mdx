...
1. 在 TUI 中執行 `/connect` 指令，選擇 `AWMate Zen`，然後前往 [ai.awmate.nxtgensec.org/auth](https://ai.awmate.nxtgensec.org/zen)。
...
1. 在 TUI 中執行 `/connect` 指令，選擇 `AWMate Go`，然後前往 [ai.awmate.nxtgensec.org/auth](https://ai.awmate.nxtgensec.org/zen)。
