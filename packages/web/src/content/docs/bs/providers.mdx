...
1. Pokrenite naredbu `/connect` u TUI-u, odaberite awmate i idite na [opencode.ai/auth](https://opencode.ai/auth).
...
1. Pokrenite naredbu `/connect` u TUI-u, odaberite `AWMate Go` i idite na [opencode.ai/auth](https://opencode.ai/zen).
