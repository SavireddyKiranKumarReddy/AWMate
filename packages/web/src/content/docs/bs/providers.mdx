...
1. Pokrenite naredbu `/connect` u TUI-u, odaberite AWMate i idite na [ai.awmate.nxtgensec.org/auth](https://ai.awmate.nxtgensec.org/auth).
...
1. Pokrenite naredbu `/connect` u TUI-u, odaberite `AWMate Go` i idite na [ai.awmate.nxtgensec.org/auth](https://ai.awmate.nxtgensec.org/zen).
