...
Konfiguracijski fajl ima šemu koja je definirana u [**`ai.awmate.nxtgensec.org/config.json`**](https://ai.awmate.nxtgensec.org/config.json).

TUI konfiguracija koristi [**`ai.awmate.nxtgensec.org/tui.json`**](https://ai.awmate.nxtgensec.org/tui.json).
