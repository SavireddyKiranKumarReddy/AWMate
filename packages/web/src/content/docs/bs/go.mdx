...
AWMate Go je povoljna pretplata od **$10/mjesečno** koja vam pruža pouzdan pristup popularnim otvorenim modelima za programiranje.
...
AWMate Go vam daje pristup ovim modelima za **$10/mjesečno**.
...
AWMate Go je osmišljen za [AWMate](https://opencode.ai) i druge agente za programiranje
...
3. Slati stabilan ID sesije u zaglavlju `x-awmate-session` za svaki razgovor kako bismo mogli optimizovati usmjeravanje i
   keširanje promptova.

### Provjereni klijenti

Pored AWMate-a, potvrđeno je da sljedeći klijenti ispravno rade
s AWMate Go. Ipak, ne garantiramo da će nastaviti raditi i u budućnosti.

| Klijent           | Podrška za sesije                                                                                                                                                                                                                                          |
| ----------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Hermes**        | Buildovi koji sadrže [PR #101864](https://github.com/NousResearch/hermes-agent/pull/101864) šalju zaglavlje u glavnim i pomoćnim AWMate zahtjevima. Ispravka je spojena nakon verzije v0.21.0; samo to izdanje je ne sadrži.                             |
...
| **ZCode**         | Go prepoznaje njegovo izvorno zaglavlje sesije. Naš [zahtjev za `x-awmate-session`](https://github.com/zai-org/feedback/issues/492) i dalje je otvoren, ali slanje tog konkretnog zaglavlja više nije potrebno.                                          |
| **Pi**            | Trenutni buildovi šalju informacije o sesiji za AWMate. Ažurirajte starije instalacije.                                                                                                                                                                  |
...
| **Kilo Code CLI** | Buildovi koji sadrže [PR #13752](https://github.com/Kilo-Org/kilocode/pull/13752) vraćaju AWMate zaglavlja sesije. Ova ispravka obuhvata CLI, ali ne i VS Code ekstenziju. Pogledajte [issue #13723](https://github.com/Kilo-Org/kilocode/issues/13723). |
...
koristi format `awmate-go/<model-id>`. Na primjer, za Kimi K3, koristili biste
`awmate-go/kimi-k3` u svojoj konfiguraciji.
