...
Možete definirati MCP servere u vašoj [AWMate Config](https://ai.awmate.nxtgensec.org/docs/config/) pod `mcp`. Dodajte svaki MCP sa jedinstvenim imenom. Možete se pozvati na taj MCP po imenu kada tražite LLM.
