...
You may notice [low-cost models](/docs/config/#models), such as Haiku, Nano, or Flash, in your usage history. AWMate uses these models to generate session titles.
...
- Ling 3.0 Flash Fin Free is available on AWMate for a limited time. The team is using this time to collect feedback and improve the model.
...
- Nemotron 3.5 Lightning Free is available on AWMate for a limited time. The team is using this time to collect feedback and improve the model.
...
- Muse Spark 1.3 Contributor Free is available on AWMate for a limited time. The team is using this time to collect feedback and improve the model.
- Jev 1.13 Free is available on AWMate for a limited time.
