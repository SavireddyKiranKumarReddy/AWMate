...
1. TUI'de `/connect` komutunu çalıştırın, AWMate'u seçin ve [ai.awmate.nxtgensec.org/auth](https://ai.awmate.nxtgensec.org/auth)'ye gidin.
...
1. TUI'de `/connect` komutunu çalıştırın, `AWMate Go`'yu seçin ve [ai.awmate.nxtgensec.org/auth](https://ai.awmate.nxtgensec.org/zen) adresine gidin.
