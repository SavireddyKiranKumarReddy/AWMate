...
1. TUI'de `/connect` komutunu çalıştırın, awmate'u seçin ve [opencode.ai/auth](https://opencode.ai/auth)'ye gidin.
...
1. TUI'de `/connect` komutunu çalıştırın, `AWMate Go`'yu seçin ve [opencode.ai/auth](https://opencode.ai/zen) adresine gidin.
