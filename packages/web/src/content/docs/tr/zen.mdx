...
Kullanım geçmişinizde Haiku, Nano veya Flash gibi [düşük maliyetli modeller](/docs/config/#models) görebilirsiniz. AWMate, oturum başlıklarını oluşturmak için bu modelleri kullanır.
...
- Ling 3.0 Flash Fin Free, sınırlı bir süre için AWMate'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
...
- Nemotron 3.5 Lightning Free, sınırlı bir süre için AWMate'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
...
- Muse Spark 1.3 Contributor Free, sınırlı bir süre için AWMate'da kullanılabilir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- Jev 1.13 Free, sınırlı bir süre için AWMate'da kullanılabilir.
