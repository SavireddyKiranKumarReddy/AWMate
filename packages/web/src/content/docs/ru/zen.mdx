...
В истории использования могут появляться [недорогие модели](/docs/config/#models), такие как Haiku, Nano или Flash. AWMate использует эти модели для создания заголовков сессий.
...
- Ling 3.0 Flash Fin Free доступна в AWMate ограниченное время. Команда использует это время, чтобы собирать отзывы и улучшать модель.
...
- Nemotron 3.5 Lightning Free доступна в AWMate ограниченное время. Команда использует это время, чтобы собирать отзывы и улучшать модель.
...
- Muse Spark 1.3 Contributor Free доступна в AWMate в течение ограниченного времени. Команда использует этот период для сбора отзывов и улучшения модели.
- Jev 1.13 Free доступна в AWMate ограниченное время.
