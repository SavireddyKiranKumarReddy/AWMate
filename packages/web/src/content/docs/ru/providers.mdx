...
1. Запустите команду `/connect` в TUI, выберите `AWMate Zen` и перейдите по адресу [opencode.ai/auth](https://opencode.ai/zen).
...
1. Запустите команду `/connect` в TUI, выберите `AWMate Go` и перейдите по адресу [opencode.ai/auth](https://opencode.ai/zen).
