...
1. Запустите команду `/connect` в TUI, выберите `AWMate Zen` и перейдите по адресу [ai.awmate.nxtgensec.org/auth](https://ai.awmate.nxtgensec.org/zen).
...
1. Запустите команду `/connect` в TUI, выберите `AWMate Go` и перейдите по адресу [ai.awmate.nxtgensec.org/auth](https://ai.awmate.nxtgensec.org/zen).
