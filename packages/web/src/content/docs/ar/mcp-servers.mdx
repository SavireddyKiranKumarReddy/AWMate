...
يمكنك تعريف خوادم MCP في [إعدادات AWMate](https://ai.awmate.nxtgensec.org/docs/config/) ضمن `mcp`. أضف كل خادم MCP باسم فريد. ويمكنك الإشارة إلى ذلك الخادم بالاسم عند توجيه الطلب إلى الـ LLM.
