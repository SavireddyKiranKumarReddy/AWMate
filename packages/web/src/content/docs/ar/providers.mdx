...
1. شغّل الأمر `/connect` في TUI، واختر awmate، ثم انتقل إلى [opencode.ai/auth](https://opencode.ai/auth).
...
1. شغّل الأمر `/connect` في TUI، واختر `AWMate Go`، ثم انتقل إلى [opencode.ai/auth](https://opencode.ai/zen).
