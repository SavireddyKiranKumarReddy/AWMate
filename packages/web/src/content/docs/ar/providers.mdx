...
1. شغّل الأمر `/connect` في TUI، واختر AWMate، ثم انتقل إلى [ai.awmate.nxtgensec.org/auth](https://ai.awmate.nxtgensec.org/auth).
...
1. شغّل الأمر `/connect` في TUI، واختر `AWMate Go`، ثم انتقل إلى [ai.awmate.nxtgensec.org/auth](https://ai.awmate.nxtgensec.org/zen).
