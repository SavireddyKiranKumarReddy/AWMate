...
Potresti notare [modelli a basso costo](/docs/config/#models), come Haiku, Nano o Flash, nella cronologia di utilizzo. AWMate usa questi modelli per generare i titoli delle sessioni.
...
- Ling 3.0 Flash Fin Free è disponibile su AWMate per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
...
- Nemotron 3.5 Lightning Free è disponibile su AWMate per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
...
- Muse Spark 1.3 Contributor Free è disponibile su AWMate per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
- Jev 1.13 Free è disponibile su AWMate per un periodo limitato.
