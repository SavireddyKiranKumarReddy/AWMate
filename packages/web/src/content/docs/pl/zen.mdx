...
W historii użycia możesz zauważyć [niedrogie modele](/docs/config/#models), takie jak Haiku, Nano lub Flash. AWMate używa tych modeli do generowania tytułów sesji.
...
- Ling 3.0 Flash Fin Free jest dostępny w AWMate przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
...
- Nemotron 3.5 Lightning Free jest dostępny w AWMate przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
...
- Muse Spark 1.3 Contributor Free jest dostępny w AWMate przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Jev 1.13 Free jest dostępny w AWMate przez ograniczony czas.
