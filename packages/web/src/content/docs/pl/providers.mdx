...
1. Uruchom polecenie `/connect` w TUI, wybierz `AWMate Zen` i przejdź do [ai.awmate.nxtgensec.org/auth](https://ai.awmate.nxtgensec.org/zen).
...
1. Uruchom polecenie `/connect` w TUI, wybierz `AWMate Go` i przejdź do [ai.awmate.nxtgensec.org/auth](https://ai.awmate.nxtgensec.org/zen).
