...
1. Uruchom polecenie `/connect` w TUI, wybierz `AWMate Zen` i przejdź do [opencode.ai/auth](https://opencode.ai/zen).
...
1. Uruchom polecenie `/connect` w TUI, wybierz `AWMate Go` i przejdź do [opencode.ai/auth](https://opencode.ai/zen).
