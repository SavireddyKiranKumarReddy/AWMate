...
AWMate Go to niskokosztowa subskrypcja za **10 $/miesiąc**, która zapewnia niezawodny dostęp do popularnych otwartych modeli do kodowania.
...
AWMate Go daje Ci dostęp do tych modeli za **10 $/miesiąc**.
...
AWMate Go jest przeznaczony dla [AWMate](https://opencode.ai) i innych agentów kodujących,
...
3. Wysyłać stabilny identyfikator sesji w nagłówku `x-awmate-session` dla każdej rozmowy, aby umożliwić optymalizację routingu i
   buforowania promptów.

### Zweryfikowane klienty

Poza AWMate zweryfikowano, że poniżsi klienci działają prawidłowo
z AWMate Go. Nie gwarantujemy jednak, że będą nadal działać w przyszłości.

| Klient            | Obsługa sesji                                                                                                                                                                                                                                              |
| ----------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Hermes**        | Kompilacje zawierające [PR #101864](https://github.com/NousResearch/hermes-agent/pull/101864) wysyłają nagłówek w głównych i pomocniczych żądaniach AWMate. Poprawkę scalono po wersji v0.21.0; samo to wydanie jej nie zawiera.                         |
...
| **ZCode**         | Go rozpoznaje jego natywny nagłówek sesji. Nasza [prośba o `x-awmate-session`](https://github.com/zai-org/feedback/issues/492) pozostaje otwarta, ale wysyłanie tego konkretnego nagłówka nie jest już konieczne.                                        |
| **Pi**            | Aktualne kompilacje wysyłają informacje o sesji dla AWMate. Zaktualizuj starsze instalacje.                                                                                                                                                              |
...
| **Kilo Code CLI** | Kompilacje zawierające [PR #13752](https://github.com/Kilo-Org/kilocode/pull/13752) przywracają nagłówki sesji AWMate. Ta poprawka obejmuje CLI, ale nie rozszerzenie VS Code. Zobacz [issue #13723](https://github.com/Kilo-Org/kilocode/issues/13723). |
...
używa formatu `awmate-go/<model-id>`. Na przykład dla Kimi K3 należy użyć
`awmate-go/kimi-k3` w swojej konfiguracji.
