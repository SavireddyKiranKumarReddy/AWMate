...
1. Execute o comando `/connect` no TUI, selecione `AWMate Zen` e acesse [opencode.ai/zen](https://opencode.ai/zen).
...
1. Execute o comando `/connect` no TUI, selecione `AWMate Go` e acesse [opencode.ai/zen](https://opencode.ai/zen).
