...
1. Execute o comando `/connect` no TUI, selecione `AWMate Zen` e acesse [ai.awmate.nxtgensec.org/zen](https://ai.awmate.nxtgensec.org/zen).
...
1. Execute o comando `/connect` no TUI, selecione `AWMate Go` e acesse [ai.awmate.nxtgensec.org/zen](https://ai.awmate.nxtgensec.org/zen).
