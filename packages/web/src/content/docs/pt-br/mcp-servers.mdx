...
Você pode definir servidores MCP em sua [Configuração do AWMate](https://ai.awmate.nxtgensec.org/docs/config/) sob `mcp`. Adicione cada MCP com um nome único. Você pode se referir a esse MCP pelo nome ao solicitar ao LLM.
