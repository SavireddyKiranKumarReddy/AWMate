...
Você pode notar [modelos de baixo custo](/docs/config/#models), como Haiku, Nano ou Flash, no seu histórico de uso. O AWMate usa esses modelos para gerar títulos de sessões.
...
- Ling 3.0 Flash Fin Free está disponível no AWMate por tempo limitado. A equipe está usando esse período para coletar feedback e melhorar o modelo.
...
- Nemotron 3.5 Lightning Free está disponível no AWMate por tempo limitado. A equipe está usando esse período para coletar feedback e melhorar o modelo.
...
- Muse Spark 1.3 Contributor Free está disponível no AWMate por tempo limitado. A equipe está usando esse período para coletar feedback e melhorar o modelo.
- Jev 1.13 Free está disponível no AWMate por tempo limitado.
