...
1. Kjør kommandoen `/connect` i TUI, velg `AWMate Zen` og gå til [opencode.ai/auth](https://opencode.ai/zen).
...
1. Kjør kommandoen `/connect` i TUI, velg `AWMate Go`, og gå til [opencode.ai/auth](https://opencode.ai/zen).
