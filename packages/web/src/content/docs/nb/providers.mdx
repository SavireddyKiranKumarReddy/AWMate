...
1. Kjør kommandoen `/connect` i TUI, velg `AWMate Zen` og gå til [ai.awmate.nxtgensec.org/auth](https://ai.awmate.nxtgensec.org/zen).
...
1. Kjør kommandoen `/connect` i TUI, velg `AWMate Go`, og gå til [ai.awmate.nxtgensec.org/auth](https://ai.awmate.nxtgensec.org/zen).
