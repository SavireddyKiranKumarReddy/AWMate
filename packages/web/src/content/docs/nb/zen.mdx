...
Du vil kanskje legge merke til [lavprismodeller](/docs/config/#models), som Haiku, Nano eller Flash, i brukshistorikken din. AWMate bruker disse modellene til å generere økttitler.
...
- Ling 3.0 Flash Fin Free er tilgjengelig på AWMate i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
...
- Nemotron 3.5 Lightning Free er tilgjengelig på AWMate i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
...
- Muse Spark 1.3 Contributor Free er tilgjengelig på AWMate i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- Jev 1.13 Free er tilgjengelig på AWMate i en begrenset periode.
