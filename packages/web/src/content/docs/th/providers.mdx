...
1. เรียกใช้คำสั่ง `/connect` ใน TUI เลือก awmate และไปที่ [opencode.ai/auth](https://opencode.ai/auth)
...
1. เรียกใช้คำสั่ง `/connect` ใน TUI เลือก `AWMate Go` และไปที่ [opencode.ai/auth](https://opencode.ai/zen)
