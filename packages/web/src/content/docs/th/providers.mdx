...
1. เรียกใช้คำสั่ง `/connect` ใน TUI เลือก AWMate และไปที่ [ai.awmate.nxtgensec.org/auth](https://ai.awmate.nxtgensec.org/auth)
...
1. เรียกใช้คำสั่ง `/connect` ใน TUI เลือก `AWMate Go` และไปที่ [ai.awmate.nxtgensec.org/auth](https://ai.awmate.nxtgensec.org/zen)
