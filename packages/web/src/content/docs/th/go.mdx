...
AWMate Go คือการสมัครสมาชิกในราคาประหยัด **$10/เดือน** ซึ่งให้คุณเข้าถึงโมเดลโอเพนซอร์สยอดนิยมสำหรับการเขียนโค้ดได้อย่างเสถียร
...
AWMate Go ให้คุณเข้าถึงโมเดลเหล่านี้ได้ในราคา **$10/เดือน**
...
AWMate Go ออกแบบมาสำหรับ [AWMate](https://opencode.ai) และ coding agent อื่นๆ ที่สร้างคำขอประเภทเดียวกัน
...
3. ส่ง session ID ที่คงที่ใน `x-awmate-session` สำหรับแต่ละบทสนทนา เพื่อให้เราปรับ routing และ prompt caching ให้เหมาะสมได้

### ไคลเอนต์ที่ผ่านการตรวจสอบแล้ว

นอกจาก AWMate แล้ว ไคลเอนต์ต่อไปนี้ได้รับการตรวจสอบแล้วว่าทำงานกับ AWMate Go ได้อย่างถูกต้อง
อย่างไรก็ตาม เราไม่รับประกันว่าไคลเอนต์เหล่านี้จะยังคงทำงานได้ต่อไปในอนาคต

| ไคลเอนต์          | การรองรับเซสชัน                                                                                                                                                                                                                                  |
| ----------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| **Hermes**        | บิลด์ที่มี [PR #101864](https://github.com/NousResearch/hermes-agent/pull/101864) จะส่งส่วนหัวในคำขอ AWMate ทั้งคำขอหลักและคำขอเสริม การแก้ไขนี้ถูก merge หลัง v0.21.0 ดังนั้นตัวรีลีส v0.21.0 เองจึงยังไม่มีการแก้ไขนี้                       |
...
| **ZCode**         | Go รู้จักส่วนหัวเซสชันแบบ native ของ ZCode [คำขอให้เพิ่ม `x-awmate-session`](https://github.com/zai-org/feedback/issues/492) ของเรายังเปิดอยู่ แต่ไม่จำเป็นต้องส่งส่วนหัวเฉพาะนี้อีกต่อไป                                                      |
| **Pi**            | บิลด์ปัจจุบันส่งข้อมูลเซสชันสำหรับ AWMate โปรดอัปเดตการติดตั้งเวอร์ชันเก่า                                                                                                                                                                     |
| **jcode**         | อัปเดตเป็น **v0.81.6 หรือใหม่กว่า** ซึ่งมี[การแก้ไขส่วนหัวเซสชัน](https://github.com/1jehuang/jcode/issues/1167)                                                                                                                                 |
| **Kilo Code CLI** | บิลด์ที่มี [PR #13752](https://github.com/Kilo-Org/kilocode/pull/13752) จะทำให้ส่วนหัวเซสชันของ AWMate กลับมาทำงาน การแก้ไขนี้ครอบคลุม CLI แต่ไม่ครอบคลุมส่วนขยาย VS Code ดู [issue #13723](https://github.com/Kilo-Org/kilocode/issues/13723) |
...
[model id](/docs/config/#models) ใน AWMate config ของคุณจะใช้รูปแบบ `awmate-go/<model-id>` ตัวอย่างเช่น สำหรับ Kimi K3 คุณจะใช้ `awmate-go/kimi-k3` ใน config ของคุณ
