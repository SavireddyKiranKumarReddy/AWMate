...
ไฟล์กำหนดค่ามีสคีมาที่กำหนดไว้ใน [**`ai.awmate.nxtgensec.org/config.json`**](https://ai.awmate.nxtgensec.org/config.json)

การกำหนดค่า TUI ใช้ [**`ai.awmate.nxtgensec.org/tui.json`**](https://ai.awmate.nxtgensec.org/tui.json)
