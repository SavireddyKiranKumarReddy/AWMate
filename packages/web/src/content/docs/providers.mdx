...
1. Run the `/connect` command in the TUI, select `AWMate Zen`, and head to [ai.awmate.nxtgensec.org/auth](https://ai.awmate.nxtgensec.org/zen).
...
1. Run the `/connect` command in the TUI, select `AWMate Go`, and head to [ai.awmate.nxtgensec.org/auth](https://ai.awmate.nxtgensec.org/zen).
