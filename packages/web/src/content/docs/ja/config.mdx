...
サーバー/ランタイム構成スキーマは [**`ai.awmate.nxtgensec.org/config.json`**](https://ai.awmate.nxtgensec.org/config.json) で定義されています。

TUI 設定は [**`ai.awmate.nxtgensec.org/tui.json`**](https://ai.awmate.nxtgensec.org/tui.json) を使用します。
