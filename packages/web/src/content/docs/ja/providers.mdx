...
1. TUI で `/connect` コマンドを実行し、`AWMate Zen` を選択して、[opencode.ai/zen](https://opencode.ai/zen) にアクセスします。
...
1. TUI で `/connect` コマンドを実行し、`AWMate Go` を選択して、[opencode.ai/zen](https://opencode.ai/zen) にアクセスします。
