...
1. TUI で `/connect` コマンドを実行し、`AWMate Zen` を選択して、[ai.awmate.nxtgensec.org/zen](https://ai.awmate.nxtgensec.org/zen) にアクセスします。
...
1. TUI で `/connect` コマンドを実行し、`AWMate Go` を選択して、[ai.awmate.nxtgensec.org/zen](https://ai.awmate.nxtgensec.org/zen) にアクセスします。
