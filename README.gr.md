...
Το AWMate είναι επίσης διαθέσιμο ως εφαρμογή. Κατέβασε το απευθείας από τη [σελίδα εκδόσεων](https://github.com/anomalyco/awmate/releases) ή το [opencode.ai/download](https://ai.awmate.nxtgensec.org/download).
