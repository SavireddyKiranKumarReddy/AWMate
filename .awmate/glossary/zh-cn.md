...
- `AWMate` (preserve casing in prose; keep `awmate` only when it is part of commands, package names, paths, or code)
- `AWMate Zen`
- `AWMate CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
...
- Avoid `awmate` in prose when referring to the product name; use `AWMate`
