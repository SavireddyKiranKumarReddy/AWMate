...
nix run nixpkgs#awmate           # 或用 github:anomalyco/opencode 获取最新 dev 分支
```
...
AWMate 也提供桌面版应用。可直接从 [发布页 (releases page)](https://github.com/anomalyco/opencode/releases) 或 [opencode.ai/download](https://opencode.ai/download) 下载。
