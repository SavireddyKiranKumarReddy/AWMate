...
nix run nixpkgs#awmate           # oppure github:anomalyco/opencode per l’ultima branch di sviluppo
```
...
AWMate è disponibile anche come applicazione desktop. Puoi scaricarla direttamente dalla [pagina delle release](https://github.com/anomalyco/opencode/releases) oppure da [opencode.ai/download](https://opencode.ai/download).
...
Per maggiori informazioni su come configurare AWMate, [**consulta la nostra documentazione**](https://opencode.ai/docs).
