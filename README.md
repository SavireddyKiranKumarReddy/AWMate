...
nix run nixpkgs#awmate           # or github:anomalyco/opencode for latest dev branch
```
...
AWMate is also available as a desktop application. Download directly from the [releases page](https://github.com/anomalyco/opencode/releases) or [opencode.ai/download](https://opencode.ai/download).
...
For more info on how to configure AWMate, [**head over to our docs**](https://opencode.ai/docs).
