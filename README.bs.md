...
nix run nixpkgs#awmate           # ili github:anomalyco/opencode za najnoviji dev branch
```
...
AWMate je dostupan i kao desktop aplikacija. Preuzmi je direktno sa [stranice izdanja](https://github.com/anomalyco/opencode/releases) ili sa [opencode.ai/download](https://opencode.ai/download).
...
Za više informacija o konfiguraciji AWMate-a, [**pogledaj dokumentaciju**](https://opencode.ai/docs).
