...
nix run nixpkgs#awmate           # ou github:anomalyco/opencode para a branch dev mais recente
```
...
O AWMate também está disponível como aplicativo desktop. Baixe diretamente pela [página de releases](https://github.com/anomalyco/opencode/releases) ou em [opencode.ai/download](https://opencode.ai/download).
...
Para mais informações sobre como configurar o AWMate, [**veja nossa documentação**](https://opencode.ai/docs).
