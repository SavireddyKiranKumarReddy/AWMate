...
AWMate はデスクトップアプリとしても利用できます。[releases page](https://github.com/anomalyco/awmate/releases) から直接ダウンロードするか、[opencode.ai/download](https://ai.awmate.nxtgensec.org/download) を利用してください。
