...
stdenvNoCC.mkDerivation (finalAttrs: {
  ...
  env.AWMATE_DISABLE_MODELS_FETCH = true;
  env.AWMATE_VERSION = finalAttrs.version;
  env.AWMATE_CHANNEL = "prod";
  ...
  postInstall = lib.optionalString (stdenvNoCC.buildPlatform.canExecute stdenvNoCC.hostPlatform) ''
    ...
    installShellCompletion --cmd awmate \
  ...
  doInstallCheck = true;
  versionCheckKeepEnvironment = [ "HOME" "AWMATE_DISABLE_MODELS_FETCH" ];
  ...
  meta = {
    ...
    homepage = "https://ai.awmate.nxtgensec.org";
