...
AWMate findes også som desktop-app. Download direkte fra [releases-siden](https://github.com/anomalyco/awmate/releases) eller [opencode.ai/download](https://ai.awmate.nxtgensec.org/download).
